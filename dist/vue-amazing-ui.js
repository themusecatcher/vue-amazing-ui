...
const uo = ["href", "target"], co = ["src", "alt"], ro = ["href", "target"], po = ["src", "alt"], vo = ["href", "target"], fo = ["src", "alt"], ho = j({ __name: "Swiper", props: { images: { default: () => [] }, width: { default: "100%" }, height: { default: "100vh" }, type: { default: "banner" }, navigation: { type: Boolean, default: !0 }, delay: { default: 3e3 }, swipe: { type: Boolean, default: !0 }, preloaderColor: { default: "theme" } }, emits: ["swiper", "change"], setup(t, { emit: a }) {
  ...
  return (z, g) => (d(), p(N, null, [z.type === "banner" ? (d(), le(P(Xa), ve({ key: 0, class: { "swiper-no-swiping": !z.swipe }, modules: r.value, navigation: z.navigation, "slides-per-view": 1, autoplay: c.value, lazy: "", loop: "", onSwiper: y, onSlideChange: g[0] || (g[0] = (n) => z.$emit("change", n)) }, z.$attrs), { default: q(() => [(d(!0), p(N, null, U(z.images, (n, x) => (d(), le(P(e1), { key: x }, { default: q(() => [l("a", { href: n.link ? n.link : "javascript:;", target: n.link ? "_blank" : "_self", class: "m-link" }, [l("img", { src: n.src, class: "u-img", style: _(`width: ${s.value}; height: ${i.value};`), alt: n.title, loading: "lazy" }, null, 12, co)], 8, uo), l("div", { class: B(`swiper-lazy-preloader swiper-lazy-preloader-${z.preloaderColor}`) }, null, 2)]), _: 2 }, 1024))), 128))]), _: 1 }, 16, ["class", "modules", "navigation", "autoplay"])) : F("", !0), z.type === "carousel" ? (d(), le(P(Xa), ve({ key: 1, class: "swiper-no-swiping", modules: o.value, autoplay: v.value, lazy: "", loop: "", onSwiper: y, onSlideChange: g[1] || (g[1] = (n) => z.$emit("change", n)) }, z.$attrs), { default: q(() => [(d(!0), p(N, null, U(z.images, (n, x) => (d(), le(P(e1), { key: x }, { default: q(() => [l("a", { href: n.link ? n.link : "javascript:;", target: n.link ? "_blank" : "_self", class: "m-link" }, [l("img", { src: n.src, class: "u-img", style: _(`width: ${s.value}; height: ${i.value};`), alt: n.title, loading: "lazy" }, null, 12, po)], 8, ro), l("div", { class: B(`swiper-lazy-preloader swiper-lazy-preloader-${z.preloaderColor}`) }, null, 2)]), _: 2 }, 1024))), 128))]), _: 1 }, 16, ["modules", "autoplay"])) : F("", !0), z.type === "broadcast" ? (d(), le(P(Xa), ve({ key: 2, modules: u.value, navigation: z.navigation, lazy: "", onSwiper: y, onSlideChange: g[2] || (g[2] = (n) => z.$emit("change", n)) }, z.$attrs), { default: q(() => [(d(!0), p(N, null, U(z.images, (n, x) => (d(), le(P(e1), { key: x }, { default: q(() => [l("a", { href: n.link ? n.link : "javascript:;", target: n.link ? "_blank" : "_self", class: "m-link" }, [l("img", { src: n.src, class: "u-img", style: _(`width: ${s.value}; height: ${i.value};`), alt: n.title, loading: "lazy" }, null, 12, fo)], 8, vo), l("div", { class: B(`swiper-lazy-preloader swiper-lazy-preloader-${z.preloaderColor}`) }, null, 2)]), _: 2 }, 1024))), 128))]), _: 1 }, 16, ["modules", "navigation"])) : F("", !0)], 64));
} }), Ia = I(ho, [["__scopeId", "data-v-3d66a64e"]]);
Ia.install = (t) => {
  t.component(Ia.__name, Ia);
};
