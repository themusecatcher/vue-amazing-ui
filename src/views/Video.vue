...
onMounted(() => {
  // rafTimeout(() => { // 模拟接口调用
  //     videoSrc.value = 'https://cdn.jsdelivr.net/gh/themusecatcher/static-resources@0.0.2/Bao.mp4'
  //     videoPoster.value = 'https://cdn.jsdelivr.net/gh/themusecatcher/static-resources@0.0.2/bao.jpg'
  //   }, 1000)
})
</script>
