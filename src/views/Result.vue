  ...
  <div>
    ...
    >
      ...
      <div class="desc">
        ...
        <p>
          <svg focusable="false" class="u-icon" data-icon="close-circle" aria-hidden="true" viewBox="64 64 896 896">
            <path
    ...
    <Result title="Great, we have done all the operations!">
      <template #image>
        <svg focusable="false" class="u-svg" data-icon="smile" aria-hidden="true" viewBox="64 64 896 896">
          <path
