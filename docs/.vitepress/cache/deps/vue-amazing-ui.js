import {
  TransitionPresets,
  useTransition
} from "./chunk-5UGHPD4Q.js";
import {
  useQRCode
} from "./chunk-CRHKMTIE.js";
import "./chunk-CM3LLAKT.js";
import {
  ja
} from "./chunk-5W7JKHNU.js";
import {
  Swiper,
  SwiperSlide
} from "./chunk-BSC3BING.js";
import {
  Fragment,
  Transition,
  TransitionGroup,
...
// node_modules/.pnpm/vue-amazing-ui@0.1.30_@algolia+client-search@4.22.0_@types+node@20.10.5_less@4.2.0_search-ins_ysd2s567ow3hdwnacts7trsj4y/node_modules/vue-amazing-ui/dist/vue-amazing-ui.js
...
var aa = V(defineComponent({ __name: "Alert", props: { message: { default: "" }, description: { default: "" }, type: { default: "info" }, closable: { type: Boolean, default: false }, closeText: { default: "" }, icon: { default: "" }, showIcon: { type: Boolean, default: false } }, emits: ["close"], setup(l, { emit: a }) {
  const e = l, o = ref(), u = useSlots(), d = computed(() => {
    var n;
  ...
  return (p, n) => (openBlock(), createElementBlock("div", { ref_key: "alert", ref: o, class: "m-alert-wrapper" }, [createBaseVNode("div", { class: normalizeClass(["m-alert", [`${p.type}`, { "width-description": d.value }]]) }, [p.showIcon ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [d.value ? (openBlock(), createElementBlock("span", H1, [renderSlot(p.$slots, "icon", {}, () => [p.icon ? (openBlock(), createElementBlock("img", { key: 0, src: p.icon, class: "u-big-icon-img" }, null, 8, I1)) : p.type === "info" ? (openBlock(), createElementBlock("svg", j1, T1)) : p.type === "success" ? (openBlock(), createElementBlock("svg", V1, R1)) : p.type === "warning" ? (openBlock(), createElementBlock("svg", W1, N1)) : p.type === "error" ? (openBlock(), createElementBlock("svg", O1, q1)) : createCommentVNode("", true)], true)])) : (openBlock(), createElementBlock("span", _1, [renderSlot(p.$slots, "icon", {}, () => [p.icon ? (openBlock(), createElementBlock("img", { key: 0, src: p.icon, class: "u-icon-img" }, null, 8, C1)) : p.type === "info" ? (openBlock(), createElementBlock("svg", $1, B1)) : p.type === "success" ? (openBlock(), createElementBlock("svg", F1, L1)) : p.type === "warning" ? (openBlock(), createElementBlock("svg", S1, A1)) : p.type === "error" ? (openBlock(), createElementBlock("svg", D1, E1)) : createCommentVNode("", true)], true)]))], 64)) : createCommentVNode("", true), createBaseVNode("div", P1, [createBaseVNode("div", Y1, [renderSlot(p.$slots, "message", {}, () => [createTextVNode(toDisplayString(p.message), 1)], true)]), d.value ? (openBlock(), createElementBlock("div", U1, [renderSlot(p.$slots, "description", {}, () => [createTextVNode(toDisplayString(p.description), 1)], true)])) : createCommentVNode("", true)]), p.closable ? (openBlock(), createElementBlock("a", { key: 1, class: "m-close", onClick: c }, [renderSlot(p.$slots, "closeText", {}, () => [p.closeText ? (openBlock(), createElementBlock("span", K1, toDisplayString(p.closeText), 1)) : (openBlock(), createElementBlock("svg", Z1, G1))], true)])) : createCommentVNode("", true)], 2)], 512));
...
var la = V(defineComponent({ __name: "Avatar", props: { shape: { default: "circle" }, size: { default: "default" }, src: { default: "" }, alt: { default: "" }, icon: { default: void 0 } }, setup(l) {
  ...
  return (n, h) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-avatar", [u.value === null ? "avatar-" + n.size : "", "avatar-" + n.shape, { "avatar-image": n.src }]]), style: normalizeStyle(u.value || {}) }, [n.src ? (openBlock(), createElementBlock("img", { key: 0, class: "u-image", src: n.src, alt: n.alt }, null, 8, J1)) : createCommentVNode("", true), !n.src && s.value ? (openBlock(), createElementBlock("span", X1, [renderSlot(n.$slots, "icon", {}, void 0, true)])) : createCommentVNode("", true), n.src || s.value || !c.value ? createCommentVNode("", true) : (openBlock(), createElementBlock("span", { key: 2, class: "m-string", style: normalizeStyle(p.value) }, [renderSlot(n.$slots, "default", {}, void 0, true)], 4))], 6));
...
var ta = V(defineComponent({ __name: "BackTop", props: { bottom: { default: 40 }, right: { default: 40 }, visibilityHeight: { default: 180 }, to: { default: "body" }, listenTo: { default: void 0 } }, emits: ["click", "show"], setup(l, { emit: a }) {
  const e = l, o = computed(() => typeof e.bottom == "number" ? e.bottom + "px" : e.bottom), u = computed(() => typeof e.right == "number" ? e.right + "px" : e.right), d = ref(), s = ref(0), c = ref();
  watchEffect(() => {
    nextTick(() => {
      var m;
  ...
  const n = computed(() => s.value >= e.visibilityHeight);
  function h(m) {
  ...
  return watch(n, (m) => {
    x("show", m);
  }), (m, i) => (openBlock(), createBlock(Transition, null, { default: withCtx(() => [withDirectives(createBaseVNode("div", { ref_key: "backtop", ref: d, onClick: M, class: "m-backtop", style: normalizeStyle(`bottom: ${o.value}; right: ${u.value};`) }, [renderSlot(m.$slots, "default", {}, () => [Q1], true)], 4), [[vShow, n.value]])]), _: 3 }));
...
var oa = V(defineComponent({ __name: "Badge", props: { color: { default: "" }, count: { default: 0 }, max: { default: 99 }, showZero: { type: Boolean, default: false }, dot: { type: Boolean, default: false }, status: { default: void 0 }, text: { default: "" }, countStyle: { default: () => ({}) }, title: { default: "" }, ripple: { type: Boolean, default: true } }, setup(l) {
  ...
  return (c, p) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-badge", { "badge-status": c.status }]) }, [c.status || c.color ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createBaseVNode("span", { class: normalizeClass(["u-status-dot", [`status-${c.status || c.color}`, { "dot-ripple": c.ripple }]]), style: normalizeStyle(o.value) }, null, 6), createBaseVNode("span", el, [renderSlot(c.$slots, "default", {}, () => [createTextVNode(toDisplayString(c.text), 1)], true)])], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [d.value ? (openBlock(), createElementBlock("span", al, [renderSlot(c.$slots, "default", {}, void 0, true)])) : createCommentVNode("", true), s.value ? (openBlock(), createElementBlock("span", { key: 1, class: normalizeClass(["m-count", { "only-number": !d.value }]) }, [renderSlot(c.$slots, "count", {}, void 0, true)], 2)) : (openBlock(), createBlock(Transition, { key: 2, name: "zoom" }, { default: withCtx(() => [withDirectives(createBaseVNode("div", { class: normalizeClass(["m-badge-count", { "small-num": c.count < 10, "only-number": !d.value, "only-dot": c.count === 0 && !c.showZero }]), style: normalizeStyle(c.countStyle), title: c.title || String(c.count) }, [c.dot ? createCommentVNode("", true) : (openBlock(), createElementBlock("span", tl, [createBaseVNode("span", ol, toDisplayString(c.count > c.max ? c.max + "+" : c.count), 1)]))], 14, ll), [[vShow, c.showZero || c.count !== 0 || c.dot]])]), _: 1 }))], 64))], 2));
...
var sa = V(defineComponent({ __name: "Breadcrumb", props: { routes: { default: () => [] }, fontSize: { default: 14 }, height: { default: 21 }, maxWidth: { default: 180 }, separator: { default: "" }, target: { default: "_self" } }, setup(l) {
  ...
  return (u, d) => (openBlock(), createElementBlock("div", { class: "m-breadcrumb", style: normalizeStyle(`height: ${u.height}px;`) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(u.routes, (s, c) => (openBlock(), createElementBlock("div", { class: "m-bread", key: c }, [createBaseVNode("a", { class: normalizeClass(["u-route", { active: c === e.value - 1 }]), style: normalizeStyle(`font-size: ${u.fontSize}px; max-width: ${u.maxWidth}px;`), href: c === e.value - 1 ? "javascript:;" : o(s), title: s.name, target: c === e.value - 1 ? "_self" : u.target }, toDisplayString(s.name || "--"), 15, sl), c !== e.value - 1 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [u.separator ? (openBlock(), createElementBlock("span", nl, toDisplayString(u.separator), 1)) : (openBlock(), createElementBlock("svg", il, ul))], 64)) : createCommentVNode("", true)]))), 128)), cl], 4));
...
var xe = V(defineComponent({ __name: "Button", props: { name: { default: "按钮" }, type: { default: "default" }, effect: { default: "fade" }, size: { default: "middle" }, route: { default: () => ({}) }, target: { default: "_self" }, disabled: { type: Boolean, default: false }, loading: { type: Boolean, default: false }, center: { type: Boolean, default: false } }, emits: ["click"], setup(l, { emit: a }) {
  const e = l, o = computed(() => JSON.stringify(e.route) !== "{}"), u = a;
  function d(c) {
    o.value || u("click", c);
  }
  function s(c) {
  ...
  return (c, p) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-btn-wrap", { center: c.center }]) }, [createBaseVNode("a", { onClick: d, href: s(c.route), target: o.value ? c.target : "_self", disabled: c.disabled, class: normalizeClass(["m-btn", [c.type, c.size, { [c.effect]: c.type === "default", disabled: c.disabled, "m-btn-loading": !o.value && c.loading }]]) }, [withDirectives(createBaseVNode("span", { class: normalizeClass(["m-loading-icon", { [`loading-${c.size}`]: c.loading }]) }, [createBaseVNode("span", { class: normalizeClass(["u-spin-circle", `spin-${c.size}`]) }, null, 2)], 2), [[vShow, !o.value]]), createBaseVNode("span", rl, [renderSlot(c.$slots, "default", {}, () => [createTextVNode(toDisplayString(c.name), 1)], true)])], 10, dl)], 2));
...
var na = V(defineComponent({ __name: "Card", props: { width: { default: "auto" }, bordered: { type: Boolean, default: true }, extra: { default: "" }, size: { default: "default" }, title: { default: "" }, headStyle: { default: () => ({}) }, bodyStyle: { default: () => ({}) } }, setup(l) {
  const a = l, e = computed(() => typeof a.width == "number" ? a.width + "px" : a.width), o = useSlots(), u = computed(() => {
    var p, n, h, x;
  ...
  return (d, s) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-card", { bordered: d.bordered, "m-small-card": d.size === "small" }]), style: normalizeStyle(`width: ${e.value};`) }, [u.value ? (openBlock(), createElementBlock("div", { key: 0, class: "m-card-head", style: normalizeStyle(d.headStyle) }, [createBaseVNode("div", vl, [createBaseVNode("div", pl, [renderSlot(d.$slots, "title", {}, () => [createTextVNode(toDisplayString(d.title), 1)], true)]), createBaseVNode("div", fl, [renderSlot(d.$slots, "extra", {}, () => [createTextVNode(toDisplayString(d.extra), 1)], true)])])], 4)) : createCommentVNode("", true), createBaseVNode("div", { class: "m-card-body", style: normalizeStyle(d.bodyStyle) }, [renderSlot(d.$slots, "default", {}, void 0, true)], 4)], 6));
...
var ia = V(defineComponent({ __name: "Carousel", props: { images: { default: () => [] }, interval: { default: 3e3 }, width: { default: "100%" }, height: { default: "100vh" }, navigation: { type: Boolean, default: true }, navColor: { default: "#FFF" }, navSize: { default: 36 }, pagination: { type: Boolean, default: true }, pageActiveColor: { default: "#1677FF" }, pageSize: { default: 10 }, pageStyle: { default: () => ({}) }, disableOnInteraction: { type: Boolean, default: true }, pauseOnMouseEnter: { type: Boolean, default: true } }, setup(l) {
  const a = l, e = ref(true), o = ref(0), u = ref(false), d = ref(), s = ref(), c = ref(), p = ref(false), n = ref(), h = ref(1), x = computed(() => typeof a.width == "number" ? a.width + "px" : a.width), M = computed(() => typeof a.height == "number" ? a.height + "px" : a.height), m = computed(() => (a.images.length + 1) * z.value), i = computed(() => a.images.length);
  onMounted(() => {
    (function() {
      var A = null;
      function q(K) {
  ...
  const b = ref(Array(i.value).fill(false)), g = ref(), k = ref(60), f = computed(() => k.value === 60 ? 12 : k.value / 60 * 12);
  function y(A) {
    b.value[A] = true;
  }
  watch(() => b.value[0], (A) => {
  ...
  function H() {
    i.value > 1 && b.value[0] && (e.value = true, u.value = false, J(), console.log("imageSlider start"));
  }
  function D() {
    Qa(s.value), u.value = true, o.value = Math.ceil(o.value / z.value) * z.value;
  }
  function I() {
    Qa(s.value), u.value = true, o.value = Math.floor(o.value / z.value) * z.value;
  }
  function J() {
    d.value = me(() => {
  ...
  function ae(A) {
    e.value ? D() : (I(), e.value = true), u.value = false, function(q) {
      o.value === i.value * z.value && (o.value = 0), c.value = q, s.value = pe(ne);
    }(A);
  }
  function de(A) {
    e.value ? (D(), e.value = false) : I(), u.value = false, function(q) {
  ...
  function ne() {
    if (o.value >= c.value)
      p.value && (p.value = false, a.disableOnInteraction || a.pauseOnMouseEnter || H());
    else {
      var A = Math.ceil((c.value - o.value) / f.value);
  ...
  return (A, q) => (openBlock(), createElementBlock("div", { class: "m-slider", ref_key: "carousel", ref: n, style: normalizeStyle(`--navColor: ${A.navColor}; --pageActiveColor: ${A.pageActiveColor}; width: ${x.value}; height: ${M.value};`), onMouseenter: q[1] || (q[1] = (K) => A.pauseOnMouseEnter ? (Ce(d.value), d.value = null, e.value ? D() : I(), void console.log("imageSlider stop")) : () => false), onMouseleave: q[2] || (q[2] = (K) => A.pauseOnMouseEnter ? H() : () => false) }, [createBaseVNode("div", { class: normalizeClass({ transition: u.value }), style: normalizeStyle(`width: ${m.value}px; height: 100%; will-change: transform; transform: translateX(${-o.value}px);`) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(A.images, (K, ee) => (openBlock(), createElementBlock("div", { class: "m-image", key: ee }, [createVNode(unref(ie), { spinning: !b.value[ee], indicator: "dynamic-circle" }, { default: withCtx(() => [createBaseVNode("a", { href: K.link ? K.link : "javascript:;", target: K.link ? "_blank" : "_self", class: "m-link" }, [(openBlock(), createElementBlock("img", { onLoad: (le) => y(ee), src: K.src, key: K.src, alt: K.title, class: "u-img", style: normalizeStyle(`width: ${z.value}px; height: ${B.value}px;`) }, null, 44, zl))], 8, Ml)]), _: 2 }, 1032, ["spinning"])]))), 128)), i.value ? (openBlock(), createElementBlock("div", _l, [createVNode(unref(ie), { spinning: !b.value[0], indicator: "dynamic-circle" }, { default: withCtx(() => [createBaseVNode("a", { href: A.images[0].link ? A.images[0].link : "javascript:;", target: A.images[0].link ? "_blank" : "_self", class: "m-link" }, [(openBlock(), createElementBlock("img", { onLoad: q[0] || (q[0] = (K) => y(0)), src: A.images[0].src, key: A.images[0].src, alt: A.images[0].title, class: "u-img", style: normalizeStyle(`width: ${z.value}px; height: ${B.value}px;`) }, null, 44, $l))], 8, Cl)]), _: 1 }, 8, ["spinning"])])) : createCommentVNode("", true)], 6), A.navigation ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [(openBlock(), createElementBlock("svg", { class: "arrow-left", style: normalizeStyle(`width: ${A.navSize}px; height: ${A.navSize}px;`), onClick: ke, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 16 16" }, Bl, 4)), (openBlock(), createElementBlock("svg", { class: "arrow-right", style: normalizeStyle(`width: ${A.navSize}px; height: ${A.navSize}px;`), onClick: we, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 16 16" }, Fl, 4))], 64)) : createCommentVNode("", true), A.pagination ? (openBlock(), createElementBlock("div", Ll, [(openBlock(true), createElementBlock(Fragment, null, renderList(i.value, (K) => (openBlock(), createElementBlock("div", { onClick: (ee) => function(le) {
    if (h.value !== le) {
      p.value = true;
      const Q = (le - 1) * z.value;
      le < h.value && (h.value = le, de(Q)), le > h.value && (h.value = le, ae(Q));
    }
  }(K), class: normalizeClass(["u-circle", { active: h.value === K }]), style: normalizeStyle([{ width: `${A.pageSize}px`, height: `${A.pageSize}px` }, A.pageStyle]), key: K }, null, 14, Sl))), 128))])) : createCommentVNode("", true)], 36));
...
var Se = V(defineComponent({ __name: "Select", props: { options: { default: () => [] }, label: { default: "label" }, value: { default: "value" }, placeholder: { default: "请选择" }, disabled: { type: Boolean, default: false }, allowClear: { type: Boolean, default: false }, search: { type: Boolean, default: false }, filter: { type: [Function, Boolean], default: true }, width: { default: 120 }, height: { default: 32 }, maxDisplay: { default: 6 }, modelValue: { default: null } }, emits: ["update:modelValue", "change"], setup(l, { emit: a }) {
  const e = l, o = ref(), u = ref(), d = ref(), s = ref(), c = ref(false), p = ref(true), n = ref(true), h = ref(false), x = ref(false), M = ref();
  function m() {
    e.allowClear && u.value && (n.value = false, h.value = true, e.search && (x.value = false));
  }
  function i() {
    e.allowClear && h.value && (h.value = false, e.search || (n.value = true)), e.search && (c.value ? (x.value = true, n.value = false, M.value.focus()) : (x.value = false, n.value = true));
  }
  function b() {
    p.value = false;
  }
  function g() {
    s.value = null, p.value = true, M.value.focus();
  }
  watchEffect(() => {
    ...
    (function() {
      if (e.modelValue) {
        ...
        y ? (u.value = y[e.label], s.value = y[e.value]) : (u.value = e.modelValue, s.value = null);
      } else
        u.value = null, s.value = null;
      e.search && (d.value = u.value);
    })();
  }), watch(c, (y) => {
    !y && e.search && (d.value = u.value);
  });
  const k = a;
  function f() {
    h.value = false, u.value = null, s.value = null, c.value = false, n.value = true, k("update:modelValue"), k("change");
  }
  return (y, z) => (openBlock(), createElementBlock("div", { class: "m-select", style: normalizeStyle(`height: ${y.height}px;`) }, [createBaseVNode("div", { class: normalizeClass(["m-select-wrap", { hover: !y.disabled, focus: c.value, disabled: y.disabled }]), style: normalizeStyle(`width: ${y.width}px; height: ${y.height}px;`), tabindex: "1", ref_key: "selectRef", ref: M, onMouseenter: m, onMouseleave: i, onBlur: z[1] || (z[1] = (B) => p.value && !y.disabled ? (c.value && (c.value = false), void (e.search && (x.value = false, n.value = true))) : () => false), onClick: z[2] || (z[2] = (B) => y.disabled ? () => false : function() {
  ...
  }()) }, [y.search ? withDirectives((openBlock(), createElementBlock("input", { key: 1, class: "u-search", style: normalizeStyle(`line-height: ${y.height - 2}px;`), autocomplete: "off", "onUpdate:modelValue": z[0] || (z[0] = (B) => d.value = B), placeholder: u.value || y.placeholder }, null, 12, jl)), [[vModelText, d.value, void 0, { number: true, trim: true }]]) : (openBlock(), createElementBlock("div", { key: 0, class: normalizeClass(["u-select-input", { placeholder: !u.value }]), style: normalizeStyle(`line-height: ${y.height - 2}px;`), title: u.value }, toDisplayString(u.value || y.placeholder), 15, Il)), (openBlock(), createElementBlock("svg", { focusable: "false", class: normalizeClass(["u-svg", { show: x.value }]), "data-icon": "search", "aria-hidden": "true", viewBox: "64 64 896 896" }, Tl, 2)), (openBlock(), createElementBlock("svg", { class: normalizeClass(["u-svg", { rotate: c.value, show: n.value }]), viewBox: "64 64 896 896", "data-icon": "down", "aria-hidden": "true", focusable: "false" }, Vl, 2)), (openBlock(), createElementBlock("svg", { onClick: withModifiers(f, ["stop"]), class: normalizeClass(["close", { show: h.value }]), focusable: "false", "data-icon": "close-circle", "aria-hidden": "true", viewBox: "64 64 896 896" }, Rl, 2))], 38), createVNode(TransitionGroup, { name: "fade", tag: "div" }, { default: withCtx(() => [withDirectives(createBaseVNode("div", { class: "m-options-panel", onMouseenter: b, onMouseleave: g, key: "1", style: normalizeStyle(`top: ${y.height + 4}px; line-height: ${y.height - 10}px; max-height: ${y.maxDisplay * y.height + 9}px; width: ${y.width}px;`) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(o.value, (B, E) => (openBlock(), createElementBlock("p", { key: E, class: normalizeClass(["u-option", { "option-hover": !B.disabled && B[y.value] === s.value, "option-selected": B[y.label] === u.value, "option-disabled": B.disabled }]), title: B[y.label], onMouseenter: (H) => {
    return D = B[y.value], void (s.value = D);
    var D;
  }, onClick: (H) => B.disabled ? () => false : function(D, I, J) {
    e.modelValue !== D && (u.value = I, s.value = D, k("update:modelValue", D), k("change", D, I, J)), c.value = false, e.search && (x.value = false, n.value = true);
  }(B[y.value], B[y.label], E) }, toDisplayString(B[y.label]), 43, Wl))), 128))], 36), [[vShow, c.value && o.value && o.value.length]]), withDirectives(createBaseVNode("div", { key: "2", class: "m-empty-wrap", style: normalizeStyle(`top: ${y.height + 4}px; width: ${y.width}px;`) }, [createVNode(unref(He), { image: "2", key: "2" })], 4), [[vShow, c.value && o.value && !o.value.length]])]), _: 1 })], 4));
...
var ua = V(defineComponent({ __name: "Cascader", props: { options: { default: () => [] }, label: { default: "label" }, value: { default: "value" }, children: { default: "children" }, placeholder: { default: "请选择" }, changeOnSelect: { type: Boolean, default: false }, gap: { default: 8 }, width: { default: 120 }, height: { default: 32 }, disabled: { type: [Boolean, Array], default: false }, allowClear: { type: Boolean, default: false }, search: { type: Boolean, default: false }, filter: { type: [Function, Boolean], default: true }, maxDisplay: { default: 6 }, selectedValue: { default: () => [] } }, emits: ["update:selectedValue", "change"], setup(l, { emit: a }) {
  const e = l, o = ref([]), u = ref([]), d = ref([]), s = ref([]), c = ref([]);
  function p(i, b) {
    const g = i.length;
    for (let k = 0; k < g; k++)
  ...
  return (i, b) => (openBlock(), createElementBlock("div", { class: "m-cascader", style: normalizeStyle(`height: ${i.height}px; gap: ${i.gap}px;`) }, [createVNode(unref(Se), { options: d.value, label: i.label, value: i.value, placeholder: Array.isArray(i.placeholder) ? i.placeholder[0] : i.placeholder, disabled: Array.isArray(i.disabled) ? i.disabled[0] : i.disabled, "allow-clear": i.allowClear, search: i.search, filter: i.filter, width: Array.isArray(i.width) ? i.width[0] : i.width, height: i.height, "max-display": i.maxDisplay, modelValue: o.value[0], "onUpdate:modelValue": b[0] || (b[0] = (g) => o.value[0] = g), onChange: x }, null, 8, ["options", "label", "value", "placeholder", "disabled", "allow-clear", "search", "filter", "width", "height", "max-display", "modelValue"]), createVNode(unref(Se), { options: s.value, label: i.label, value: i.value, placeholder: Array.isArray(i.placeholder) ? i.placeholder[1] : i.placeholder, disabled: Array.isArray(i.disabled) ? i.disabled[1] : i.disabled, "allow-clear": i.allowClear, search: i.search, filter: i.filter, width: Array.isArray(i.width) ? i.width[1] : i.width, height: i.height, "max-display": i.maxDisplay, modelValue: o.value[1], "onUpdate:modelValue": b[1] || (b[1] = (g) => o.value[1] = g), onChange: M }, null, 8, ["options", "label", "value", "placeholder", "disabled", "allow-clear", "search", "filter", "width", "height", "max-display", "modelValue"]), createVNode(unref(Se), { options: c.value, label: i.label, value: i.value, placeholder: Array.isArray(i.placeholder) ? i.placeholder[2] : i.placeholder, disabled: Array.isArray(i.disabled) ? i.disabled[2] : i.disabled, "allow-clear": i.allowClear, search: i.search, filter: i.filter, width: Array.isArray(i.width) ? i.width[2] : i.width, height: i.height, "max-display": i.maxDisplay, modelValue: o.value[2], "onUpdate:modelValue": b[2] || (b[2] = (g) => o.value[2] = g), onChange: m }, null, 8, ["options", "label", "value", "placeholder", "disabled", "allow-clear", "search", "filter", "width", "height", "max-display", "modelValue"])], 4));
...
var ca = V(defineComponent({ __name: "Checkbox", props: { options: { default: () => [] }, disabled: { type: Boolean, default: false }, vertical: { type: Boolean, default: false }, value: { default: () => [] }, gap: { default: 8 }, width: { default: "auto" }, height: { default: "auto" }, indeterminate: { type: Boolean, default: false }, checked: { type: Boolean, default: false } }, emits: ["update:value", "update:checked", "change"], setup(l, { emit: a }) {
  const e = l, o = computed(() => e.options.length), u = computed(() => typeof e.width == "number" ? e.width + "px" : e.width), d = computed(() => typeof e.height == "number" ? e.height + "px" : e.height), s = ref(e.value);
  watch(() => e.value, (h) => {
    s.value = h;
  });
  const c = computed(() => e.vertical ? { marginBottom: e.gap + "px" } : { marginRight: e.gap + "px" }), p = a;
  function n() {
    p("update:checked", !e.checked);
  }
  return (h, x) => (openBlock(), createElementBlock("div", { class: "m-checkbox", style: normalizeStyle(`max-width: ${u.value}; max-height: ${d.value};`) }, [o.value ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(h.options, (M, m) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-checkbox-wrap", { vertical: h.vertical }]), style: normalizeStyle(o.value !== m + 1 ? c.value : ""), key: m }, [createBaseVNode("div", { class: normalizeClass(["m-box", { disabled: h.disabled || M.disabled }]), onClick: (i) => h.disabled || M.disabled ? () => false : function(b) {
  ...
  }(M.value) }, [createBaseVNode("span", { class: normalizeClass(["u-checkbox", { "u-checkbox-checked": s.value.includes(M.value) }]) }, null, 2), createBaseVNode("span", Ol, [renderSlot(h.$slots, "default", { label: M.label }, () => [createTextVNode(toDisplayString(M.label), 1)], true)])], 10, Nl)], 6))), 128)) : (openBlock(), createElementBlock("div", ql, [createBaseVNode("div", { class: normalizeClass(["m-box", { disabled: h.disabled }]), onClick: n }, [createBaseVNode("span", { class: normalizeClass(["u-checkbox", { "u-checkbox-checked": h.checked && !h.indeterminate, indeterminate: h.indeterminate }]) }, null, 2), createBaseVNode("span", Pl, [renderSlot(h.$slots, "default", {}, () => [createTextVNode("Check all")], true)])], 2)]))], 4));
...
var da = V(defineComponent({ __name: "Col", props: { span: { default: void 0 }, offset: { default: 0 }, flex: { default: "" }, xs: { default: void 0 }, sm: { default: void 0 }, md: { default: void 0 }, lg: { default: void 0 }, xl: { default: void 0 }, xxl: { default: void 0 } }, setup(l) {
  ...
  return onMounted(() => {
    ...
    var p, n;
    return openBlock(), createElementBlock("div", { class: normalizeClass(`m-col col-${((p = o.value) == null ? void 0 : p.span) || s.span} offset-${((n = o.value) == null ? void 0 : n.offset) || s.offset}`), style: normalizeStyle([{ "padding-left": "var(--xGap)", "padding-right": "var(--xGap)" }, `flex: ${e.value}`]) }, [renderSlot(s.$slots, "default", {}, void 0, true)], 6);
  };
...
var Zl = [((l) => (pushScopeId("data-v-7bb27cfd"), l = l(), popScopeId(), l))(() => createBaseVNode("path", { d: "M765.7 486.8L314.9 134.7A7.97 7.97 0 00302 141v77.3c0 4.9 2.3 9.6 6.1 12.6l360 281.1-360 281.1c-3.9 3-6.1 7.7-6.1 12.6V883c0 6.7 7.7 10.4 12.9 6.3l450.8-352.1a31.96 31.96 0 000-50.4z" }, null, -1))];
var Gl = { class: "u-lang" };
var ra = V(defineComponent({ __name: "Collapse", props: { collapseData: { default: () => [] }, activeKey: { default: null }, copyable: { type: Boolean, default: false }, lang: { default: "" }, fontSize: { default: 14 }, headerFontSize: { default: 0 }, textFontSize: { default: 0 }, showArrow: { type: Boolean, default: true } }, emits: ["update:activeKey", "change"], setup(l, { emit: a }) {
  ...
  return (n, h) => {
    ...
    return openBlock(), createElementBlock("div", Yl, [(openBlock(true), createElementBlock(Fragment, null, renderList(n.collapseData, (M, m) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-collapse-item", { "u-collapse-item-active": c(M.key || m) }]), key: m }, [createBaseVNode("div", { class: "u-collapse-header", onClick: (i) => {
      var b;
      c(b = M.key || m) ? Array.isArray(e.activeKey) ? s(e.activeKey.filter((g) => g !== b)) : s(null) : Array.isArray(e.activeKey) ? s([...e.activeKey, b]) : s(b);
    } }, [n.showArrow ? (openBlock(), createElementBlock("svg", Kl, Zl)) : createCommentVNode("", true), createBaseVNode("div", { class: normalizeClass(["u-header", { ml24: n.showArrow }]), style: normalizeStyle(`font-size: ${n.headerFontSize || n.fontSize}px;`) }, [renderSlot(n.$slots, "header", { header: M.header, key: M.key || m }, () => [createTextVNode(toDisplayString(M.header || "--"), 1)], true)], 6)], 8, Ul), createBaseVNode("div", { class: normalizeClass(["u-collapse-content", { "u-collapse-copyable": n.copyable }]), style: normalizeStyle(`height: ${c(M.key || m) ? u.value[m] : 0}px; opacity: ${c(M.key || m) ? 1 : 0};`) }, [createBaseVNode("div", Gl, [renderSlot(n.$slots, "lang", { lang: n.lang, key: M.key || m }, () => [createTextVNode(toDisplayString(n.lang), 1)], true)]), createVNode(x, { size: "small", class: "u-copy", type: "primary", onClick: (i) => function(b) {
...
var va = V(defineComponent({ __name: "Countdown", props: { title: { default: "Countdown" }, value: { default: void 0 }, future: { type: Boolean, default: true }, format: { default: "HH:mm:ss" }, prefix: { default: "" }, suffix: { default: "" }, titleStyle: { default: () => ({}) }, valueStyle: { default: () => ({}) }, finishedText: { default: "Finished" } }, emits: ["finish"], setup(l, { emit: a }) {
  const e = l, o = useSlots(), u = computed(() => {
    var i;
  ...
  }), s = ref(0), c = ref(), p = computed(() => ({ showMillisecond: e.format.includes("SSS"), showYear: e.format.includes("Y"), showMonth: e.format.includes("M"), showDay: e.format.includes("D"), showHour: e.format.includes("H"), showMinute: e.format.includes("m"), showSecond: e.format.includes("s") }));
  function n(m) {
  ...
  function h(m) {
    ...
    if (m = Math.floor(m / 1e3), p.value.showYear) {
      ...
      i = i.includes("YY") ? i.replace("YY", n(g)) : i.replace("Y", String(g));
    } else
      g = 0;
    if (p.value.showMonth) {
      m -= 60 * g * 60 * 24 * 30 * 12;
      var k = Math.floor(m / 2592e3);
      i = i.includes("MM") ? i.replace("MM", n(k)) : i.replace("M", String(k));
    } else
      k = 0;
    if (p.value.showDay) {
      m -= 60 * k * 60 * 24 * 30;
  ...
  }), (m, i) => (openBlock(), createElementBlock("div", Jl, [createBaseVNode("div", { class: "u-title", style: normalizeStyle(m.titleStyle) }, [renderSlot(m.$slots, "title", {}, () => [createTextVNode(toDisplayString(e.title), 1)], true)], 4), createBaseVNode("div", Xl, [u.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [u.value || c.value > 0 || c.value === null ? (openBlock(), createElementBlock("span", Ql, [renderSlot(m.$slots, "prefix", {}, () => [createTextVNode(toDisplayString(m.prefix), 1)], true)])) : createCommentVNode("", true)], 64)) : createCommentVNode("", true), m.finishedText && c.value === 0 && c.value !== null ? (openBlock(), createElementBlock("span", { key: 1, class: "u-time-value", style: normalizeStyle(m.valueStyle) }, [renderSlot(m.$slots, "finish", {}, () => [createTextVNode(toDisplayString(m.finishedText), 1)], true)], 4)) : createCommentVNode("", true), Number.isFinite(c.value) && c.value > 0 ? (openBlock(), createElementBlock("span", { key: 2, class: "u-time-value", style: normalizeStyle(m.valueStyle) }, toDisplayString(h(c.value)), 5)) : createCommentVNode("", true), d.value ? (openBlock(), createElementBlock(Fragment, { key: 3 }, [d.value || c.value > 0 || c.value === null ? (openBlock(), createElementBlock("span", et, [renderSlot(m.$slots, "suffix", {}, () => [createTextVNode(toDisplayString(m.suffix), 1)], true)])) : createCommentVNode("", true)], 64)) : createCommentVNode("", true)])]));
...
var pa = V(defineComponent({ inheritAttrs: false, __name: "DatePicker", props: { width: { default: 180 }, mode: { default: "date" }, showTime: { type: Boolean, default: false }, showToday: { type: Boolean, default: false }, modelType: { default: "format" } }, setup(l) {
  const a = l, e = computed(() => a.mode === "time"), o = computed(() => a.mode === "week"), u = computed(() => a.mode === "month"), d = computed(() => a.mode === "year");
  return (s, c) => (openBlock(), createElementBlock("div", { class: "m-datepicker", style: normalizeStyle(`width: ${s.width}px;`) }, [createVNode(unref(ja), mergeProps({ locale: "zh-CN", "month-change-on-scroll": false, "enable-time-picker": s.showTime, "time-picker": e.value, "week-picker": o.value, "month-picker": u.value, "year-picker": d.value, "now-button-label": "今天", "show-now-button": s.showToday, "auto-apply": "", "text-input": "", "model-type": s.modelType, "day-names": ["一", "二", "三", "四", "五", "六", "七"] }, s.$attrs), null, 16, ["enable-time-picker", "time-picker", "week-picker", "month-picker", "year-picker", "show-now-button", "model-type"])], 4));
...
var fa = V(defineComponent({ __name: "Descriptions", props: { title: { default: "" }, bordered: { type: Boolean, default: false }, column: { default: () => ({ xs: 1, sm: 2, md: 3 }) }, extra: { default: "" }, size: { default: "default" }, labelStyle: { default: () => ({}) }, contentStyle: { default: () => ({}) } }, setup(l) {
  ...
  const u = computed(() => typeof a.column == "object" ? e.value >= 1600 && a.column.xxl ? a.column.xxl : e.value >= 1200 && a.column.xl ? a.column.xl : e.value >= 992 && a.column.lg ? a.column.lg : e.value >= 768 && a.column.md ? a.column.md : e.value >= 576 && a.column.sm ? a.column.sm : e.value < 576 && a.column.xs ? a.column.xs : 1 : a.column), d = ref(), s = ref(), c = ref(), p = ref(), n = ref([]), h = computed(() => n.value.length);
  function x(i, b) {
    const g = i.length;
    let k = [];
    for (let f = 0; f < g; f++) {
      const y = { span: Math.min(i[f].dataset.span, b), element: i[f] };
      M(k) < b ? (y.span = Math.min(y.span, b - M(k)), f === g - 1 && (y.span = b - M(k)), k.push(y), f === g - 1 && n.value.push(k)) : (n.value.push(k), k = [y], f === g - 1 && (y.span = b, n.value.push(k)));
    }
    a.bordered ? nextTick(() => {
      n.value.forEach((f, y) => {
        f.forEach((z) => {
          const B = Array.from(z.element.children), E = B[0].cloneNode(true);
          E.colSpan = 1, m(E, a.labelStyle), m(E, JSON.parse(z.element.dataset.labelStyle));
          const H = B[1].cloneNode(true);
          H.colSpan = 2 * z.span - 1, m(H, a.contentStyle), m(H, JSON.parse(z.element.dataset.contentStyle)), p.value[y].appendChild(E), p.value[y].appendChild(H);
        });
      });
    }) : nextTick(() => {
      i.forEach((f, y) => {
        ...
        const E = z[1];
        m(E, a.contentStyle), m(E, JSON.parse(f.dataset.contentStyle)), c.value[y].appendChild(f);
      });
    });
  }
  function M(i) {
    return i.reduce((b, g) => b + g.span, 0);
  }
  function m(i, b) {
  ...
  }), (i, b) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-desc", `desc-${i.size}`]) }, [createBaseVNode("div", at, [createBaseVNode("div", lt, [renderSlot(i.$slots, "title", {}, () => [createTextVNode(toDisplayString(i.title), 1)], true)]), createBaseVNode("div", tt, [renderSlot(i.$slots, "extra", {}, () => [createTextVNode(toDisplayString(i.extra), 1)], true)])]), withDirectives(createBaseVNode("div", { ref_key: "view", ref: d }, [renderSlot(i.$slots, "default", {}, void 0, true)], 512), [[vShow, false]]), createBaseVNode("div", { class: normalizeClass(["m-desc-view", { "m-bordered": i.bordered }]) }, [createBaseVNode("table", null, [i.bordered ? (openBlock(), createElementBlock("tbody", nt, [h.value ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(h.value, (g) => (openBlock(), createElementBlock("tr", { ref_for: true, ref_key: "rows", ref: p, class: "tr-bordered", key: g }))), 128)) : createCommentVNode("", true)])) : (openBlock(), createElementBlock("tbody", ot, [(openBlock(true), createElementBlock(Fragment, null, renderList(n.value, (g, k) => (openBlock(), createElementBlock("tr", { key: k }, [(openBlock(true), createElementBlock(Fragment, null, renderList(g, (f, y) => (openBlock(), createElementBlock("td", { ref_for: true, ref_key: "cols", ref: c, class: "u-item-td", colspan: f.span, key: y }, null, 8, st))), 128))]))), 128))]))])], 2)], 2));
...
var ma = V(defineComponent({ __name: "Dialog", props: { title: { default: "提示" }, content: { default: "" }, width: { default: 540 }, height: { default: "auto" }, switchFullscreen: { type: Boolean, default: false }, cancelText: { default: "取消" }, okText: { default: "确定" }, footer: { type: Boolean, default: false }, center: { type: Boolean, default: true }, top: { default: 100 }, loading: { type: Boolean, default: false }, bodyStyle: { default: () => ({}) }, visible: { type: Boolean, default: false } }, emits: ["close", "cancel", "ok"], setup(l, { emit: a }) {
  const e = l, o = ref(false), u = computed(() => typeof e.height == "number" ? e.height + "px" : e.height);
  watch(() => e.visible, (x) => {
    x && (o.value = false);
  });
  const d = a;
  ...
  return (x, M) => (openBlock(), createElementBlock("div", pt, [createVNode(Transition, { name: "mask" }, { default: withCtx(() => [withDirectives(createBaseVNode("div", ft, null, 512), [[vShow, x.visible]])]), _: 1 }), createVNode(Transition, null, { default: withCtx(() => [withDirectives(createBaseVNode("div", { class: "m-dialog-wrap", onClick: withModifiers(s, ["self"]) }, [createBaseVNode("div", { ref: "dialog", class: normalizeClass(["m-dialog", x.center ? "relative-hv-center" : "top-center"]), style: normalizeStyle(`width: ${o.value ? "100%" : e.width + "px"}; top: ${x.center ? "50%" : o.value ? 0 : x.top + "px"};`) }, [createBaseVNode("div", { class: normalizeClass(["m-dialog-content", { loading: x.loading }]), style: normalizeStyle(`--height: ${o.value ? "100vh" : u.value}`) }, [createVNode(unref(ie), { class: "u-spin", spinning: x.loading, size: "small" }, null, 8, ["spinning"]), createBaseVNode("div", ht, [createBaseVNode("p", mt, [renderSlot(x.$slots, "title", {}, () => [createTextVNode(toDisplayString(x.title), 1)], true)])]), x.switchFullscreen ? (openBlock(), createElementBlock("span", { key: 0, class: "m-screen", onClick: c }, [withDirectives((openBlock(), createElementBlock("svg", gt, yt, 512)), [[vShow, !o.value]]), withDirectives((openBlock(), createElementBlock("svg", bt, kt, 512)), [[vShow, o.value]])])) : createCommentVNode("", true), createBaseVNode("span", { class: "m-close", onClick: p }, wt), createBaseVNode("div", { class: "m-dialog-body", style: normalizeStyle(x.bodyStyle) }, [renderSlot(x.$slots, "default", {}, () => [createTextVNode(toDisplayString(x.content), 1)], true)], 4), withDirectives(createBaseVNode("div", xt, [createVNode(unref(xe), { class: "mr8", onClick: n }, { default: withCtx(() => [createTextVNode(toDisplayString(x.cancelText), 1)]), _: 1 }), createVNode(unref(xe), { type: "primary", onClick: h }, { default: withCtx(() => [createTextVNode(toDisplayString(x.okText), 1)]), _: 1 })], 512), [[vShow, x.footer]])], 6)], 6)], 512), [[vShow, x.visible]])]), _: 3 })]));
...
var ga = V(defineComponent({ __name: "Divider", props: { dashed: { type: Boolean, default: false }, orientation: { default: "center" }, orientationMargin: { default: "" }, borderWidth: { default: 1 }, type: { default: "horizontal" } }, setup(l) {
  ...
  }), o = useSlots(), u = computed(() => {
    var s, c;
    const d = (s = o.default) == null ? void 0 : s.call(o);
    return !!d && !!(d[0].children !== "v-if" && ((c = d[0].children) != null && c.length));
  });
  return (d, s) => d.type === "horizontal" ? (openBlock(), createElementBlock("div", { key: 0, class: normalizeClass([`m-divider-horizontal ${d.orientation}`, { dashed: d.dashed, margin24: !u.value, marginLeft: d.orientationMargin !== "" && d.orientation === "left", marginRight: d.orientationMargin !== "" && d.orientation === "right" }]), style: normalizeStyle(`--border-width: ${d.borderWidth}px;`) }, [d.orientation === "left" ? withDirectives((openBlock(), createElementBlock("span", { key: 0, class: "u-text", style: normalizeStyle(`margin-left: ${e.value};`) }, [renderSlot(d.$slots, "default", {}, void 0, true)], 4)), [[vShow, u.value]]) : d.orientation === "right" ? withDirectives((openBlock(), createElementBlock("span", { key: 1, class: "u-text", style: normalizeStyle(`margin-right: ${e.value};`) }, [renderSlot(d.$slots, "default", {}, void 0, true)], 4)), [[vShow, u.value]]) : withDirectives((openBlock(), createElementBlock("span", Mt, [renderSlot(d.$slots, "default", {}, void 0, true)], 512)), [[vShow, u.value]])], 6)) : (openBlock(), createElementBlock("div", zt));
...
var ya = V(defineComponent({ __name: "Drawer", props: { title: { default: "" }, width: { default: 378 }, height: { default: 378 }, closable: { type: Boolean, default: true }, destroyOnClose: { type: Boolean, default: false }, extra: { default: "" }, placement: { default: "right" }, zIndex: { default: 1e3 }, open: { type: Boolean, default: false } }, emits: ["update:open", "close"], setup(l, { emit: a }) {
  const e = l, o = computed(() => typeof e.width == "number" ? e.width + "px" : e.width), u = computed(() => typeof e.height == "number" ? e.height + "px" : e.height), d = a;
  function s(p) {
    c(p);
  }
  function c(p) {
  ...
  return (p, n) => (openBlock(), createElementBlock("div", _t, [createVNode(Transition, { name: "fade" }, { default: withCtx(() => [withDirectives(createBaseVNode("div", { class: "m-drawer-mask", onClick: withModifiers(s, ["self"]) }, null, 512), [[vShow, p.open]])]), _: 1 }), createVNode(Transition, { name: `motion-${p.placement}` }, { default: withCtx(() => [withDirectives(createBaseVNode("div", { class: normalizeClass(["m-drawer-wrapper", `drawer-${p.placement}`]), style: normalizeStyle(`z-index: ${p.zIndex}; ${["top", "bottom"].includes(p.placement) ? "height:" + u.value : "width:" + o.value};`) }, [createBaseVNode("div", Ct, [p.destroyOnClose ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", $t, [createBaseVNode("div", Bt, [createBaseVNode("div", Ft, [p.closable ? (openBlock(), createElementBlock("svg", { key: 0, focusable: "false", onClick: c, class: "u-close", "data-icon": "close", width: "1em", height: "1em", fill: "currentColor", "aria-hidden": "true", viewBox: "64 64 896 896" }, Lt)) : createCommentVNode("", true), createBaseVNode("p", St, [renderSlot(p.$slots, "title", {}, () => [createTextVNode(toDisplayString(p.title), 1)], true)])]), createBaseVNode("div", At, [renderSlot(p.$slots, "extra", {}, () => [createTextVNode(toDisplayString(p.extra), 1)], true)])]), createBaseVNode("div", Dt, [renderSlot(p.$slots, "default", {}, void 0, true)])])), p.destroyOnClose && p.open ? (openBlock(), createElementBlock("div", Et, [createBaseVNode("div", Ht, [createBaseVNode("div", It, [(openBlock(), createElementBlock("svg", { focusable: "false", onClick: c, class: "u-close", "data-icon": "close", width: "1em", height: "1em", fill: "currentColor", "aria-hidden": "true", viewBox: "64 64 896 896" }, jt)), createBaseVNode("p", Tt, [renderSlot(p.$slots, "title", {}, () => [createTextVNode(toDisplayString(p.title), 1)], true)])]), createBaseVNode("div", Vt, [renderSlot(p.$slots, "extra", {}, () => [createTextVNode(toDisplayString(p.extra), 1)], true)])]), createBaseVNode("div", Rt, [renderSlot(p.$slots, "default", {}, void 0, true)])])) : createCommentVNode("", true)])], 6), [[vShow, p.open]])]), _: 3 }, 8, ["name"])]));
...
var qe = V(defineComponent({ __name: "Tooltip", props: { maxWidth: { default: 120 }, content: { default: "暂无内容" }, tooltip: { default: "暂无提示" }, fontSize: { default: 14 }, color: { default: "#FFF" }, backgroundColor: { default: "rgba(0, 0, 0, .85)" }, overlayStyle: { default: () => ({}) } }, emits: ["openChange"], setup(l, { emit: a }) {
  const e = ref(false), o = ref(), u = ref(0), d = ref(0), s = ref(), c = ref(), p = a;
  function n() {
    (function() {
  ...
  return (x, M) => (openBlock(), createElementBlock("div", { class: "m-tooltip", onMouseenter: n, onMouseleave: h }, [createBaseVNode("div", { ref_key: "tooltipRef", ref: c, class: normalizeClass(["m-tooltip-content", { "show-tip": e.value }]), style: normalizeStyle(`--tooltip-font-size: ${x.fontSize}px; --tooltip-color: ${x.color}; --tooltip-background-color: ${x.backgroundColor}; max-width: ${x.maxWidth}px; top: ${-u.value}px; left: ${-d.value}px;`), onMouseenter: n, onMouseleave: h }, [createBaseVNode("div", { class: "u-tooltip", style: normalizeStyle(x.overlayStyle) }, [renderSlot(x.$slots, "tooltip", {}, () => [createTextVNode(toDisplayString(x.tooltip), 1)], true)], 4), Wt], 38), createBaseVNode("div", { ref_key: "contentRef", ref: s }, [renderSlot(x.$slots, "default", {}, () => [createTextVNode(toDisplayString(x.content), 1)], true)], 512)], 32));
...
var ba = V(defineComponent({ __name: "Ellipsis", props: { maxWidth: { default: "100%" }, line: { default: void 0 }, expand: { type: Boolean, default: false }, tooltip: { type: Boolean, default: true }, tooltipMaxWidth: { default: void 0 }, tooltipFontSize: { default: 14 }, tooltipColor: { default: "#FFF" }, tooltipBackgroundColor: { default: "rgba(0, 0, 0, .85)" }, tooltipOverlayStyle: { default: () => ({ padding: "8px 12px", textAlign: "justify" }) } }, emits: ["expandChange"], setup(l, { emit: a }) {
  const e = l, o = computed(() => typeof e.maxWidth == "number" ? e.maxWidth + "px" : e.maxWidth), u = ref(), d = ref(), s = ref();
  watchEffect(() => {
    u.value = e.tooltip;
  }), watchEffect(() => {
  ...
  const c = a;
  function p() {
    d.value.style["-webkit-line-clamp"] ? (e.tooltip ? (u.value = false, nextTick(() => {
      d.value.style["-webkit-line-clamp"] = "";
    })) : d.value.style["-webkit-line-clamp"] = "", c("expandChange", true)) : (e.tooltip && (u.value = true), d.value.style["-webkit-line-clamp"] = e.line, c("expandChange", false));
  }
  return (n, h) => u.value ? (openBlock(), createBlock(unref(qe), { key: 0, "max-width": s.value, fontSize: n.tooltipFontSize, color: n.tooltipColor, backgroundColor: n.tooltipBackgroundColor, overlayStyle: n.tooltipOverlayStyle }, { tooltip: withCtx(() => [renderSlot(n.$slots, "tooltip", {}, () => [renderSlot(n.$slots, "default", {}, void 0, true)], true)]), default: withCtx(() => [createBaseVNode("div", mergeProps({ ref_key: "ellipsis", ref: d, class: ["m-ellipsis", [n.line ? "ellipsis-line" : "not-ellipsis-line", { "cursor-pointer": n.expand }]], style: `-webkit-line-clamp: ${n.line}; max-width: ${o.value};`, onClick: h[0] || (h[0] = (x) => n.expand ? p() : () => false) }, n.$attrs), [renderSlot(n.$slots, "default", {}, void 0, true)], 16)]), _: 3 }, 8, ["max-width", "fontSize", "color", "backgroundColor", "overlayStyle"])) : (openBlock(), createElementBlock("div", mergeProps({ key: 1, ref_key: "ellipsis", ref: d, class: ["m-ellipsis", [n.line ? "ellipsis-line" : "not-ellipsis-line", { "cursor-pointer": n.expand }]], style: `-webkit-line-clamp: ${n.line}; max-width: ${o.value};`, onClick: h[1] || (h[1] = (x) => n.expand ? p() : () => false) }, n.$attrs), [renderSlot(n.$slots, "default", {}, void 0, true)], 16));
...
var ka = V(defineComponent({ __name: "Flex", props: { width: { default: "auto" }, vertical: { type: Boolean, default: false }, wrap: { default: "nowrap" }, justify: { default: "normal" }, align: { default: "normal" }, gap: { default: void 0 } }, setup(l) {
  ...
  return (u, d) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-flex", { "flex-vertical": u.vertical }]), style: normalizeStyle(`
      width: ${e.value};
      gap: ${o.value};
...
var Ae = V(defineComponent({ __name: "Space", props: { width: { default: "auto" }, align: { default: "start" }, direction: { default: "horizontal" }, size: { default: "small" }, wrap: { type: Boolean, default: true } }, setup(l) {
  const a = l, e = computed(() => typeof a.width == "number" ? a.width + "px" : a.width), o = computed(() => {
    if (typeof a.size == "number")
      return a.size + "px";
  ...
  return (u, d) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-space", [`${u.direction} ${u.align}`, { wrap: u.wrap }]]), style: normalizeStyle(`width: ${e.value}; gap: ${o.value}; margin-bottom: -${Array.isArray(a.size) && u.wrap ? a.size[1] : 0}px;`) }, [renderSlot(u.$slots, "default", {}, void 0, true)], 6));
} }), [["__scopeId", "data-v-15e6c265"]]);
Ae.install = (l) => {
  l.component(Ae.__name, Ae);
};
var be = (l) => (pushScopeId("data-v-fbf55b26"), l = l(), popScopeId(), l);
...
var d2 = defineComponent({ __name: "Image", props: { src: { default: "" }, name: { default: "" }, width: { default: 200 }, height: { default: 200 }, bordered: { type: Boolean, default: true }, gap: { default: 8 }, fit: { default: "contain" }, preview: { default: "预览" }, zoomRatio: { default: 0.1 }, minZoomScale: { default: 0.1 }, maxZoomScale: { default: 10 }, resetOnDbclick: { type: Boolean, default: true }, loop: { type: Boolean, default: false }, album: { type: Boolean, default: false } }, setup(l, { expose: a }) {
  const e = l, o = computed(() => typeof e.width == "number" ? e.width + "px" : e.width), u = computed(() => typeof e.height == "number" ? e.height + "px" : e.height), d = ref([]);
  watchEffect(() => {
    d.value = Array.isArray(e.src) ? e.src : [{ src: e.src, name: e.name }];
  });
  const s = computed(() => d.value.length);
  onMounted(() => {
    document.addEventListener("keydown", y);
  }), onUnmounted(() => {
    document.removeEventListener("keydown", y);
  });
  const c = ref(Array(s.value).fill(false)), p = ref(Array(s.value).fill(false)), n = ref(0), h = ref(false), x = ref(0), M = ref(1), m = ref(1), i = ref(1), b = ref(0), g = ref(0), k = ref(0), f = ref(0);
  function y(A) {
  ...
  function B(A) {
    M.value = 1, x.value = 0, k.value = 0, f.value = 0, h.value = true, n.value = A;
  }
  function E(A, q) {
  ...
  function J() {
    M.value = 1, m.value = 1, i.value = 1, x.value = 0, k.value = 0, f.value = 0;
  }
  function ae() {
    x.value += 90;
  }
  ...
  return a({ onPreview: B }), (A, q) => (openBlock(), createElementBlock("div", Nt, [createVNode(unref(Ae), { size: A.gap }, { default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(d.value, (K, ee) => withDirectives((openBlock(), createElementBlock("div", { class: normalizeClass(["m-image", { bordered: A.bordered, "image-hover-mask": c.value[ee] }]), style: normalizeStyle(`width: ${o.value}; height: ${u.value};`), key: ee }, [createVNode(unref(ie), { spinning: !c.value[ee], indicator: "dynamic-circle" }, { default: withCtx(() => [createBaseVNode("img", { class: "u-image", style: normalizeStyle(`width: calc(${o.value} - 2px); height: calc(${u.value} - 2px); object-fit: ${A.fit};`), onLoad: (le) => {
    return Q = ee, void (c.value[Q] = true);
    var Q;
  }, src: K.src, alt: K.name }, null, 44, Ot)]), _: 2 }, 1032, ["spinning"]), createBaseVNode("div", { class: "m-image-mask", onClick: (le) => B(ee) }, [createBaseVNode("div", Pt, [Yt, createBaseVNode("p", Ut, [renderSlot(A.$slots, "preview", {}, () => [createTextVNode(toDisplayString(A.preview), 1)], true)])])], 8, qt)], 6)), [[vShow, !A.album || A.album && ee === 0]])), 128))]), _: 3 }, 8, ["size"]), createVNode(Transition, { name: "mask" }, { default: withCtx(() => [withDirectives(createBaseVNode("div", Kt, null, 512), [[vShow, h.value]])]), _: 1 }), createVNode(Transition, { name: "preview" }, { default: withCtx(() => [withDirectives(createBaseVNode("div", { class: "m-preview-wrap", onClick: withModifiers(H, ["self"]), onWheel: withModifiers(re, ["prevent"]) }, [createBaseVNode("div", Zt, [createBaseVNode("div", Gt, [createBaseVNode("a", { class: "u-name", href: d.value[n.value].src, target: "_blank", title: z(d.value[n.value]) }, toDisplayString(z(d.value[n.value])), 9, Jt), withDirectives(createBaseVNode("p", { class: "u-preview-progress" }, toDisplayString(n.value + 1) + " / " + toDisplayString(s.value), 513), [[vShow, Array.isArray(A.src)]]), createBaseVNode("div", { class: "u-preview-operation", title: "关闭", onClick: H }, Xt), createBaseVNode("div", { class: normalizeClass(["u-preview-operation", { "u-operation-disabled": M.value === A.maxZoomScale }]), title: "放大", onClick: D }, Qt, 2), createBaseVNode("div", { class: normalizeClass(["u-preview-operation", { "u-operation-disabled": M.value === A.minZoomScale }]), title: "缩小", onClick: I }, e2, 2), createBaseVNode("div", { class: "u-preview-operation", title: "还原", onClick: J }, a2), createBaseVNode("div", { class: "u-preview-operation", title: "向右旋转", onClick: ae }, l2), createBaseVNode("div", { class: "u-preview-operation", title: "向左旋转", onClick: de }, t2), createBaseVNode("div", { class: "u-preview-operation", title: "水平镜像", onClick: ke }, o2), createBaseVNode("div", { class: "u-preview-operation", title: "垂直镜像", onClick: we }, [(openBlock(), createElementBlock("svg", s2, n2))])]), createBaseVNode("div", { class: "m-preview-image", style: normalizeStyle(`transform: translate3d(${k.value}px, ${f.value}px, 0px);`) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(d.value, (K, ee) => withDirectives((openBlock(), createBlock(unref(ie), { spinning: !p.value[ee], indicator: "dynamic-circle", key: ee }, { default: withCtx(() => [createBaseVNode("img", { class: "u-preview-image", style: normalizeStyle(`transform: scale3d(${m.value * M.value}, ${i.value * M.value}, 1) rotate(${x.value}deg);`), src: K.src, alt: K.name, onMousedown: q[0] || (q[0] = withModifiers((le) => function(Q) {
...
var wa = V(defineComponent({ inheritAttrs: false, __name: "Input", props: { width: { default: "100%" }, addonBefore: { default: "" }, addonAfter: { default: "" }, allowClear: { type: Boolean, default: false }, password: { type: Boolean, default: false }, disabled: { type: Boolean, default: false }, maxlength: { default: void 0 }, showCount: { type: Boolean, default: false }, size: { default: "middle" }, prefix: { default: "" }, suffix: { default: "" }, value: { default: "" }, valueModifiers: { default: () => ({}) } }, emits: ["update:value", "change", "enter"], setup(l, { emit: a }) {
  const e = l, o = computed(() => typeof e.width == "number" ? e.width + "px" : e.width), u = computed(() => e.maxlength ? e.value.length + " / " + e.maxlength : e.value.length), d = useSlots(), s = computed(() => {
    var y;
...
var _2 = defineComponent({ inheritAttrs: false, __name: "InputNumber", props: { width: { default: 90 }, min: { default: -1 / 0 }, max: { default: 1 / 0 }, step: { default: 1 }, precision: { default: 0 }, prefix: { default: "" }, formatter: { type: Function, default: (l) => l }, keyboard: { type: Boolean, default: true }, value: { default: null } }, emits: ["update:value", "change"], setup(l, { emit: a }) {
  var b;
  const e = l, o = computed(() => typeof e.width == "number" ? e.width + "px" : e.width), u = computed(() => {
    var k;
  ...
  }), c = ref(e.formatter((b = e.value) == null ? void 0 : b.toFixed(u.value)));
  watch(() => e.value, (g) => {
    c.value = e.formatter(g == null ? void 0 : g.toFixed(u.value));
  }), watch(c, (g) => {
    g || n(null);
  });
  const p = a;
  ...
  function h(g) {
    ...
    if (Number.isNaN(parseFloat(k)))
      ...
      if (parseFloat(k) < e.min)
        return void n(e.min);
      parseFloat(k) !== e.value ? n(parseFloat(k)) : c.value = (y = e.value) == null ? void 0 : y.toFixed(u.value);
    }
  }
  function x(g, k) {
    const f = String(g).split(".")[1], y = String(k).split(".")[1];
    let z = Math.max((f == null ? void 0 : f.length) || 0, (y == null ? void 0 : y.length) || 0), B = g.toFixed(z), E = k.toFixed(z);
    return (+B.replace(".", "") + +E.replace(".", "")) / Math.pow(10, z);
  }
  function M(g) {
    g.key === "ArrowUp" && m(), g.key === "ArrowDown" && i();
  }
  function m() {
  ...
  return (g, k) => (openBlock(), createElementBlock("div", { class: "m-input-number", tabindex: "1", style: normalizeStyle(`width: ${o.value};`) }, [createBaseVNode("div", k2, [s.value ? (openBlock(), createElementBlock("span", w2, [renderSlot(g.$slots, "prefix", {}, () => [createTextVNode(toDisplayString(g.prefix), 1)], true)])) : createCommentVNode("", true), g.keyboard ? withDirectives((openBlock(), createElementBlock("input", mergeProps({ key: 1, autocomplete: "off", class: "u-input-number", onChange: h, "onUpdate:modelValue": k[0] || (k[0] = (f) => c.value = f), onKeydown: [k[1] || (k[1] = withKeys(withModifiers(() => {
  }, ["prevent"]), ["up"])), M] }, g.$attrs), null, 16)), [[vModelDynamic, c.value]]) : withDirectives((openBlock(), createElementBlock("input", mergeProps({ key: 2, autocomplete: "off", class: "u-input-number", onChange: h, "onUpdate:modelValue": k[2] || (k[2] = (f) => c.value = f) }, g.$attrs), null, 16)), [[vModelDynamic, c.value]])]), createBaseVNode("div", x2, [createBaseVNode("span", { class: normalizeClass(["u-up-arrow", { disabled: (g.value || 0) >= g.max }]), onClick: m }, M2, 2), createBaseVNode("span", { class: normalizeClass(["u-down-arrow", { disabled: (g.value || 0) <= g.min }]), onClick: i }, z2, 2)])], 4));
} });
...
var S2 = [Ze(() => createBaseVNode("circle", { class: "path", cx: "25", cy: "25", r: "20", fill: "none" }, null, -1))];
...
var Ye = V(defineComponent({ __name: "Message", props: { duration: { default: 3e3 }, top: { default: 30 } }, emits: ["close"], setup(l, { expose: a, emit: e }) {
  const o = l, u = ref(), d = ref([]), s = ref([]), c = ref([]), p = computed(() => typeof o.top == "number" ? o.top + "px" : o.top), n = computed(() => d.value.every((m) => !m));
  function h() {
    Ce(u.value);
  ...
  function M(m) {
    s.value[m] = me(() => {
      d.value[m] = false, x("close");
    }, o.duration);
  }
  return (m, i) => (openBlock(), createElementBlock("div", { class: "m-message-wrap", style: normalizeStyle(`top: ${p.value};`) }, [createVNode(TransitionGroup, { name: "slide-fade" }, { default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(c.value, (b, g) => withDirectives((openBlock(), createElementBlock("div", { class: "m-message", key: g }, [createBaseVNode("div", { class: "m-message-content", onMouseenter: (k) => function(f) {
    Ce(s.value[f]);
  }(g), onMouseleave: (k) => function(f) {
    M(f);
  }(g) }, [b.mode === "info" ? (openBlock(), createElementBlock("svg", { key: 0, class: "u-svg", style: normalizeStyle({ fill: Ee[b.mode] }), viewBox: "64 64 896 896", "data-icon": "info-circle", "aria-hidden": "true", focusable: "false" }, $2, 4)) : createCommentVNode("", true), b.mode === "success" ? (openBlock(), createElementBlock("svg", { key: 1, class: "u-svg", style: normalizeStyle({ fill: Ee[b.mode] }), viewBox: "64 64 896 896", "data-icon": "check-circle", "aria-hidden": "true", focusable: "false" }, B2, 4)) : createCommentVNode("", true), b.mode === "error" ? (openBlock(), createElementBlock("svg", { key: 2, class: "u-svg", style: normalizeStyle({ fill: Ee[b.mode] }), viewBox: "64 64 896 896", "data-icon": "close-circle", "aria-hidden": "true", focusable: "false" }, F2, 4)) : createCommentVNode("", true), b.mode === "warning" ? (openBlock(), createElementBlock("svg", { key: 3, class: "u-svg", style: normalizeStyle({ fill: Ee[b.mode] }), viewBox: "64 64 896 896", "data-icon": "exclamation-circle", "aria-hidden": "true", focusable: "false" }, L2, 4)) : createCommentVNode("", true), b.mode === "loading" ? (openBlock(), createElementBlock("svg", { key: 4, class: "u-svg circular", style: normalizeStyle({ stroke: Ee[b.mode] }), viewBox: "0 0 50 50", focusable: "false" }, S2, 4)) : createCommentVNode("", true), createBaseVNode("p", A2, toDisplayString(b.content), 1)], 40, C2)])), [[vShow, d.value[g]]])), 128))]), _: 1 })], 4));
...
var za = V(defineComponent({ __name: "Notification", props: { message: { default: "温馨提示" }, duration: { default: 4500 }, top: { default: 24 }, bottom: { default: 24 }, placement: { default: "topRight" } }, emits: ["close"], setup(l, { expose: a, emit: e }) {
  const o = l, u = ref(), d = ref([]), s = ref([]), c = ref([]), p = ref(o.placement), n = ref(), h = computed(() => d.value.length === c.value.length);
  function x() {
...
var _a = defineComponent({ __name: "NumberAnimation", props: { from: { default: 0 }, to: { default: 1e3 }, duration: { default: 3e3 }, autoplay: { type: Boolean, default: true }, precision: { default: 0 }, prefix: { default: "" }, suffix: { default: "" }, separator: { default: "," }, decimal: { default: "." }, valueStyle: { default: () => ({}) }, transition: { default: "easeInOutCubic" } }, emits: ["started", "finished"], setup(l, { expose: a, emit: e }) {
  ...
  const d = useTransition(u, { duration: o.duration, transition: TransitionPresets[o.transition], onFinished: () => p("finished"), onStarted: () => p("started") });
  function s() {
    u.value = o.to;
  }
  const c = computed(() => function(n) {
  ...
  return a({ play: s }), (n, h) => (openBlock(), createElementBlock("span", { style: normalizeStyle(n.valueStyle) }, toDisplayString(c.value), 5));
} });
_a.install = (l) => {
...
var Ue = V(defineComponent({ __name: "Pagination", props: { current: { default: 1 }, pageSize: { default: 10 }, total: { default: 0 }, pageListNum: { default: 5 }, hideOnSinglePage: { type: Boolean, default: false }, showQuickJumper: { type: Boolean, default: false }, showTotal: { type: Boolean, default: false }, placement: { default: "center" } }, emits: ["change"], setup(l, { emit: a }) {
  const e = l, o = ref(e.current), u = ref(""), d = ref(false), s = ref(false), c = ref(false), p = ref(false), n = computed(() => Math.ceil(e.total / e.pageSize)), h = computed(() => function(b) {
    var g = [], k = Math.floor(e.pageListNum / 2), f = { start: b - k, end: b + k };
    f.start < 1 && (f.end = f.end + (1 - f.start), f.start = 1), f.end > n.value && (f.start = f.start - (f.end - n.value), f.end = n.value), f.start < 1 && (f.start = 1), f.start > 1 ? d.value = true : d.value = false, f.end < n.value ? s.value = true : s.value = false;
  ...
  return watch(o, (b) => {
    ...
    document.onkeydown = (b) => {
      b && b.key === "Enter" && function() {
        var g = Number(u.value);
        Number.isInteger(g) && (g < 1 && (g = 1), g > n.value && (g = n.value), i(g)), u.value = "";
      }();
    };
  }), onUnmounted(() => {
    document.onkeydown = null;
  }), (b, g) => (openBlock(), createElementBlock("div", { class: normalizeClass([`m-pagination ${b.placement}`, { hidden: b.hideOnSinglePage && b.total <= b.pageSize }]) }, [createBaseVNode("div", o0, [b.showTotal ? (openBlock(), createElementBlock("span", s0, "共 " + toDisplayString(n.value) + " 页 / " + toDisplayString(b.total) + " 条", 1)) : createCommentVNode("", true), createBaseVNode("span", { class: normalizeClass(["u-item", { disabled: o.value === 1 }]), onClick: g[0] || (g[0] = (k) => i(o.value - 1)) }, n0, 2), createBaseVNode("span", { class: normalizeClass(["u-item", { active: o.value === 1 }]), onClick: g[1] || (g[1] = (k) => i(1)) }, "1", 2), withDirectives(createBaseVNode("span", { class: "m-arrow", ref: "forward", onClick: M, onMouseenter: g[2] || (g[2] = (k) => c.value = true), onMouseleave: g[3] || (g[3] = (k) => c.value = false) }, i0, 544), [[vShow, d.value && h.value[0] - 1 > 1]]), (openBlock(true), createElementBlock(Fragment, null, renderList(h.value, (k, f) => (openBlock(), createElementBlock("span", { class: normalizeClass(["u-item", { active: o.value === k }]), key: f, onClick: (y) => i(k) }, toDisplayString(k), 11, u0))), 128)), withDirectives(createBaseVNode("span", { class: "m-arrow", ref: "backward", onClick: m, onMouseenter: g[4] || (g[4] = (k) => p.value = true), onMouseleave: g[5] || (g[5] = (k) => p.value = false) }, c0, 544), [[vShow, s.value && h.value[h.value.length - 1] + 1 < n.value]]), withDirectives(createBaseVNode("span", { class: normalizeClass(["u-item", { active: o.value === n.value }]), onClick: g[6] || (g[6] = (k) => i(n.value)) }, toDisplayString(n.value), 3), [[vShow, n.value !== 1]]), createBaseVNode("span", { class: normalizeClass(["u-item", { disabled: o.value === n.value }]), onClick: g[7] || (g[7] = (k) => i(o.value + 1)) }, d0, 2), b.showQuickJumper ? (openBlock(), createElementBlock("span", r0, [createTextVNode("跳至"), withDirectives(createBaseVNode("input", { type: "text", "onUpdate:modelValue": g[8] || (g[8] = (k) => u.value = k) }, null, 512), [[vModelText, u.value]]), createTextVNode("页")])) : createCommentVNode("", true)])], 2));
...
var Ca = V(defineComponent({ __name: "Popconfirm", props: { title: { default: "" }, description: { default: "" }, content: { default: "" }, icon: { default: "" }, iconType: { default: "warning" }, maxWidth: { default: "auto" }, cancelText: { default: "取消" }, cancelType: { default: "default" }, okText: { default: "确定" }, okType: { default: "primary" }, showCancel: { type: Boolean, default: true } }, emits: ["cancel", "ok", "openChange"], setup(l, { emit: a }) {
  const e = l, o = computed(() => typeof e.maxWidth == "number" ? e.maxWidth + "px" : e.maxWidth), u = useSlots(), d = computed(() => {
    var y;
    const f = (y = u.description) == null ? void 0 : y.call(u);
    return f ? !!(f[0].children !== "v-if" && (f != null && f.length)) : e.description;
  }), s = ref(false), c = ref(0), p = ref(0), n = ref(), h = ref(), x = ref(false);
  function M() {
    x.value = false;
  }
  function m() {
  ...
  function b() {
    s.value = !s.value, s.value && function() {
      const f = n.value.offsetWidth, y = h.value.offsetWidth, z = h.value.offsetHeight;
      c.value = z + 4, p.value = (y - f) / 2;
    }(), i("openChange", s.value);
  }
  function g(f) {
    s.value = false, i("openChange", false), i("cancel", f);
  }
  function k(f) {
    s.value = false, i("openChange", false), i("ok", f);
  }
  return (f, y) => {
    const z = resolveComponent("Button");
    return openBlock(), createElementBlock("div", v0, [createBaseVNode("div", { ref_key: "popRef", ref: h, tabindex: "1", class: normalizeClass(["m-pop-content", { "show-pop": s.value }]), style: normalizeStyle(`max-width: ${o.value}; top: ${-c.value}px; left: ${-p.value}px;`), onBlur: y[0] || (y[0] = (B) => x.value ? (s.value = false, void i("openChange", false)) : () => false) }, [createBaseVNode("div", p0, [createBaseVNode("div", f0, [createBaseVNode("span", h0, [renderSlot(f.$slots, "icon", {}, () => [f.iconType === "info" ? (openBlock(), createElementBlock("svg", m0, g0)) : createCommentVNode("", true), f.iconType === "success" ? (openBlock(), createElementBlock("svg", y0, b0)) : createCommentVNode("", true), f.iconType === "error" ? (openBlock(), createElementBlock("svg", k0, w0)) : createCommentVNode("", true), f.iconType === "warning" ? (openBlock(), createElementBlock("svg", x0, M0)) : createCommentVNode("", true)], true)]), createBaseVNode("div", { class: normalizeClass(["m-title", { "font-weight": d.value }]) }, [renderSlot(f.$slots, "title", {}, () => [createTextVNode(toDisplayString(f.title), 1)], true)], 2)]), d.value ? (openBlock(), createElementBlock("div", z0, [renderSlot(f.$slots, "description", {}, () => [createTextVNode(toDisplayString(f.description), 1)], true)])) : createCommentVNode("", true), createBaseVNode("div", _0, [f.showCancel ? (openBlock(), createBlock(z, { key: 0, onClick: g, size: "small", type: f.cancelType }, { default: withCtx(() => [createTextVNode(toDisplayString(f.cancelText), 1)]), _: 1 }, 8, ["type"])) : createCommentVNode("", true), createVNode(z, { onClick: k, size: "small", type: f.okType }, { default: withCtx(() => [createTextVNode(toDisplayString(f.okText), 1)]), _: 1 }, 8, ["type"])])]), C0], 38), createBaseVNode("div", { ref_key: "contentRef", ref: n, onClick: b, onMouseenter: M, onMouseleave: m }, [renderSlot(f.$slots, "default", {}, () => [createTextVNode(toDisplayString(f.content), 1)], true)], 544)]);
  };
...
var $a = V(defineComponent({ __name: "Progress", props: { width: { default: "100%" }, percent: { default: 0 }, strokeColor: { default: "#1677FF" }, strokeWidth: { default: 8 }, showInfo: { type: Boolean, default: true }, type: { default: "line" } }, setup(l) {
  const a = l, e = computed(() => typeof a.width == "number" ? a.width + "px" : a.width), o = computed(() => (100 - a.strokeWidth) * Math.PI), u = computed(() => {
  ...
  return (s, c) => s.type === "line" ? (openBlock(), createElementBlock("div", { key: 0, class: "m-progress-line", style: normalizeStyle(`width: ${e.value}; height: ${s.strokeWidth < 24 ? 24 : s.strokeWidth}px;`) }, [createBaseVNode("div", $0, [createBaseVNode("div", { class: normalizeClass(["u-progress-bg", { "u-success-bg": s.percent >= 100 }]), style: normalizeStyle(`background: ${d.value}; width: ${s.percent >= 100 ? 100 : s.percent}%; height: ${s.strokeWidth}px;`) }, null, 6)]), s.showInfo ? (openBlock(), createBlock(Transition, { key: 0, mode: "out-in" }, { default: withCtx(() => [s.percent >= 100 ? (openBlock(), createElementBlock("span", B0, F0)) : (openBlock(), createElementBlock("p", L0, toDisplayString(s.percent >= 100 ? 100 : s.percent) + "%", 1))]), _: 1 })) : createCommentVNode("", true)], 4)) : (openBlock(), createElementBlock("div", { key: 1, class: "m-progress-circle", style: normalizeStyle(`width: ${e.value}; height: ${e.value};`) }, [(openBlock(), createElementBlock("svg", S0, [createBaseVNode("path", { d: u.value, "stroke-linecap": "round", class: "u-progress-circle-trail", "stroke-width": s.strokeWidth, style: normalizeStyle(`stroke-dasharray: ${o.value}px, ${o.value}px;`), "fill-opacity": "0" }, null, 12, A0), createBaseVNode("path", { d: u.value, "stroke-linecap": "round", class: normalizeClass(["u-progress-circle-path", { success: s.percent >= 100 }]), "stroke-width": s.strokeWidth, stroke: d.value, style: normalizeStyle(`stroke-dasharray: ${s.percent / 100 * o.value}px, ${o.value}px;`), opacity: s.percent === 0 ? 0 : 1, "fill-opacity": "0" }, null, 14, D0)])), s.showInfo ? (openBlock(), createBlock(Transition, { key: 0, mode: "out-in" }, { default: withCtx(() => [s.percent >= 100 ? (openBlock(), createElementBlock("svg", E0, H0)) : (openBlock(), createElementBlock("p", I0, toDisplayString(s.percent >= 100 ? 100 : s.percent) + "%", 1))]), _: 1 })) : createCommentVNode("", true)], 4));
...
var Ba = V(defineComponent({ __name: "QRCode", props: { value: { default: "" }, size: { default: 160 }, color: { default: "#000" }, bgColor: { default: "#FFF" }, bordered: { type: Boolean, default: true }, borderColor: { default: "#0505050f" }, scale: { default: 8 }, errorLevel: { default: "H" } }, setup(l) {
  ...
  return (o, u) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-qrcode", { bordered: o.bordered }]), style: normalizeStyle(`width: ${o.size}px; height: ${o.size}px; border-color: ${o.borderColor};`) }, [createBaseVNode("img", { src: e.value.value, class: "u-qrcode", alt: "QRCode" }, null, 8, j0)], 6));
...
var Fa = V(defineComponent({ __name: "Radio", props: { options: { default: () => [] }, disabled: { type: Boolean, default: false }, vertical: { type: Boolean, default: false }, value: { default: null }, gap: { default: 8 }, button: { type: Boolean, default: false }, buttonStyle: { default: "outline" } }, emits: ["update:value", "change"], setup(l, { emit: a }) {
  const e = l, o = computed(() => e.options.length), u = computed(() => e.vertical ? { marginBottom: e.gap + "px" } : { marginRight: e.gap + "px" }), d = a;
  function s(c) {
    c !== e.value && (d("update:value", c), d("change", c));
  }
  return (c, p) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-radio", { "m-radio-button-solid": c.buttonStyle === "solid" }]) }, [c.button ? (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList(c.options, (n, h) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-radio-button-wrap", { "m-radio-button-checked": c.value === n.value, "m-radio-button-disabled": c.disabled || n.disabled }]), key: h, onClick: (x) => c.disabled || n.disabled ? () => false : s(n.value) }, [createBaseVNode("span", W0, [renderSlot(c.$slots, "default", { label: n.label }, () => [createTextVNode(toDisplayString(n.label), 1)], true)])], 10, R0))), 128)) : (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(c.options, (n, h) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-radio-wrap", { vertical: c.vertical }]), style: normalizeStyle(o.value !== h + 1 ? u.value : ""), key: h }, [createBaseVNode("div", { class: normalizeClass(["m-box", { "m-radio-disabled": c.disabled || n.disabled }]), onClick: (x) => c.disabled || n.disabled ? () => false : s(n.value) }, [createBaseVNode("span", { class: normalizeClass(["u-radio", { "u-radio-checked": c.value === n.value }]) }, null, 2), createBaseVNode("span", V0, [renderSlot(c.$slots, "default", { label: n.label }, () => [createTextVNode(toDisplayString(n.label), 1)], true)])], 10, T0)], 6))), 128))], 2));
} }), [["__scopeId", "data-v-5a3af575"]]);
Fa.install = (l) => {
  l.component(Fa.__name, Fa);
};
var Fe = (l) => (pushScopeId("data-v-3840d4df"), l = l(), popScopeId(), l);
var N0 = ["onClick"];
var O0 = ["onClick", "onMouseenter"];
var q0 = [Fe(() => createBaseVNode("path", { d: "M908.1 353.1l-253.9-36.9L540.7 86.1c-3.1-6.3-8.2-11.4-14.5-14.5-15.8-7.8-35-1.3-42.9 14.5L369.8 316.2l-253.9 36.9c-7 1-13.4 4.3-18.3 9.3a32.05 32.05 0 00.6 45.3l183.7 179.1-43.4 252.9a31.95 31.95 0 0046.4 33.7L512 754l227.1 119.4c6.2 3.3 13.4 4.4 20.3 3.2 17.4-3 29.1-19.5 26.1-36.9l-43.4-252.9 183.7-179.1c5-4.9 8.3-11.3 9.3-18.3 2.7-17.5-9.5-33.7-27-36.3z" }, null, -1))];
var P0 = [Fe(() => createBaseVNode("path", { d: "M908.1 353.1l-253.9-36.9L540.7 86.1c-3.1-6.3-8.2-11.4-14.5-14.5-15.8-7.8-35-1.3-42.9 14.5L369.8 316.2l-253.9 36.9c-7 1-13.4 4.3-18.3 9.3a32.05 32.05 0 00.6 45.3l183.7 179.1-43.4 252.9a31.95 31.95 0 0046.4 33.7L512 754l227.1 119.4c6.2 3.3 13.4 4.4 20.3 3.2 17.4-3 29.1-19.5 26.1-36.9l-43.4-252.9 183.7-179.1c5-4.9 8.3-11.3 9.3-18.3 2.7-17.5-9.5-33.7-27-36.3zM664.8 561.6l36.1 210.3L512 672.7 323.1 772l36.1-210.3-152.8-149L417.6 382 512 190.7 606.4 382l211.2 30.7-152.8 148.9z" }, null, -1))];
var Y0 = [Fe(() => createBaseVNode("path", { d: "M923 283.6a260.04 260.04 0 00-56.9-82.8 264.4 264.4 0 00-84-55.5A265.34 265.34 0 00679.7 125c-49.3 0-97.4 13.5-139.2 39-10 6.1-19.5 12.8-28.5 20.1-9-7.3-18.5-14-28.5-20.1-41.8-25.5-89.9-39-139.2-39-35.5 0-69.9 6.8-102.4 20.3-31.4 13-59.7 31.7-84 55.5a258.44 258.44 0 00-56.9 82.8c-13.9 32.3-21 66.6-21 101.9 0 33.3 6.8 68 20.3 103.3 11.3 29.5 27.5 60.1 48.2 91 32.8 48.9 77.9 99.9 133.9 151.6 92.8 85.7 184.7 144.9 188.6 147.3l23.7 15.2c10.5 6.7 24 6.7 34.5 0l23.7-15.2c3.9-2.5 95.7-61.6 188.6-147.3 56-51.7 101.1-102.7 133.9-151.6 20.7-30.9 37-61.5 48.2-91 13.5-35.3 20.3-70 20.3-103.3.1-35.3-7-69.6-20.9-101.9z" }, null, -1))];
...
var Aa = V(defineComponent({ __name: "Row", props: { width: { default: "auto" }, gutter: { default: 0 }, wrap: { type: Boolean, default: false }, align: { default: "top" }, justify: { default: "start" } }, setup(l) {
  ...
  }), (p, n) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-row", { "gutter-row": p.gutter }]), style: normalizeStyle(`--xGap: ${o.value / 2}px; --justify: ${p.justify}; --align: ${e[p.align]}; width: ${d.value}; margin-left: -${o.value / 2}px; margin-right: -${o.value / 2}px; row-gap: ${u.value}px;`) }, [renderSlot(p.$slots, "default", {}, void 0, true)], 6));
...
var Da = V(defineComponent({ __name: "Slider", props: { width: { default: "100%" }, min: { default: 0 }, max: { default: 100 }, disabled: { type: Boolean, default: false }, range: { type: Boolean, default: false }, step: { default: 1 }, tipFormatter: { type: Function, default: (l) => l }, hideTip: { type: Boolean, default: false }, value: { default: 0 } }, emits: ["update:value", "change"], setup(l, { emit: a }) {
  const e = l, o = ref(false), u = ref(), d = ref(0), s = ref(0), c = ref(), p = ref(), n = ref(), h = ref(), x = computed(() => k(p.value / (e.max - e.min) * e.step)), M = computed(() => typeof e.width == "number" ? e.width + "px" : e.width), m = computed(() => {
    const H = Math.round(s.value / x.value * e.step + e.min);
    return e.range ? [Math.round(d.value / x.value * e.step + e.min), H] : H;
  }), i = computed(() => e.range ? e.tipFormatter(m.value[0]) : null), b = computed(() => e.range ? e.tipFormatter(m.value[1]) : e.tipFormatter(m.value)), g = a;
  function k(H) {
  ...
  function y() {
    ...
    document.onmousemove = (D) => {
      ...
      I < 0 ? d.value = 0 : I >= 0 && I <= s.value ? d.value = I : (d.value = s.value, h.value.focus(), z());
    }, document.onmouseup = () => {
  ...
  function z() {
    ...
    document.onmousemove = (D) => {
      const I = k(Math.round((D.clientX - H) / x.value) * x.value);
      I > p.value ? s.value = p.value : d.value <= I && I <= p.value ? s.value = I : (s.value = d.value, n.value.focus(), y());
    }, document.onmouseup = () => {
      document.onmousemove = null;
    };
  }
  function B(H, D) {
    const I = H - x.value;
    D === "left" ? d.value = I < 0 ? 0 : I : I >= d.value ? s.value = I : (s.value = d.value, d.value = I, n.value.focus());
  }
  function E(H, D) {
    const I = H + x.value;
    D === "right" ? I > p.value ? s.value = p.value : s.value = I : I <= s.value ? d.value = I : (d.value = s.value, s.value = I, h.value.focus());
  }
  ...
  }), (H, D) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-slider", { disabled: H.disabled }]), ref_key: "slider", ref: c, style: normalizeStyle(`width: ${M.value};`) }, [createBaseVNode("div", { class: "u-slider-rail", onClick: D[0] || (D[0] = withModifiers((I) => H.disabled ? () => false : function(J) {
    o.value ? (Ce(u.value), u.value = null) : o.value = true, u.value = me(() => {
      o.value = false;
    }, 300);
  ...
  }(I), ["self"])) }), createBaseVNode("div", { class: normalizeClass(["u-slider-track", { trackTransition: o.value }]), style: normalizeStyle(`left: ${d.value}px; right: auto; width: ${s.value - d.value}px;`) }, null, 6), H.range ? (openBlock(), createElementBlock("div", { key: 0, tabindex: "0", ref_key: "leftHandle", ref: n, class: normalizeClass(["u-slider-handle", { handleTransition: o.value }]), style: normalizeStyle(`left: ${d.value}px; right: auto; transform: translate(-50%, -50%);`), onKeydown: [D[1] || (D[1] = withKeys(withModifiers((I) => H.disabled ? () => false : B(d.value, "left"), ["prevent"]), ["left"])), D[2] || (D[2] = withKeys(withModifiers((I) => H.disabled ? () => false : E(d.value, "left"), ["prevent"]), ["right"])), D[3] || (D[3] = withKeys(withModifiers((I) => H.disabled ? () => false : B(d.value, "left"), ["prevent"]), ["down"])), D[4] || (D[4] = withKeys(withModifiers((I) => H.disabled ? () => false : E(d.value, "left"), ["prevent"]), ["up"]))], onMousedown: D[5] || (D[5] = (I) => H.disabled ? () => false : y()) }, [H.hideTip ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", b4, [createTextVNode(toDisplayString(i.value) + " ", 1), k4]))], 38)) : createCommentVNode("", true), createBaseVNode("div", { tabindex: "0", ref_key: "rightHandle", ref: h, class: normalizeClass(["u-slider-handle", { handleTransition: o.value }]), style: normalizeStyle(`left: ${s.value}px; right: auto; transform: translate(-50%, -50%);`), onKeydown: [D[6] || (D[6] = withKeys(withModifiers((I) => H.disabled ? () => false : B(s.value, "right"), ["prevent"]), ["left"])), D[7] || (D[7] = withKeys(withModifiers((I) => H.disabled ? () => false : E(s.value, "right"), ["prevent"]), ["right"])), D[8] || (D[8] = withKeys(withModifiers((I) => H.disabled ? () => false : B(s.value, "right"), ["prevent"]), ["down"])), D[9] || (D[9] = withKeys(withModifiers((I) => H.disabled ? () => false : E(s.value, "right"), ["prevent"]), ["up"]))], onMousedown: D[10] || (D[10] = (I) => H.disabled ? () => false : z()) }, [H.hideTip ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", w4, [createTextVNode(toDisplayString(b.value) + " ", 1), x4]))], 38)], 6));
...
var Ea = V(defineComponent({ __name: "Statistic", props: { title: { default: "" }, value: { default: "" }, valueStyle: { default: () => ({}) }, precision: { default: 0 }, prefix: { default: "" }, suffix: { default: "" }, separator: { default: "," }, formatter: { type: Function, default: (l) => l } }, setup(l) {
  const a = l, e = computed(() => a.formatter(z1(a.value, a.precision, a.separator))), o = useSlots(), u = computed(() => {
    var c;
  ...
  return (s, c) => (openBlock(), createElementBlock("div", M4, [createBaseVNode("div", z4, [renderSlot(s.$slots, "title", {}, () => [createTextVNode(toDisplayString(s.title), 1)], true)]), createBaseVNode("div", { class: "m-content", style: normalizeStyle(s.valueStyle) }, [u.value ? (openBlock(), createElementBlock("span", _4, [renderSlot(s.$slots, "prefix", {}, () => [createTextVNode(toDisplayString(s.prefix), 1)], true)])) : createCommentVNode("", true), createBaseVNode("span", C4, [renderSlot(s.$slots, "default", {}, () => [createTextVNode(toDisplayString(e.value), 1)], true)]), d.value ? (openBlock(), createElementBlock("span", $4, [renderSlot(s.$slots, "suffix", {}, () => [createTextVNode(toDisplayString(s.suffix), 1)], true)])) : createCommentVNode("", true)], 4)]));
...
var Ha = V(defineComponent({ __name: "Steps", props: { steps: { default: () => [] }, current: { default: 1 }, width: { default: "100%" }, descMaxWidth: { default: 120 } }, emits: ["update:current", "change"], setup(l, { emit: a }) {
  const e = l, o = computed(() => typeof e.width == "number" ? e.width + "px" : e.width), u = computed(() => e.steps.length), d = computed(() => e.current < 1 ? 1 : e.current > u.value + 1 ? u.value + 1 : e.current), s = a;
  return (c, p) => (openBlock(), createElementBlock("div", { class: "m-steps-area", style: normalizeStyle(`width: ${o.value};`) }, [createBaseVNode("div", B4, [(openBlock(true), createElementBlock(Fragment, null, renderList(c.steps, (n, h) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-steps-item", { finish: d.value > h + 1, process: d.value === h + 1, wait: d.value < h + 1 }]), key: h }, [createBaseVNode("div", { class: "m-info-wrap", onClick: (x) => function(M) {
    d.value !== M && (s("update:current", M), s("change", M));
  }(h + 1) }, [createBaseVNode("div", L4, [d.value <= h + 1 ? (openBlock(), createElementBlock("span", S4, toDisplayString(h + 1), 1)) : (openBlock(), createElementBlock("svg", A4, D4))]), createBaseVNode("div", E4, [createBaseVNode("div", H4, toDisplayString(n.title), 1), withDirectives(createBaseVNode("div", { class: "u-steps-description", style: normalizeStyle(`max-width: ${c.descMaxWidth}px;`) }, toDisplayString(n.description), 5), [[vShow, n.description]])])], 8, F4)], 2))), 128))])], 4));
...
var Ia = V(defineComponent({ __name: "Swiper", props: { images: { default: () => [] }, width: { default: "100%" }, height: { default: "100vh" }, type: { default: "banner" }, navigation: { type: Boolean, default: true }, delay: { default: 3e3 }, swipe: { type: Boolean, default: true }, preloaderColor: { default: "theme" } }, emits: ["swiper", "change"], setup(l, { emit: a }) {
  const e = l, o = computed(() => typeof e.width == "number" ? e.width + "px" : e.width), u = computed(() => typeof e.height == "number" ? e.height + "px" : e.height), d = ref([Navigation, Pagination, Autoplay, EffectFade]), s = ref({ delay: e.delay, disableOnInteraction: false, pauseOnMouseEnter: true }), c = ref([Autoplay]), p = ref({ delay: 0, disableOnInteraction: false }), n = ref([Navigation, Pagination, Mousewheel]), h = a;
  function x(M) {
  ...
  return (M, m) => (openBlock(), createElementBlock(Fragment, null, [M.type === "banner" ? (openBlock(), createBlock(unref(Swiper), mergeProps({ key: 0, class: { "swiper-no-swiping": !M.swipe }, modules: d.value, navigation: M.navigation, "slides-per-view": 1, autoplay: s.value, lazy: "", loop: "", onSwiper: x, onSlideChange: m[0] || (m[0] = (i) => M.$emit("change")) }, M.$attrs), { default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(M.images, (i, b) => (openBlock(), createBlock(unref(SwiperSlide), { key: b }, { default: withCtx(() => [createBaseVNode("a", { href: i.link ? i.link : "javascript:;", target: i.link ? "_blank" : "_self", class: "m-link" }, [createBaseVNode("img", { src: i.src, class: "u-img", style: normalizeStyle(`width: ${o.value}; height: ${u.value};`), alt: i.title, loading: "lazy" }, null, 12, j4)], 8, I4), createBaseVNode("div", { class: normalizeClass(`swiper-lazy-preloader swiper-lazy-preloader-${M.preloaderColor}`) }, null, 2)]), _: 2 }, 1024))), 128))]), _: 1 }, 16, ["class", "modules", "navigation", "autoplay"])) : createCommentVNode("", true), M.type === "carousel" ? (openBlock(), createBlock(unref(Swiper), mergeProps({ key: 1, class: "swiper-no-swiping", modules: c.value, autoplay: p.value, lazy: "", loop: "", onSwiper: x, onSlideChange: m[1] || (m[1] = (i) => M.$emit("change")) }, M.$attrs), { default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(M.images, (i, b) => (openBlock(), createBlock(unref(SwiperSlide), { key: b }, { default: withCtx(() => [createBaseVNode("a", { href: i.link ? i.link : "javascript:;", target: i.link ? "_blank" : "_self", class: "m-link" }, [createBaseVNode("img", { src: i.src, class: "u-img", style: normalizeStyle(`width: ${o.value}; height: ${u.value};`), alt: i.title, loading: "lazy" }, null, 12, V4)], 8, T4), createBaseVNode("div", { class: normalizeClass(`swiper-lazy-preloader swiper-lazy-preloader-${M.preloaderColor}`) }, null, 2)]), _: 2 }, 1024))), 128))]), _: 1 }, 16, ["modules", "autoplay"])) : createCommentVNode("", true), M.type === "broadcast" ? (openBlock(), createBlock(unref(Swiper), mergeProps({ key: 2, modules: n.value, navigation: M.navigation, lazy: "", onSwiper: x, onSlideChange: m[2] || (m[2] = (i) => M.$emit("change")) }, M.$attrs), { default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(M.images, (i, b) => (openBlock(), createBlock(unref(SwiperSlide), { key: b }, { default: withCtx(() => [createBaseVNode("a", { href: i.link ? i.link : "javascript:;", target: i.link ? "_blank" : "_self", class: "m-link" }, [createBaseVNode("img", { src: i.src, class: "u-img", style: normalizeStyle(`width: ${o.value}; height: ${u.value};`), alt: i.title, loading: "lazy" }, null, 12, W4)], 8, R4), createBaseVNode("div", { class: normalizeClass(`swiper-lazy-preloader swiper-lazy-preloader-${M.preloaderColor}`) }, null, 2)]), _: 2 }, 1024))), 128))]), _: 1 }, 16, ["modules", "navigation"])) : createCommentVNode("", true)], 64));
...
var ja2 = V(defineComponent({ __name: "Switch", props: { onInfo: { default: "" }, offInfo: { default: "" }, disabled: { type: Boolean, default: false }, checked: { type: Boolean, default: false }, nodeStyle: { default: () => ({}) } }, emits: ["update:checked", "change"], setup(l, { emit: a }) {
  const e = l, o = a;
  return (u, d) => (openBlock(), createElementBlock("div", N4, [createBaseVNode("div", { onClick: d[0] || (d[0] = (s) => u.disabled ? () => false : (o("update:checked", !e.checked), void o("change", !e.checked))), class: normalizeClass(["m-switch", { "switch-checked": u.checked, disabled: u.disabled }]) }, [createBaseVNode("div", { class: normalizeClass(["u-switch-inner", u.checked ? "inner-checked" : "inner-unchecked"]) }, toDisplayString(u.checked ? u.onInfo : u.offInfo), 3), createBaseVNode("div", { class: normalizeClass(["u-node", { "node-checked": u.checked }]), style: normalizeStyle(u.nodeStyle) }, [renderSlot(u.$slots, "node", {}, void 0, true)], 6)], 2)]));
...
var G4 = ["title"];
var J4 = { key: 1 };
var Ta = V(defineComponent({ __name: "Table", props: { columns: { default: () => [] }, dataSource: { default: () => [] }, pagination: { default: () => ({ page: 1, pageSize: 10 }) }, showPagination: { type: Boolean, default: true }, hideOnSinglePage: { type: Boolean, default: false }, total: { default: 0 }, loading: { type: Boolean, default: false } }, emits: ["change"], setup(l, { emit: a }) {
  const e = a;
  function o(u) {
    e("change", u);
  }
  return (u, d) => (openBlock(), createElementBlock("div", O4, [createBaseVNode("table", q4, [createBaseVNode("thead", null, [createBaseVNode("tr", P4, [(openBlock(true), createElementBlock(Fragment, null, renderList(u.columns, (s, c) => (openBlock(), createElementBlock("th", { class: "m-th", style: normalizeStyle(`width: ${typeof s.width == "number" ? s.width + "px" : s.width};`), key: c }, toDisplayString(s.title), 5))), 128))])]), createBaseVNode("tbody", Y4, [withDirectives(createBaseVNode("tr", U4, [createVNode(unref(ie), { class: "m-loading", size: "small", colspan: u.columns.length }, null, 8, ["colspan"])], 512), [[vShow, u.loading]]), withDirectives(createBaseVNode("tr", K4, [createBaseVNode("td", { class: "m-td-empty", colspan: u.columns.length }, [createVNode(unref(He), { class: "empty", image: "2" })], 8, Z4)], 512), [[vShow, !u.total]]), (openBlock(true), createElementBlock(Fragment, null, renderList(u.dataSource, (s, c) => (openBlock(), createElementBlock("tr", { class: "m-tr", key: c }, [(openBlock(true), createElementBlock(Fragment, null, renderList(u.columns, (p, n) => (openBlock(), createElementBlock("td", { class: "m-td", key: n, title: s[p.dataIndex] }, [p.slot ? renderSlot(u.$slots, p.slot, mergeProps({ key: 0 }, s, { index: c }), () => [createTextVNode(toDisplayString(s[p.dataIndex] || "--"), 1)], true) : (openBlock(), createElementBlock("span", J4, toDisplayString(s[p.dataIndex] || "--"), 1))], 8, G4))), 128))]))), 128))])]), u.showPagination && u.total ? (openBlock(), createBlock(unref(Ue), { key: 0, class: "mt20", onChange: o, current: u.pagination.page, pageSize: u.pagination.pageSize, total: u.total, hideOnSinglePage: u.hideOnSinglePage, showQuickJumper: true, showTotal: true, placement: "right" }, null, 8, ["current", "pageSize", "total", "hideOnSinglePage"])) : createCommentVNode("", true)]));
...
var Va = V(defineComponent({ __name: "Tabs", props: { tabPages: { default: () => [] }, centered: { type: Boolean, default: false }, size: { default: "small" }, activeKey: { default: "" } }, emits: ["update:activeKey", "change"], setup(l, { emit: a }) {
  const e = l, o = ref(), u = ref(0), d = ref(0), s = ref(), c = ref(), p = ref(false), n = ref(0), h = ref(0);
  watchEffect(() => {
    (function() {
      const m = s.value.offsetWidth, i = c.value.offsetWidth;
      i > m && (p.value = true, n.value = i - m);
    })();
  ...
  return (m, i) => (openBlock(), createElementBlock("div", { class: normalizeClass(`m-tabs ${m.size}`) }, [createBaseVNode("div", X4, [createBaseVNode("div", { ref_key: "wrap", ref: s, class: normalizeClass(["m-tabs-nav-wrap", { "tabs-center": m.centered, "before-shadow-active": h.value > 0, "after-shadow-active": h.value < n.value }]) }, [createBaseVNode("div", { ref_key: "nav", ref: c, class: "m-tabs-nav-list", onWheel: i[0] || (i[0] = (b) => p.value ? function(g) {
    if (g.deltaX !== 0) {
      g.preventDefault();
      const k = 1 * g.deltaX;
      h.value + k > n.value ? h.value = n.value : h.value + k < 0 ? h.value = 0 : h.value += k;
    }
...
var Ra = V(defineComponent({ __name: "Tag", props: { closable: { type: Boolean, default: false }, color: { default: "" }, icon: { default: "" }, size: { default: "middle" }, bordered: { type: Boolean, default: true }, dynamic: { type: Boolean, default: false }, value: { default: () => [] }, spaceWidth: { default: "auto" }, spaceAlign: { default: "start" }, spaceDirection: { default: "horizontal" }, spaceSize: { default: "small" } }, emits: ["update:value", "close", "dynamicClose"], setup(l, { emit: a }) {
  const e = l, o = computed(() => {
    ...
    return null;
  }), u = computed(() => e.dynamic && e.value.length ? o.value ? e.value.map((y) => ({ label: y, closable: true })) : e.value.map((y) => ({ closable: true, ...y })) : []), d = useSlots(), s = computed(() => {
    var y;
    if (!e.dynamic) {
    ...
    return false;
  }), c = ref(), p = ref(false), n = ref(""), h = ["success", "processing", "error", "warning", "default", "pink", "red", "yellow", "orange", "cyan", "green", "blue", "purple", "geekblue", "magenta", "volcano", "gold", "lime"], x = ref(false), M = ref(), m = ref(Array(e.value.length).fill(1));
  watchEffect(() => {
    if (e.dynamic) {
  ...
  function k() {
    o.value ? i("update:value", [...e.value, n.value]) : i("update:value", [...e.value, { label: n.value }]), p.value = false, c.value = "";
  }
  function f(y) {
    y.key === "Enter" && c.value.blur();
  }
  return (y, z) => y.dynamic ? (openBlock(), createBlock(unref(Ae), { key: 1, width: y.spaceWidth, align: y.spaceAlign, direction: y.spaceDirection, size: y.spaceSize }, { default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(u.value, (B, E) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-tag", [`tag-${B.size || y.size}`, (B.color || y.color) && h.includes(B.color || y.color) ? "tag-" + (B.color || y.color) : "", { "tag-borderless": B.bordered !== void 0 && !B.bordered, "has-color": (B.color || y.color) && !h.includes(B.color || y.color) }]]), style: normalizeStyle(`background-color: ${!B.color && !y.color || h.includes(B.color || y.color) ? "" : B.color || y.color};`), key: E }, [withDirectives(createBaseVNode("span", { class: "m-icon", ref_for: true, ref_key: "tagsIconRef", ref: M }, [renderSlot(y.$slots, "icon", { index: E }, () => [createTextVNode(toDisplayString(B.icon), 1)], true)], 512), [[vShow, m.value[E]]]), createBaseVNode("span", oo, [renderSlot(y.$slots, "default", { label: B.label, index: E }, () => [createTextVNode(toDisplayString(B.label), 1)], true)]), B.closable || y.closable ? (openBlock(), createElementBlock("span", { key: 0, class: "m-close", onClick: (H) => function(D, I) {
    const J = e.value.filter((ae, de) => de !== I);
    i("update:value", J), i("dynamicClose", D, I);
  }(B, E) }, no, 8, so)) : createCommentVNode("", true)], 6))), 128)), p.value ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", { key: 0, class: normalizeClass(["m-tag", [`tag-${y.size}`, { "m-plus": y.dynamic }]]), onClick: g }, io, 2)), withDirectives(createBaseVNode("input", { ref_key: "inputRef", ref: c, class: normalizeClass(["u-input", `input-${y.size}`]), type: "text", "onUpdate:modelValue": z[0] || (z[0] = (B) => n.value = B), onBlur: z[1] || (z[1] = (B) => p.value = false), onChange: k, onKeydown: f }, null, 34), [[vShow, p.value], [vModelText, n.value]])]), _: 3 }, 8, ["width", "align", "direction", "size"])) : (openBlock(), createElementBlock("div", { key: 0, class: normalizeClass(["m-tag", [`tag-${y.size}`, y.color && h.includes(y.color) ? "tag-" + y.color : "", { "tag-borderless": !y.bordered, "has-color": y.color && !h.includes(y.color), hidden: x.value }]]), style: normalizeStyle(`background-color: ${y.color && !h.includes(y.color) ? y.color : ""};`) }, [s.value ? (openBlock(), createElementBlock("span", ao, [renderSlot(y.$slots, "icon", {}, () => [createTextVNode(toDisplayString(y.icon), 1)], true)])) : createCommentVNode("", true), createBaseVNode("span", lo, [renderSlot(y.$slots, "default", {}, void 0, true)]), y.closable ? (openBlock(), createElementBlock("span", { key: 1, class: "m-close", onClick: b }, to)) : createCommentVNode("", true)], 6));
...
var Wa = V(defineComponent({ inheritAttrs: false, __name: "Textarea", props: { width: { default: "100%" }, allowClear: { type: Boolean, default: false }, autoSize: { type: [Boolean, Object], default: false }, disabled: { type: Boolean, default: false }, maxlength: { default: void 0 }, showCount: { type: Boolean, default: false }, value: { default: "" }, valueModifiers: { default: () => ({}) } }, emits: ["update:value", "change", "enter"], setup(l, { emit: a }) {
  ...
  watch(() => e.value, () => {
    JSON.stringify(u.value) !== "{}" && (c.value = 32, nextTick(() => {
      p();
    }));
  });
  const s = ref(), c = ref(32);
  function p() {
  ...
  return (i, b) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-textarea", { "show-count": i.showCount }]), style: normalizeStyle(`width: ${o.value};`), "data-count": d.value }, [createBaseVNode("textarea", mergeProps({ ref_key: "textarea", ref: s, type: "hidden", class: ["u-textarea", { disabled: i.disabled }], style: [`height: ${i.autoSize ? c.value : ""}px`, u.value], value: i.value, maxlength: i.maxlength, disabled: i.disabled, onInput: h, onChange: x, onKeydown: M }, i.$attrs), null, 16, co), !i.disabled && i.allowClear && i.value ? (openBlock(), createElementBlock("span", { key: 0, class: "m-clear", onClick: m }, ro)) : createCommentVNode("", true)], 14, uo));
...
var Na = V(defineComponent({ __name: "TextScroll", props: { text: { default: () => [] }, width: { default: "100%" }, height: { default: 60 }, backgroundColor: { default: "#FFF" }, amount: { default: 4 }, gap: { default: 20 }, vertical: { type: Boolean, default: false }, interval: { default: 3e3 } }, emits: ["click"], setup(l, { emit: a }) {
  const e = l, o = ref(0), u = ref(0), d = ref(), s = ref(60), c = ref([...e.text]), p = ref(), n = ref(0), h = computed(() => s.value === 60 ? 1 : 60 / s.value);
  function x() {
    ...
    u.value = E(function D(I) {
      ...
      u.value > 10 && (H = I), u.value = E(D);
    });
  }
  function M() {
    o.value >= n.value ? (c.value.push(c.value.shift()), o.value = 0) : o.value += h.value, d.value = pe(M);
  }
  const m = computed(() => typeof e.width == "number" ? e.width + "px" : e.width), i = computed(() => e.text.length);
  function b() {
  ...
  function B() {
    z = me(() => {
      y.value === i.value - 1 ? y.value = 0 : y.value++, B();
    }, e.interval);
  }
  return (E, H) => E.vertical ? (openBlock(), createElementBlock("div", { key: 1, class: "m-slider-vertical", onMouseenter: g, onMouseleave: b, style: normalizeStyle(`height: ${E.height}px; width: ${m.value}; background: ${E.backgroundColor};`) }, [createVNode(TransitionGroup, { name: "slide" }, { default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(c.value, (D, I) => withDirectives((openBlock(), createElementBlock("div", { class: "m-slider", style: normalizeStyle(`width: calc(${m.value} - ${2 * E.gap}px); height: ${E.height}px;`), key: I }, [createBaseVNode("a", { class: "u-slider", title: D.title, href: D.link ? D.link : "javascript:;", target: D.link ? "_blank" : "_self", onClick: (J) => f(D.title) }, toDisplayString(D.title || "--"), 9, po)], 4)), [[vShow, y.value === I]])), 128))]), _: 1 })], 36)) : (openBlock(), createElementBlock("div", { key: 0, class: "m-slider-horizon", onMouseenter: g, onMouseleave: b, ref_key: "horizonRef", ref: p, style: normalizeStyle(`height: ${E.height}px; width: ${m.value}; background: ${E.backgroundColor};`) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(c.value, (D, I) => (openBlock(), createElementBlock("a", { style: normalizeStyle(`will-change: transform; transform: translateX(${-o.value}px); width: ${n.value - E.gap}px; margin-left: ${E.gap}px;`), class: "u-slide-title", key: I, title: D.title, href: D.link ? D.link : "javascript:;", target: D.link ? "_blank" : "_self", onClick: (J) => f(D.title) }, toDisplayString(D.title || "--"), 13, vo))), 128))], 36));
...
var Oa = V(defineComponent({ __name: "Timeline", props: { timelineData: { default: () => [] }, width: { default: "100%" }, lineStyle: { default: "solid" }, mode: { default: "left" }, position: { default: "left" } }, setup(l) {
  const a = l, e = ref(), o = ref([]), u = computed(() => typeof a.width == "number" ? a.width + "px" : a.width), d = computed(() => a.timelineData.length);
  return watchEffect(() => {
    (function() {
  ...
  }, { flush: "post" }), (s, c) => (openBlock(), createElementBlock("div", { class: "m-timeline-area", style: normalizeStyle(`width: ${u.value};`) }, [createBaseVNode("div", fo, [(openBlock(true), createElementBlock(Fragment, null, renderList(s.timelineData, (p, n) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-timeline-item", { last: n === s.timelineData.length - 1 }]), key: n }, [createBaseVNode("span", { class: normalizeClass(`u-tail ${s.mode}-tail`), style: normalizeStyle(`border-left-style: ${s.lineStyle};`) }, null, 6), createBaseVNode("div", { class: normalizeClass(`m-dot ${s.mode}-dot`), style: normalizeStyle(`height: ${o.value[n]}`) }, [renderSlot(s.$slots, "dot", { index: n }, () => [p.color === "red" ? (openBlock(), createElementBlock("span", { key: 0, class: "u-dot", style: normalizeStyle({ borderColor: "#ff4d4f" }) }, null, 4)) : p.color === "gray" ? (openBlock(), createElementBlock("span", { key: 1, class: "u-dot", style: normalizeStyle({ borderColor: "#00000040" }) }, null, 4)) : p.color === "green" ? (openBlock(), createElementBlock("span", { key: 2, class: "u-dot", style: normalizeStyle({ borderColor: "#52c41a" }) }, null, 4)) : p.color === "blue" ? (openBlock(), createElementBlock("span", { key: 3, class: "u-dot", style: normalizeStyle({ borderColor: "#1677ff" }) }, null, 4)) : (openBlock(), createElementBlock("span", { key: 4, class: "u-dot", style: normalizeStyle({ borderColor: p.color || "#1677ff" }) }, null, 4))], true)], 6), createBaseVNode("div", { ref_for: true, ref_key: "desc", ref: e, class: normalizeClass(`u-desc ${s.mode}-desc`) }, [renderSlot(s.$slots, "desc", { index: n }, () => [createTextVNode(toDisplayString(p.desc || "--"), 1)], true)], 2)], 2))), 128))])], 4));
...
var qa = V(defineComponent({ __name: "Upload", props: { accept: { default: "*" }, multiple: { type: Boolean, default: false }, maxCount: { default: 1 }, tip: { default: "Upload" }, uploadingTip: { default: "Uploading" }, gap: { default: 8 }, fit: { default: "contain" }, errorInfo: { default: "" }, beforeUpload: { type: Function, default: () => true }, uploadMode: { default: "base64" }, customRequest: { type: Function, default: () => {
  ...
  const e = l, o = ref([]), u = ref(1), d = ref(Array(e.maxCount).fill(false)), s = ref();
  function c(m) {
  ...
  const p = a, n = function(m, i) {
    e.beforeUpload(m) ? (e.maxCount > u.value && u.value++, e.uploadMode === "base64" && (d.value[i] = true, function(b, g) {
      ...
      k.readAsDataURL(b), k.onloadstart = function(f) {
        ...
        f.loaded === f.total && (d.value[g] = false);
      }, k.onload = function(f) {
        var y;
    ...
    }(m, i)), e.uploadMode === "custom" && (d.value[i] = true, function(b, g) {
      e.customRequest(b).then((k) => {
        o.value.push(k), p("update:fileList", o.value), p("change", o.value);
      }).catch((k) => {
        e.maxCount > 1 && (u.value = o.value.length + 1), M(k);
      }).finally(() => {
        d.value[g] = false;
      });
    }(m, i))) : nextTick(() => {
  ...
  return (m, i) => (openBlock(), createElementBlock("div", ho, [createVNode(unref(Ae), { size: m.gap }, { default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(u.value, (b) => {
    return openBlock(), createElementBlock("div", { class: "m-upload-item", key: b }, [createBaseVNode("div", mo, [withDirectives(createBaseVNode("div", { class: normalizeClass(["m-upload-wrap", { "upload-disabled": m.disabled }]), onDragenter: i[1] || (i[1] = withModifiers(() => {
      ...
      return m.disabled ? () => false : (f = b - 1, void s.value[f].click());
      var f;
    } }, [createBaseVNode("input", { ref_for: true, ref_key: "uploadInput", ref: s, type: "file", onClick: i[0] || (i[0] = withModifiers(() => {
    ...
    }(b - 1), ["prevent", "stop"]) }, So, 8, Lo), [[vShow, !m.disabled]])])])) : createCommentVNode("", true)])]);
    var g;
...
var Do = [((l) => (pushScopeId("data-v-d01fba1c"), l = l(), popScopeId(), l))(() => createBaseVNode("svg", { class: "u-svg", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 34 34" }, [createBaseVNode("path", { d: `M28.26,11.961L11.035,0.813C7.464-1.498,3,1.391,3,6.013v21.974c0,4.622,4.464,7.511,8.035,5.2L28.26,22.039
...
var Pa = V(defineComponent({ __name: "Video", props: { src: { default: "" }, poster: { default: "" }, second: { default: 0.5 }, width: { default: 800 }, height: { default: 450 }, autoplay: { type: Boolean, default: false }, controls: { type: Boolean, default: true }, loop: { type: Boolean, default: false }, muted: { type: Boolean, default: false }, preload: { default: "auto" }, showPlay: { type: Boolean, default: true }, fit: { default: "contain" } }, setup(l) {
  const a = l, e = ref(a.poster), o = ref(true), u = ref(false), d = ref();
  function s() {
    var c, p;
    o.value && (d.value.currentTime = 0, o.value = false), a.autoplay ? (c = d.value) == null || c.pause() : (u.value = true, (p = d.value) == null || p.play());
  }
  return onMounted(() => {
    a.autoplay && (u.value = true, o.value = false);
  }), (c, p) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-video", { "u-video-hover": !u.value }]), style: normalizeStyle(`width: ${c.width}px; height: ${c.height}px;`) }, [createBaseVNode("video", mergeProps({ ref_key: "veo", ref: d, style: `object-fit: ${c.fit};`, src: c.src, poster: e.value, width: c.width, height: c.height, autoplay: c.autoplay, controls: !o.value && c.controls, loop: c.loop, muted: c.autoplay || c.muted, preload: c.preload, crossorigin: "anonymous", onLoadeddata: p[0] || (p[0] = (n) => c.poster ? () => false : function() {
  ...
  }()), onPause: p[1] || (p[1] = (n) => c.showPlay ? void (u.value = false) : () => false), onPlaying: p[2] || (p[2] = (n) => c.showPlay ? void (u.value = true) : () => false), onClickOnce: withModifiers(s, ["prevent"]) }, c.$attrs), " 您的浏览器不支持video标签。 ", 16, Ao), withDirectives(createBaseVNode("span", { class: normalizeClass(["m-icon-play", { hidden: u.value }]) }, Do, 2), [[vShow, o.value || c.showPlay]])], 6));
...
var Ya = V(defineComponent({ __name: "Waterfall", props: { images: { default: () => [] }, columnCount: { default: 3 }, columnGap: { default: 20 }, width: { default: "100%" }, borderRadius: { default: 8 }, backgroundColor: { default: "#F2F4F8" } }, setup(l) {
  const a = l, e = computed(() => typeof a.width == "number" ? a.width + "px" : a.width), o = ref([]), u = ref(Array(a.columnCount).fill(0)), d = shallowRef(), s = ref(), c = computed(() => Math.max(...u.value) + a.columnGap), p = computed(() => a.images.length), n = ref(Array(p.value)), h = ref(false);
  async function x() {
  ...
  function m(i, b) {
      ...
      return u.value[i] = a.columnGap + b, { top: a.columnGap, left: (s.value + a.columnGap) * i + a.columnGap };
    {
      ...
      return u.value[k] = g + a.columnGap + b, { top: g + a.columnGap, left: (s.value + a.columnGap) * k + a.columnGap };
    }
  }
  return watch(() => [a.columnCount, a.columnGap, a.width], () => {
    h.value = true, u.value = Array(a.columnCount).fill(0), x();
  }, { deep: true, flush: "post" }), watchPostEffect(() => {
    a.images.length && x();
  }), (i, b) => (openBlock(), createElementBlock("div", { class: "m-waterfall", ref_key: "waterfall", ref: d, style: normalizeStyle(`--borderRadius: ${i.borderRadius}px; background-color: ${i.backgroundColor}; width: ${e.value}; height: ${c.value}px;`) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(o.value, (g, k) => withDirectives((openBlock(), createBlock(unref(ie), { class: "m-image", style: normalizeStyle(`width: ${g.width}px; height: ${g.height}px; top: ${g && g.top}px; left: ${g && g.left}px;`), spinning: !n.value[k], size: "small", indicator: "dynamic-circle", key: k }, { default: withCtx(() => [createBaseVNode("img", { class: "u-image", src: i.images[k].src, alt: i.images[k].title, onLoad: (f) => function(y) {
    n.value[y] = true;
  }(k) }, null, 40, Eo)]), _: 2 }, 1032, ["style", "spinning"])), [[vShow, n.value[k] !== void 0]])), 128))], 4));
...
var Ua = defineComponent({ __name: "Watermark", props: { width: { default: void 0 }, height: { default: void 0 }, rotate: { default: -22 }, zIndex: { default: 9 }, image: { default: void 0 }, content: { default: "" }, fullscreen: { type: Boolean, default: false }, color: { default: "rgba(0,0,0,.15)" }, fontSize: { default: 16 }, fontWeight: { default: "normal" }, fontFamily: { default: "sans-serif" }, fontStyle: { default: "normal" }, gap: { default: () => [100, 100] }, offset: { default: () => [50, 50] } }, setup(l) {
  const a = l, e = shallowRef(), o = shallowRef(), u = shallowRef(document.documentElement), d = shallowRef(false), s = computed(() => {
    var z;
    return ((z = a.gap) == null ? void 0 : z[0]) ?? 100;
  }), c = computed(() => {
    var z;
    return ((z = a.gap) == null ? void 0 : z[1]) ?? 100;
  }), p = computed(() => s.value / 2), n = computed(() => c.value / 2), h = computed(() => {
    var z;
    ...
    var H;
    var E;
    e.value && o.value && (d.value = true, o.value.setAttribute("style", (E = { ...M.value, backgroundImage: `url('${z}')`, backgroundSize: 2 * (s.value + B) + "px" }, Object.keys(E).map((D) => `${function(I) {
  ...
  const g = (z, B, E, H, D) => {
    ...
    if (B) {
      ...
      const D = b(), [I, J] = ((Q) => {
        ...
        return [Xe ?? Me, Qe ?? Ve];
      })(B), ae = (s.value + I) * D, de = (c.value + J) * D;
      z.setAttribute("width", 2 * ae + "px"), z.setAttribute("height", 2 * de + "px");
      const ke = s.value * D / 2, we = c.value * D / 2, re = I * D, ne = J * D, ve = (re + s.value * D) / 2, A = (ne + c.value * D) / 2, q = ke + ae, K = we + de, ee = ve + ae, le = A + de;
      if (B.save(), f(B, ve, A, H), E) {
        const Q = new Image();
        Q.onload = () => {
          B.drawImage(Q, ke, we, re, ne), B.restore(), f(B, ee, le, H), B.drawImage(Q, q, K, re, ne), i(z.toDataURL(), I);
        }, Q.crossOrigin = "anonymous", Q.referrerPolicy = "no-referrer", Q.src = E;
      } else
        g(B, ke, we, re, ne), B.restore(), f(B, ee, le, H), g(B, q, K, re, ne), i(z.toDataURL(), I);
    }
  };
  function f(z, B, E, H) {
  ...
  const { stop: y } = function(z, B, E) {
    ...
    d.value || z.forEach((B) => {
      ((E, H) => {
        let D = false;
        return E.removedNodes.length && (D = Array.from(E.removedNodes).some((I) => I === H)), E.type === "attributes" && E.target === H && (D = true), D;
      })(B, o.value) && (m(), k());
    });
  }, { subtree: true, childList: true, attributes: true });
  return onUnmounted(() => {
    y();
  }), (z, B) => (openBlock(), createElementBlock("div", { ref_key: "containerRef", ref: e, style: { position: "relative" } }, [renderSlot(z.$slots, "default")], 512));
} });
Ua.install = (l) => {
  l.component(Ua.__name, Ua);
};
var Ho = [aa, la, ta, oa, sa, xe, na, ia, ua, ca, da, ra, va, pa, fa, ha, ma, ga, ya, ba, He, ka, Pe, wa, xa, Ye, Ma, za, _a, Ue, Ca, $a, Ba, Fa, La, Sa, Aa, Se, Da, Ae, ie, Ea, Ha, Ia, ja2, Ta, Va, Ra, Wa, Na, Oa, qe, qa, Pa, Ya, Ua];
var Ko = { install: (l) => {
