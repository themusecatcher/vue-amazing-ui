import {
  TransitionPresets,
  useTransition
} from "./chunk-RL6T4ZPB.js";
import {
  Ka
} from "./chunk-6SKMYWFQ.js";
import {
  useQRCode
} from "./chunk-ZA6KNA2E.js";
import "./chunk-YZ7NK2YE.js";
import {
  Swiper,
  SwiperSlide
} from "./chunk-5D2PDKPO.js";
import {
  Fragment,
  Transition,
  TransitionGroup,
...
// node_modules/.pnpm/vue-amazing-ui@0.1.32_@algolia+client-search@4.22.1_@types+node@20.11.5_less@4.2.0_search-ins_b2rjm7jlvvpuapq2ya6ivjpv5a/node_modules/vue-amazing-ui/dist/vue-amazing-ui.js
...
var aa = V(defineComponent({ __name: "Alert", props: { message: { default: "" }, description: { default: "" }, type: { default: "info" }, closable: { type: Boolean, default: false }, closeText: { default: "" }, icon: { default: "" }, showIcon: { type: Boolean, default: false } }, emits: ["close"], setup(l, { emit: a }) {
  const e = l, o = ref(), n = useSlots(), d = computed(() => {
    var i;
  ...
  return (p, i) => (openBlock(), createElementBlock("div", { ref_key: "alert", ref: o, class: "m-alert-wrapper" }, [createBaseVNode("div", { class: normalizeClass(["m-alert", [`${p.type}`, { "width-description": d.value }]]) }, [p.showIcon ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [d.value ? (openBlock(), createElementBlock("span", H1, [renderSlot(p.$slots, "icon", {}, () => [p.icon ? (openBlock(), createElementBlock("img", { key: 0, src: p.icon, class: "u-big-icon-img" }, null, 8, I1)) : p.type === "info" ? (openBlock(), createElementBlock("svg", T1, j1)) : p.type === "success" ? (openBlock(), createElementBlock("svg", V1, R1)) : p.type === "warning" ? (openBlock(), createElementBlock("svg", W1, N1)) : p.type === "error" ? (openBlock(), createElementBlock("svg", O1, q1)) : createCommentVNode("", true)], true)])) : (openBlock(), createElementBlock("span", _1, [renderSlot(p.$slots, "icon", {}, () => [p.icon ? (openBlock(), createElementBlock("img", { key: 0, src: p.icon, class: "u-icon-img" }, null, 8, C1)) : p.type === "info" ? (openBlock(), createElementBlock("svg", $1, B1)) : p.type === "success" ? (openBlock(), createElementBlock("svg", F1, S1)) : p.type === "warning" ? (openBlock(), createElementBlock("svg", L1, A1)) : p.type === "error" ? (openBlock(), createElementBlock("svg", D1, E1)) : createCommentVNode("", true)], true)]))], 64)) : createCommentVNode("", true), createBaseVNode("div", P1, [createBaseVNode("div", Y1, [renderSlot(p.$slots, "message", {}, () => [createTextVNode(toDisplayString(p.message), 1)], true)]), d.value ? (openBlock(), createElementBlock("div", U1, [renderSlot(p.$slots, "description", {}, () => [createTextVNode(toDisplayString(p.description), 1)], true)])) : createCommentVNode("", true)]), p.closable ? (openBlock(), createElementBlock("a", { key: 1, class: "m-close", onClick: c }, [renderSlot(p.$slots, "closeText", {}, () => [p.closeText ? (openBlock(), createElementBlock("span", K1, toDisplayString(p.closeText), 1)) : (openBlock(), createElementBlock("svg", Z1, G1))], true)])) : createCommentVNode("", true)], 2)], 512));
...
var la = V(defineComponent({ __name: "Avatar", props: { shape: { default: "circle" }, size: { default: "default" }, src: { default: "" }, alt: { default: "" }, icon: { default: void 0 } }, setup(l) {
  ...
  return (i, h) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-avatar", [n.value === null ? "avatar-" + i.size : "", "avatar-" + i.shape, { "avatar-image": i.src }]]), style: normalizeStyle(n.value || {}) }, [i.src ? (openBlock(), createElementBlock("img", { key: 0, class: "u-image", src: i.src, alt: i.alt }, null, 8, J1)) : createCommentVNode("", true), !i.src && s.value ? (openBlock(), createElementBlock("span", X1, [renderSlot(i.$slots, "icon", {}, void 0, true)])) : createCommentVNode("", true), i.src || s.value || !c.value ? createCommentVNode("", true) : (openBlock(), createElementBlock("span", { key: 2, class: "m-string", style: normalizeStyle(p.value) }, [renderSlot(i.$slots, "default", {}, void 0, true)], 4))], 6));
...
var ta = V(defineComponent({ __name: "BackTop", props: { bottom: { default: 40 }, right: { default: 40 }, visibilityHeight: { default: 180 }, to: { default: "body" }, listenTo: { default: void 0 } }, emits: ["click", "show"], setup(l, { emit: a }) {
  const e = l, o = computed(() => typeof e.bottom == "number" ? e.bottom + "px" : e.bottom), n = computed(() => typeof e.right == "number" ? e.right + "px" : e.right), d = ref(), s = ref(0), c = ref();
  watchEffect(() => {
    nextTick(() => {
      var m;
  ...
  const i = computed(() => s.value >= e.visibilityHeight);
  function h(m) {
  ...
  return watch(i, (m) => {
    x("show", m);
  }), (m, u) => (openBlock(), createBlock(Transition, null, { default: withCtx(() => [withDirectives(createBaseVNode("div", { ref_key: "backtop", ref: d, onClick: M, class: "m-backtop", style: normalizeStyle(`bottom: ${o.value}; right: ${n.value};`) }, [renderSlot(m.$slots, "default", {}, () => [Q1], true)], 4), [[vShow, i.value]])]), _: 3 }));
...
var sa = V(defineComponent({ __name: "Breadcrumb", props: { routes: { default: () => [] }, fontSize: { default: 14 }, height: { default: 21 }, maxWidth: { default: 180 }, separator: { default: "" }, target: { default: "_self" } }, setup(l) {
  ...
  return (n, d) => (openBlock(), createElementBlock("div", { class: "m-breadcrumb", style: normalizeStyle(`height: ${n.height}px;`) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(n.routes, (s, c) => (openBlock(), createElementBlock("div", { class: "m-bread", key: c }, [createBaseVNode("a", { class: normalizeClass(["u-route", { active: c === e.value - 1 }]), style: normalizeStyle(`font-size: ${n.fontSize}px; max-width: ${n.maxWidth}px;`), href: c === e.value - 1 ? "javascript:;" : o(s), title: s.name, target: c === e.value - 1 ? "_self" : n.target }, toDisplayString(s.name || "--"), 15, sl), c !== e.value - 1 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [n.separator ? (openBlock(), createElementBlock("span", nl, toDisplayString(n.separator), 1)) : (openBlock(), createElementBlock("svg", il, ul))], 64)) : createCommentVNode("", true)]))), 128)), cl], 4));
...
var xe = V(defineComponent({ __name: "Button", props: { name: { default: "按钮" }, type: { default: "default" }, effect: { default: "fade" }, size: { default: "middle" }, route: { default: () => ({}) }, target: { default: "_self" }, disabled: { type: Boolean, default: false }, loading: { type: Boolean, default: false }, center: { type: Boolean, default: false } }, emits: ["click"], setup(l, { emit: a }) {
  const e = l, o = computed(() => JSON.stringify(e.route) !== "{}"), n = a;
  function d(c) {
    o.value || n("click", c);
  }
  function s(c) {
...
var na = V(defineComponent({ __name: "Card", props: { width: { default: "auto" }, bordered: { type: Boolean, default: true }, extra: { default: "" }, size: { default: "default" }, title: { default: "" }, headStyle: { default: () => ({}) }, bodyStyle: { default: () => ({}) } }, setup(l) {
  const a = l, e = computed(() => typeof a.width == "number" ? a.width + "px" : a.width), o = useSlots(), n = computed(() => {
    var p, i, h, x;
...
var ia = V(defineComponent({ __name: "Carousel", props: { images: { default: () => [] }, interval: { default: 3e3 }, width: { default: "100%" }, height: { default: "100vh" }, navigation: { type: Boolean, default: true }, navColor: { default: "#FFF" }, navSize: { default: 36 }, pagination: { type: Boolean, default: true }, pageActiveColor: { default: "#1677FF" }, pageSize: { default: 10 }, pageStyle: { default: () => ({}) }, disableOnInteraction: { type: Boolean, default: true }, pauseOnMouseEnter: { type: Boolean, default: true } }, setup(l) {
  const a = l, e = ref(true), o = ref(0), n = ref(false), d = ref(), s = ref(), c = ref(), p = ref(false), i = ref(), h = ref(1), x = computed(() => typeof a.width == "number" ? a.width + "px" : a.width), M = computed(() => typeof a.height == "number" ? a.height + "px" : a.height), m = computed(() => (a.images.length + 1) * z.value), u = computed(() => a.images.length);
  onMounted(() => {
    (function() {
      var D = null;
      function q(Z) {
  ...
  const b = ref(Array(u.value).fill(false)), g = ref(), k = ref(60), f = computed(() => k.value === 60 ? 12 : k.value / 60 * 12);
  function y(D) {
    b.value[D] = true;
  }
  watch(() => b.value[0], (D) => {
  ...
  function S() {
    u.value > 1 && b.value[0] && (e.value = true, n.value = false, K(), console.log("imageSlider start"));
  }
  function H() {
    Qa(s.value), n.value = true, o.value = Math.ceil(o.value / z.value) * z.value;
  }
  function E() {
    Qa(s.value), n.value = true, o.value = Math.floor(o.value / z.value) * z.value;
  }
  function K() {
    d.value = me(() => {
  ...
  function ee(D) {
    e.value ? H() : (E(), e.value = true), n.value = false, function(q) {
      o.value === u.value * z.value && (o.value = 0), c.value = q, s.value = pe(ne);
    }(D);
  }
  function de(D) {
    e.value ? (H(), e.value = false) : E(), n.value = false, function(q) {
...
var Se = V(defineComponent({ __name: "Select", props: { options: { default: () => [] }, label: { default: "label" }, value: { default: "value" }, placeholder: { default: "请选择" }, disabled: { type: Boolean, default: false }, allowClear: { type: Boolean, default: false }, search: { type: Boolean, default: false }, filter: { type: [Function, Boolean], default: true }, width: { default: 120 }, height: { default: 32 }, maxDisplay: { default: 6 }, modelValue: { default: null } }, emits: ["update:modelValue", "change"], setup(l, { emit: a }) {
  const e = l, o = ref(), n = ref(), d = ref(), s = ref(), c = ref(false), p = ref(true), i = ref(true), h = ref(false), x = ref(false), M = ref();
  function m() {
    e.allowClear && n.value && (i.value = false, h.value = true, e.search && (x.value = false));
  }
  function u() {
    e.allowClear && h.value && (h.value = false, e.search || (i.value = true)), e.search && (c.value ? (x.value = true, i.value = false, M.value.focus()) : (x.value = false, i.value = true));
  }
  function b() {
    p.value = false;
  }
  ...
  }()) }, [y.search ? withDirectives((openBlock(), createElementBlock("input", { key: 1, class: "u-search", style: normalizeStyle(`line-height: ${y.height - 2}px;`), autocomplete: "off", "onUpdate:modelValue": z[0] || (z[0] = (B) => d.value = B), placeholder: n.value || y.placeholder }, null, 12, Tl)), [[vModelText, d.value, void 0, { number: true, trim: true }]]) : (openBlock(), createElementBlock("div", { key: 0, class: normalizeClass(["u-select-input", { placeholder: !n.value }]), style: normalizeStyle(`line-height: ${y.height - 2}px;`), title: n.value }, toDisplayString(n.value || y.placeholder), 15, Il)), (openBlock(), createElementBlock("svg", { focusable: "false", class: normalizeClass(["u-svg", { show: x.value }]), "data-icon": "search", "aria-hidden": "true", viewBox: "64 64 896 896" }, jl, 2)), (openBlock(), createElementBlock("svg", { class: normalizeClass(["u-svg", { rotate: c.value, show: i.value }]), viewBox: "64 64 896 896", "data-icon": "down", "aria-hidden": "true", focusable: "false" }, Vl, 2)), (openBlock(), createElementBlock("svg", { onClick: withModifiers(f, ["stop"]), class: normalizeClass(["close", { show: h.value }]), focusable: "false", "data-icon": "close-circle", "aria-hidden": "true", viewBox: "64 64 896 896" }, Rl, 2))], 38), createVNode(TransitionGroup, { name: "fade", tag: "div" }, { default: withCtx(() => [withDirectives(createBaseVNode("div", { class: "m-options-panel", onMouseenter: b, onMouseleave: g, key: "1", style: normalizeStyle(`top: ${y.height + 4}px; line-height: ${y.height - 10}px; max-height: ${y.maxDisplay * y.height + 9}px; width: ${y.width}px;`) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(o.value, (B, I) => (openBlock(), createElementBlock("p", { key: I, class: normalizeClass(["u-option", { "option-hover": !B.disabled && B[y.value] === s.value, "option-selected": B[y.label] === n.value, "option-disabled": B.disabled }]), title: B[y.label], onMouseenter: (S) => {
    return H = B[y.value], void (s.value = H);
    var H;
  }, onClick: (S) => B.disabled ? () => false : function(H, E, K) {
    e.modelValue !== H && (n.value = E, s.value = H, k("update:modelValue", H), k("change", H, E, K)), c.value = false, e.search && (x.value = false, i.value = true);
  }(B[y.value], B[y.label], I) }, toDisplayString(B[y.label]), 43, Wl))), 128))], 36), [[vShow, c.value && o.value && o.value.length]]), withDirectives(createBaseVNode("div", { key: "2", class: "m-empty-wrap", style: normalizeStyle(`top: ${y.height + 4}px; width: ${y.width}px;`) }, [createVNode(unref(He), { image: "2", key: "2" })], 4), [[vShow, c.value && o.value && !o.value.length]])]), _: 1 })], 4));
...
var ua = V(defineComponent({ __name: "Cascader", props: { options: { default: () => [] }, label: { default: "label" }, value: { default: "value" }, children: { default: "children" }, placeholder: { default: "请选择" }, changeOnSelect: { type: Boolean, default: false }, gap: { default: 8 }, width: { default: 120 }, height: { default: 32 }, disabled: { type: [Boolean, Array], default: false }, allowClear: { type: Boolean, default: false }, search: { type: Boolean, default: false }, filter: { type: [Function, Boolean], default: true }, maxDisplay: { default: 6 }, selectedValue: { default: () => [] } }, emits: ["update:selectedValue", "change"], setup(l, { emit: a }) {
  const e = l, o = ref([]), n = ref([]), d = ref([]), s = ref([]), c = ref([]);
  function p(u, b) {
    const g = u.length;
    for (let k = 0; k < g; k++)
  ...
  return (u, b) => (openBlock(), createElementBlock("div", { class: "m-cascader", style: normalizeStyle(`height: ${u.height}px; gap: ${u.gap}px;`) }, [createVNode(unref(Se), { options: d.value, label: u.label, value: u.value, placeholder: Array.isArray(u.placeholder) ? u.placeholder[0] : u.placeholder, disabled: Array.isArray(u.disabled) ? u.disabled[0] : u.disabled, "allow-clear": u.allowClear, search: u.search, filter: u.filter, width: Array.isArray(u.width) ? u.width[0] : u.width, height: u.height, "max-display": u.maxDisplay, modelValue: o.value[0], "onUpdate:modelValue": b[0] || (b[0] = (g) => o.value[0] = g), onChange: x }, null, 8, ["options", "label", "value", "placeholder", "disabled", "allow-clear", "search", "filter", "width", "height", "max-display", "modelValue"]), createVNode(unref(Se), { options: s.value, label: u.label, value: u.value, placeholder: Array.isArray(u.placeholder) ? u.placeholder[1] : u.placeholder, disabled: Array.isArray(u.disabled) ? u.disabled[1] : u.disabled, "allow-clear": u.allowClear, search: u.search, filter: u.filter, width: Array.isArray(u.width) ? u.width[1] : u.width, height: u.height, "max-display": u.maxDisplay, modelValue: o.value[1], "onUpdate:modelValue": b[1] || (b[1] = (g) => o.value[1] = g), onChange: M }, null, 8, ["options", "label", "value", "placeholder", "disabled", "allow-clear", "search", "filter", "width", "height", "max-display", "modelValue"]), createVNode(unref(Se), { options: c.value, label: u.label, value: u.value, placeholder: Array.isArray(u.placeholder) ? u.placeholder[2] : u.placeholder, disabled: Array.isArray(u.disabled) ? u.disabled[2] : u.disabled, "allow-clear": u.allowClear, search: u.search, filter: u.filter, width: Array.isArray(u.width) ? u.width[2] : u.width, height: u.height, "max-display": u.maxDisplay, modelValue: o.value[2], "onUpdate:modelValue": b[2] || (b[2] = (g) => o.value[2] = g), onChange: m }, null, 8, ["options", "label", "value", "placeholder", "disabled", "allow-clear", "search", "filter", "width", "height", "max-display", "modelValue"])], 4));
...
var ca = V(defineComponent({ __name: "Checkbox", props: { options: { default: () => [] }, disabled: { type: Boolean, default: false }, vertical: { type: Boolean, default: false }, value: { default: () => [] }, gap: { default: 8 }, width: { default: "auto" }, height: { default: "auto" }, indeterminate: { type: Boolean, default: false }, checked: { type: Boolean, default: false } }, emits: ["update:value", "update:checked", "change"], setup(l, { emit: a }) {
  const e = l, o = computed(() => e.options.length), n = computed(() => typeof e.width == "number" ? e.width + "px" : e.width), d = computed(() => typeof e.height == "number" ? e.height + "px" : e.height), s = ref(e.value);
  watch(() => e.value, (h) => {
    s.value = h;
  });
  ...
  }(M.value) }, [createBaseVNode("span", { class: normalizeClass(["u-checkbox", { "u-checkbox-checked": s.value.includes(M.value) }]) }, null, 2), createBaseVNode("span", Ol, [renderSlot(h.$slots, "default", { label: M.label }, () => [createTextVNode(toDisplayString(M.label), 1)], true)])], 10, Nl)], 6))), 128)) : (openBlock(), createElementBlock("div", ql, [createBaseVNode("div", { class: normalizeClass(["m-box", { disabled: h.disabled }]), onClick: i }, [createBaseVNode("span", { class: normalizeClass(["u-checkbox", { "u-checkbox-checked": h.checked && !h.indeterminate, indeterminate: h.indeterminate }]) }, null, 2), createBaseVNode("span", Pl, [renderSlot(h.$slots, "default", {}, () => [createTextVNode("Check all")], true)])], 2)]))], 4));
...
var da = V(defineComponent({ __name: "Col", props: { span: { default: void 0 }, offset: { default: 0 }, flex: { default: "" }, xs: { default: void 0 }, sm: { default: void 0 }, md: { default: void 0 }, lg: { default: void 0 }, xl: { default: void 0 }, xxl: { default: void 0 } }, setup(l) {
  ...
  return onMounted(() => {
    ...
    var p, i;
    return openBlock(), createElementBlock("div", { class: normalizeClass(`m-col col-${((p = o.value) == null ? void 0 : p.span) || s.span} offset-${((i = o.value) == null ? void 0 : i.offset) || s.offset}`), style: normalizeStyle([{ "padding-left": "var(--xGap)", "padding-right": "var(--xGap)" }, `flex: ${e.value}`]) }, [renderSlot(s.$slots, "default", {}, void 0, true)], 6);
  };
...
var ra = V(defineComponent({ __name: "Collapse", props: { collapseData: { default: () => [] }, activeKey: { default: null }, copyable: { type: Boolean, default: false }, lang: { default: "" }, fontSize: { default: 14 }, headerFontSize: { default: 0 }, textFontSize: { default: 0 }, showArrow: { type: Boolean, default: true } }, emits: ["update:activeKey", "change"], setup(l, { emit: a }) {
  ...
  return (i, h) => {
    ...
    return openBlock(), createElementBlock("div", Yl, [(openBlock(true), createElementBlock(Fragment, null, renderList(i.collapseData, (M, m) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-collapse-item", { "u-collapse-item-active": c(M.key || m) }]), key: m }, [createBaseVNode("div", { class: "u-collapse-header", onClick: (u) => {
      var b;
      c(b = M.key || m) ? Array.isArray(e.activeKey) ? s(e.activeKey.filter((g) => g !== b)) : s(null) : Array.isArray(e.activeKey) ? s([...e.activeKey, b]) : s(b);
    } }, [i.showArrow ? (openBlock(), createElementBlock("svg", Kl, Zl)) : createCommentVNode("", true), createBaseVNode("div", { class: normalizeClass(["u-header", { ml24: i.showArrow }]), style: normalizeStyle(`font-size: ${i.headerFontSize || i.fontSize}px;`) }, [renderSlot(i.$slots, "header", { header: M.header, key: M.key || m }, () => [createTextVNode(toDisplayString(M.header || "--"), 1)], true)], 6)], 8, Ul), createBaseVNode("div", { class: normalizeClass(["u-collapse-content", { "u-collapse-copyable": i.copyable }]), style: normalizeStyle(`height: ${c(M.key || m) ? n.value[m] : 0}px; opacity: ${c(M.key || m) ? 1 : 0};`) }, [createBaseVNode("div", Gl, [renderSlot(i.$slots, "lang", { lang: i.lang, key: M.key || m }, () => [createTextVNode(toDisplayString(i.lang), 1)], true)]), createVNode(x, { size: "small", class: "u-copy", type: "primary", onClick: (u) => function(b) {
...
var va = V(defineComponent({ __name: "Countdown", props: { title: { default: "Countdown" }, value: { default: void 0 }, future: { type: Boolean, default: true }, format: { default: "HH:mm:ss" }, prefix: { default: "" }, suffix: { default: "" }, titleStyle: { default: () => ({}) }, valueStyle: { default: () => ({}) }, finishedText: { default: "Finished" } }, emits: ["finish"], setup(l, { emit: a }) {
  const e = l, o = useSlots(), n = computed(() => {
    var u;
...
var pa = V(defineComponent({ inheritAttrs: false, __name: "DatePicker", props: { width: { default: 180 }, mode: { default: "date" }, showTime: { type: Boolean, default: false }, showToday: { type: Boolean, default: false }, modelType: { default: "format" } }, setup(l) {
  const a = l, e = computed(() => a.mode === "time"), o = computed(() => a.mode === "week"), n = computed(() => a.mode === "month"), d = computed(() => a.mode === "year");
  return (s, c) => (openBlock(), createElementBlock("div", { class: "m-datepicker", style: normalizeStyle(`width: ${s.width}px;`) }, [createVNode(unref(Ka), mergeProps({ locale: "zh-CN", "month-change-on-scroll": false, "enable-time-picker": s.showTime, "time-picker": e.value, "week-picker": o.value, "month-picker": n.value, "year-picker": d.value, "now-button-label": "今天", "show-now-button": s.showToday, "auto-apply": "", "text-input": "", "model-type": s.modelType, "day-names": ["一", "二", "三", "四", "五", "六", "七"] }, s.$attrs), null, 16, ["enable-time-picker", "time-picker", "week-picker", "month-picker", "year-picker", "show-now-button", "model-type"])], 4));
...
var fa = V(defineComponent({ __name: "Descriptions", props: { title: { default: "" }, bordered: { type: Boolean, default: false }, column: { default: () => ({ xs: 1, sm: 2, md: 3 }) }, extra: { default: "" }, size: { default: "default" }, labelStyle: { default: () => ({}) }, contentStyle: { default: () => ({}) } }, setup(l) {
  ...
  const n = computed(() => typeof a.column == "object" ? e.value >= 1600 && a.column.xxl ? a.column.xxl : e.value >= 1200 && a.column.xl ? a.column.xl : e.value >= 992 && a.column.lg ? a.column.lg : e.value >= 768 && a.column.md ? a.column.md : e.value >= 576 && a.column.sm ? a.column.sm : e.value < 576 && a.column.xs ? a.column.xs : 1 : a.column), d = ref(), s = ref(), c = ref(), p = ref(), i = ref([]), h = computed(() => i.value.length);
  function x(u, b) {
    const g = u.length;
    let k = [];
    for (let f = 0; f < g; f++) {
  ...
  }), (u, b) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-desc", `desc-${u.size}`]) }, [createBaseVNode("div", at, [createBaseVNode("div", lt, [renderSlot(u.$slots, "title", {}, () => [createTextVNode(toDisplayString(u.title), 1)], true)]), createBaseVNode("div", tt, [renderSlot(u.$slots, "extra", {}, () => [createTextVNode(toDisplayString(u.extra), 1)], true)])]), withDirectives(createBaseVNode("div", { ref_key: "view", ref: d }, [renderSlot(u.$slots, "default", {}, void 0, true)], 512), [[vShow, false]]), createBaseVNode("div", { class: normalizeClass(["m-desc-view", { "m-bordered": u.bordered }]) }, [createBaseVNode("table", null, [u.bordered ? (openBlock(), createElementBlock("tbody", nt, [h.value ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(h.value, (g) => (openBlock(), createElementBlock("tr", { ref_for: true, ref_key: "rows", ref: p, class: "tr-bordered", key: g }))), 128)) : createCommentVNode("", true)])) : (openBlock(), createElementBlock("tbody", ot, [(openBlock(true), createElementBlock(Fragment, null, renderList(i.value, (g, k) => (openBlock(), createElementBlock("tr", { key: k }, [(openBlock(true), createElementBlock(Fragment, null, renderList(g, (f, y) => (openBlock(), createElementBlock("td", { ref_for: true, ref_key: "cols", ref: c, class: "u-item-td", colspan: f.span, key: y }, null, 8, st))), 128))]))), 128))]))])], 2)], 2));
...
var ma = V(defineComponent({ __name: "Dialog", props: { title: { default: "提示" }, content: { default: "" }, width: { default: 540 }, height: { default: "auto" }, switchFullscreen: { type: Boolean, default: false }, cancelText: { default: "取消" }, okText: { default: "确定" }, footer: { type: Boolean, default: false }, center: { type: Boolean, default: true }, top: { default: 100 }, loading: { type: Boolean, default: false }, bodyStyle: { default: () => ({}) }, visible: { type: Boolean, default: false } }, emits: ["close", "cancel", "ok"], setup(l, { emit: a }) {
  const e = l, o = ref(false), n = computed(() => typeof e.height == "number" ? e.height + "px" : e.height);
  watch(() => e.visible, (x) => {
    x && (o.value = false);
  });
  const d = a;
...
var ga = V(defineComponent({ __name: "Divider", props: { dashed: { type: Boolean, default: false }, orientation: { default: "center" }, orientationMargin: { default: "" }, borderWidth: { default: 1 }, type: { default: "horizontal" } }, setup(l) {
  ...
  return (d, s) => d.type === "horizontal" ? (openBlock(), createElementBlock("div", { key: 0, class: normalizeClass([`m-divider-horizontal ${d.orientation}`, { dashed: d.dashed, margin24: !n.value, marginLeft: d.orientationMargin !== "" && d.orientation === "left", marginRight: d.orientationMargin !== "" && d.orientation === "right" }]), style: normalizeStyle(`--border-width: ${d.borderWidth}px;`) }, [d.orientation === "left" ? withDirectives((openBlock(), createElementBlock("span", { key: 0, class: "u-text", style: normalizeStyle(`margin-left: ${e.value};`) }, [renderSlot(d.$slots, "default", {}, void 0, true)], 4)), [[vShow, n.value]]) : d.orientation === "right" ? withDirectives((openBlock(), createElementBlock("span", { key: 1, class: "u-text", style: normalizeStyle(`margin-right: ${e.value};`) }, [renderSlot(d.$slots, "default", {}, void 0, true)], 4)), [[vShow, n.value]]) : withDirectives((openBlock(), createElementBlock("span", Mt, [renderSlot(d.$slots, "default", {}, void 0, true)], 512)), [[vShow, n.value]])], 6)) : (openBlock(), createElementBlock("div", zt));
...
var ya = V(defineComponent({ __name: "Drawer", props: { title: { default: "" }, width: { default: 378 }, height: { default: 378 }, closable: { type: Boolean, default: true }, destroyOnClose: { type: Boolean, default: false }, extra: { default: "" }, placement: { default: "right" }, zIndex: { default: 1e3 }, open: { type: Boolean, default: false } }, emits: ["update:open", "close"], setup(l, { emit: a }) {
  const e = l, o = computed(() => typeof e.width == "number" ? e.width + "px" : e.width), n = computed(() => typeof e.height == "number" ? e.height + "px" : e.height), d = a;
  function s(p) {
    c(p);
  }
  function c(p) {
...
var qe = V(defineComponent({ __name: "Tooltip", props: { maxWidth: { default: 120 }, content: { default: "暂无内容" }, tooltip: { default: "暂无提示" }, fontSize: { default: 14 }, color: { default: "#FFF" }, backgroundColor: { default: "rgba(0, 0, 0, .85)" }, overlayStyle: { default: () => ({}) } }, emits: ["openChange"], setup(l, { emit: a }) {
  const e = ref(false), o = ref(), n = ref(0), d = ref(0), s = ref(), c = ref(), p = a;
  function i() {
    (function() {
...
var ba = V(defineComponent({ __name: "Ellipsis", props: { maxWidth: { default: "100%" }, line: { default: void 0 }, expand: { type: Boolean, default: false }, tooltip: { type: Boolean, default: true }, tooltipMaxWidth: { default: void 0 }, tooltipFontSize: { default: 14 }, tooltipColor: { default: "#FFF" }, tooltipBackgroundColor: { default: "rgba(0, 0, 0, .85)" }, tooltipOverlayStyle: { default: () => ({ padding: "8px 12px", textAlign: "justify" }) } }, emits: ["expandChange"], setup(l, { emit: a }) {
  const e = l, o = computed(() => typeof e.maxWidth == "number" ? e.maxWidth + "px" : e.maxWidth), n = ref(), d = ref(), s = ref();
  watchEffect(() => {
    n.value = e.tooltip;
  }), watchEffect(() => {
  ...
  function p() {
    ...
    })) : d.value.style["-webkit-line-clamp"] = "", c("expandChange", true)) : (e.tooltip && (n.value = true), d.value.style["-webkit-line-clamp"] = e.line, c("expandChange", false));
  }
  return (i, h) => n.value ? (openBlock(), createBlock(unref(qe), { key: 0, "max-width": s.value, fontSize: i.tooltipFontSize, color: i.tooltipColor, backgroundColor: i.tooltipBackgroundColor, overlayStyle: i.tooltipOverlayStyle }, { tooltip: withCtx(() => [renderSlot(i.$slots, "tooltip", {}, () => [renderSlot(i.$slots, "default", {}, void 0, true)], true)]), default: withCtx(() => [createBaseVNode("div", mergeProps({ ref_key: "ellipsis", ref: d, class: ["m-ellipsis", [i.line ? "ellipsis-line" : "not-ellipsis-line", { "cursor-pointer": i.expand }]], style: `-webkit-line-clamp: ${i.line}; max-width: ${o.value};`, onClick: h[0] || (h[0] = (x) => i.expand ? p() : () => false) }, i.$attrs), [renderSlot(i.$slots, "default", {}, void 0, true)], 16)]), _: 3 }, 8, ["max-width", "fontSize", "color", "backgroundColor", "overlayStyle"])) : (openBlock(), createElementBlock("div", mergeProps({ key: 1, ref_key: "ellipsis", ref: d, class: ["m-ellipsis", [i.line ? "ellipsis-line" : "not-ellipsis-line", { "cursor-pointer": i.expand }]], style: `-webkit-line-clamp: ${i.line}; max-width: ${o.value};`, onClick: h[1] || (h[1] = (x) => i.expand ? p() : () => false) }, i.$attrs), [renderSlot(i.$slots, "default", {}, void 0, true)], 16));
...
var d2 = defineComponent({ __name: "Image", props: { src: { default: "" }, name: { default: "" }, width: { default: 200 }, height: { default: 200 }, bordered: { type: Boolean, default: true }, gap: { default: 8 }, fit: { default: "contain" }, preview: { default: "预览" }, zoomRatio: { default: 0.1 }, minZoomScale: { default: 0.1 }, maxZoomScale: { default: 10 }, resetOnDbclick: { type: Boolean, default: true }, loop: { type: Boolean, default: false }, album: { type: Boolean, default: false } }, setup(l, { expose: a }) {
  const e = l, o = computed(() => typeof e.width == "number" ? e.width + "px" : e.width), n = computed(() => typeof e.height == "number" ? e.height + "px" : e.height), d = ref([]);
  watchEffect(() => {
  ...
  const c = ref(Array(s.value).fill(false)), p = ref(Array(s.value).fill(false)), i = ref(0), h = ref(false), x = ref(0), M = ref(1), m = ref(1), u = ref(1), b = ref(0), g = ref(0), k = ref(0), f = ref(0);
  function y(D) {
  ...
  function B(D) {
    M.value = 1, x.value = 0, k.value = 0, f.value = 0, h.value = true, i.value = D;
  }
  function I(D, q) {
  ...
  return a({ onPreview: B }), (D, q) => (openBlock(), createElementBlock("div", Nt, [createVNode(unref(Le), { size: D.gap }, { default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(d.value, (Z, ae) => withDirectives((openBlock(), createElementBlock("div", { class: normalizeClass(["m-image", { bordered: D.bordered, "image-hover-mask": c.value[ae] }]), style: normalizeStyle(`width: ${o.value}; height: ${n.value};`), key: ae }, [createVNode(unref(ie), { spinning: !c.value[ae], indicator: "dynamic-circle" }, { default: withCtx(() => [createBaseVNode("img", { class: "u-image", style: normalizeStyle(`width: calc(${o.value} - 2px); height: calc(${n.value} - 2px); object-fit: ${D.fit};`), onLoad: (le) => {
    ...
    p.value[Q] = true;
  }(ae), onDblclick: q[1] || (q[1] = (le) => D.resetOnDbclick ? K() : () => false) }, null, 44, i2)]), _: 2 }, 1032, ["spinning"])), [[vShow, i.value === ae]])), 128))], 4), s.value > 1 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createBaseVNode("div", { class: normalizeClass(["m-switch-left", { "u-switch-disabled": i.value === 0 && !D.loop }]), onClick: ne }, u2, 2), createBaseVNode("div", { class: normalizeClass(["m-switch-right", { "u-switch-disabled": i.value === s.value - 1 && !D.loop }]), onClick: ve }, c2, 2)], 64)) : createCommentVNode("", true)])], 544), [[vShow, h.value]])]), _: 1 })]));
} });
...
var wa = V(defineComponent({ inheritAttrs: false, __name: "Input", props: { width: { default: "100%" }, addonBefore: { default: "" }, addonAfter: { default: "" }, allowClear: { type: Boolean, default: false }, password: { type: Boolean, default: false }, disabled: { type: Boolean, default: false }, maxlength: { default: void 0 }, showCount: { type: Boolean, default: false }, size: { default: "middle" }, prefix: { default: "" }, suffix: { default: "" }, value: { default: "" }, valueModifiers: { default: () => ({}) } }, emits: ["update:value", "change", "enter"], setup(l, { emit: a }) {
  const e = l, o = computed(() => typeof e.width == "number" ? e.width + "px" : e.width), n = computed(() => e.maxlength ? e.value.length + " / " + e.maxlength : e.value.length), d = useSlots(), s = computed(() => {
    var y;
...
var _2 = defineComponent({ inheritAttrs: false, __name: "InputNumber", props: { width: { default: 90 }, min: { default: -1 / 0 }, max: { default: 1 / 0 }, step: { default: 1 }, precision: { default: 0 }, prefix: { default: "" }, formatter: { type: Function, default: (l) => l }, keyboard: { type: Boolean, default: true }, value: { default: null } }, emits: ["update:value", "change"], setup(l, { emit: a }) {
  var b;
  const e = l, o = computed(() => typeof e.width == "number" ? e.width + "px" : e.width), n = computed(() => {
    var k;
  ...
  }), c = ref(e.formatter((b = e.value) == null ? void 0 : b.toFixed(n.value)));
  watch(() => e.value, (g) => {
  ...
  }, ["prevent"]), ["up"])), M] }, g.$attrs), null, 16)), [[vModelDynamic, c.value]]) : withDirectives((openBlock(), createElementBlock("input", mergeProps({ key: 2, autocomplete: "off", class: "u-input-number", onChange: h, "onUpdate:modelValue": k[2] || (k[2] = (f) => c.value = f) }, g.$attrs), null, 16)), [[vModelDynamic, c.value]])]), createBaseVNode("div", x2, [createBaseVNode("span", { class: normalizeClass(["u-up-arrow", { disabled: (g.value || 0) >= g.max }]), onClick: m }, M2, 2), createBaseVNode("span", { class: normalizeClass(["u-down-arrow", { disabled: (g.value || 0) <= g.min }]), onClick: u }, z2, 2)])], 4));
} });
...
var Ye = V(defineComponent({ __name: "Message", props: { duration: { default: 3e3 }, top: { default: 30 } }, emits: ["close"], setup(l, { expose: a, emit: e }) {
  const o = l, n = ref(), d = ref([]), s = ref([]), c = ref([]), p = computed(() => typeof o.top == "number" ? o.top + "px" : o.top), i = computed(() => d.value.every((m) => !m));
  function h() {
    Ce(n.value);
  ...
  return (m, u) => (openBlock(), createElementBlock("div", { class: "m-message-wrap", style: normalizeStyle(`top: ${p.value};`) }, [createVNode(TransitionGroup, { name: "slide-fade" }, { default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(c.value, (b, g) => withDirectives((openBlock(), createElementBlock("div", { class: "m-message", key: g }, [createBaseVNode("div", { class: "m-message-content", onMouseenter: (k) => function(f) {
    Ce(s.value[f]);
  }(g), onMouseleave: (k) => function(f) {
    M(f);
  }(g) }, [b.mode === "info" ? (openBlock(), createElementBlock("svg", { key: 0, class: "u-svg", style: normalizeStyle({ fill: Ee[b.mode] }), viewBox: "64 64 896 896", "data-icon": "info-circle", "aria-hidden": "true", focusable: "false" }, $2, 4)) : createCommentVNode("", true), b.mode === "success" ? (openBlock(), createElementBlock("svg", { key: 1, class: "u-svg", style: normalizeStyle({ fill: Ee[b.mode] }), viewBox: "64 64 896 896", "data-icon": "check-circle", "aria-hidden": "true", focusable: "false" }, B2, 4)) : createCommentVNode("", true), b.mode === "error" ? (openBlock(), createElementBlock("svg", { key: 2, class: "u-svg", style: normalizeStyle({ fill: Ee[b.mode] }), viewBox: "64 64 896 896", "data-icon": "close-circle", "aria-hidden": "true", focusable: "false" }, F2, 4)) : createCommentVNode("", true), b.mode === "warning" ? (openBlock(), createElementBlock("svg", { key: 3, class: "u-svg", style: normalizeStyle({ fill: Ee[b.mode] }), viewBox: "64 64 896 896", "data-icon": "exclamation-circle", "aria-hidden": "true", focusable: "false" }, S2, 4)) : createCommentVNode("", true), b.mode === "loading" ? (openBlock(), createElementBlock("svg", { key: 4, class: "u-svg circular", style: normalizeStyle({ stroke: Ee[b.mode] }), viewBox: "0 0 50 50", focusable: "false" }, L2, 4)) : createCommentVNode("", true), createBaseVNode("p", A2, toDisplayString(b.content), 1)], 40, C2)])), [[vShow, d.value[g]]])), 128))]), _: 1 })], 4));
...
var za = V(defineComponent({ __name: "Notification", props: { message: { default: "温馨提示" }, duration: { default: 4500 }, top: { default: 24 }, bottom: { default: 24 }, placement: { default: "topRight" } }, emits: ["close"], setup(l, { expose: a, emit: e }) {
  const o = l, n = ref(), d = ref([]), s = ref([]), c = ref([]), p = ref(o.placement), i = ref(), h = computed(() => d.value.length === c.value.length);
  function x() {
...
var _a = defineComponent({ __name: "NumberAnimation", props: { from: { default: 0 }, to: { default: 1e3 }, duration: { default: 3e3 }, autoplay: { type: Boolean, default: true }, precision: { default: 0 }, prefix: { default: "" }, suffix: { default: "" }, separator: { default: "," }, decimal: { default: "." }, valueStyle: { default: () => ({}) }, transition: { default: "easeInOutCubic" } }, emits: ["started", "finished"], setup(l, { expose: a, emit: e }) {
  ...
  return a({ play: s }), (i, h) => (openBlock(), createElementBlock("span", { style: normalizeStyle(i.valueStyle) }, toDisplayString(c.value), 5));
} });
_a.install = (l) => {
...
var Ue = V(defineComponent({ __name: "Pagination", props: { current: { default: 1 }, pageSize: { default: 10 }, total: { default: 0 }, pageListNum: { default: 5 }, hideOnSinglePage: { type: Boolean, default: false }, showQuickJumper: { type: Boolean, default: false }, showTotal: { type: Boolean, default: false }, placement: { default: "center" } }, emits: ["change"], setup(l, { emit: a }) {
  const e = l, o = ref(e.current), n = ref(""), d = ref(false), s = ref(false), c = ref(false), p = ref(false), i = computed(() => Math.ceil(e.total / e.pageSize)), h = computed(() => function(b) {
    var g = [], k = Math.floor(e.pageListNum / 2), f = { start: b - k, end: b + k };
    f.start < 1 && (f.end = f.end + (1 - f.start), f.start = 1), f.end > i.value && (f.start = f.start - (f.end - i.value), f.end = i.value), f.start < 1 && (f.start = 1), f.start > 1 ? d.value = true : d.value = false, f.end < i.value ? s.value = true : s.value = false;
  ...
  }), (b, g) => (openBlock(), createElementBlock("div", { class: normalizeClass([`m-pagination ${b.placement}`, { hidden: b.hideOnSinglePage && b.total <= b.pageSize }]) }, [createBaseVNode("div", o0, [b.showTotal ? (openBlock(), createElementBlock("span", s0, "共 " + toDisplayString(i.value) + " 页 / " + toDisplayString(b.total) + " 条", 1)) : createCommentVNode("", true), createBaseVNode("span", { class: normalizeClass(["u-item", { disabled: o.value === 1 }]), onClick: g[0] || (g[0] = (k) => u(o.value - 1)) }, n0, 2), createBaseVNode("span", { class: normalizeClass(["u-item", { active: o.value === 1 }]), onClick: g[1] || (g[1] = (k) => u(1)) }, "1", 2), withDirectives(createBaseVNode("span", { class: "m-arrow", ref: "forward", onClick: M, onMouseenter: g[2] || (g[2] = (k) => c.value = true), onMouseleave: g[3] || (g[3] = (k) => c.value = false) }, i0, 544), [[vShow, d.value && h.value[0] - 1 > 1]]), (openBlock(true), createElementBlock(Fragment, null, renderList(h.value, (k, f) => (openBlock(), createElementBlock("span", { class: normalizeClass(["u-item", { active: o.value === k }]), key: f, onClick: (y) => u(k) }, toDisplayString(k), 11, u0))), 128)), withDirectives(createBaseVNode("span", { class: "m-arrow", ref: "backward", onClick: m, onMouseenter: g[4] || (g[4] = (k) => p.value = true), onMouseleave: g[5] || (g[5] = (k) => p.value = false) }, c0, 544), [[vShow, s.value && h.value[h.value.length - 1] + 1 < i.value]]), withDirectives(createBaseVNode("span", { class: normalizeClass(["u-item", { active: o.value === i.value }]), onClick: g[6] || (g[6] = (k) => u(i.value)) }, toDisplayString(i.value), 3), [[vShow, i.value !== 1]]), createBaseVNode("span", { class: normalizeClass(["u-item", { disabled: o.value === i.value }]), onClick: g[7] || (g[7] = (k) => u(o.value + 1)) }, d0, 2), b.showQuickJumper ? (openBlock(), createElementBlock("span", r0, [createTextVNode("跳至"), withDirectives(createBaseVNode("input", { type: "text", "onUpdate:modelValue": g[8] || (g[8] = (k) => n.value = k) }, null, 512), [[vModelText, n.value]]), createTextVNode("页")])) : createCommentVNode("", true)])], 2));
...
var Ca = V(defineComponent({ __name: "Popconfirm", props: { title: { default: "" }, description: { default: "" }, content: { default: "" }, icon: { default: "" }, iconType: { default: "warning" }, maxWidth: { default: "auto" }, cancelText: { default: "取消" }, cancelType: { default: "default" }, okText: { default: "确定" }, okType: { default: "primary" }, showCancel: { type: Boolean, default: true } }, emits: ["cancel", "ok", "openChange"], setup(l, { emit: a }) {
  const e = l, o = computed(() => typeof e.maxWidth == "number" ? e.maxWidth + "px" : e.maxWidth), n = useSlots(), d = computed(() => {
    var y;
    const f = (y = n.description) == null ? void 0 : y.call(n);
    return f ? !!(f[0].children !== "v-if" && (f != null && f.length)) : e.description;
  }), s = ref(false), c = ref(0), p = ref(0), i = ref(), h = ref(), x = ref(false);
  function M() {
    x.value = false;
  }
  function m() {
...
var $a = V(defineComponent({ __name: "Progress", props: { width: { default: "100%" }, percent: { default: 0 }, strokeColor: { default: "#1677FF" }, strokeWidth: { default: 8 }, showInfo: { type: Boolean, default: true }, type: { default: "line" } }, setup(l) {
  const a = l, e = computed(() => typeof a.width == "number" ? a.width + "px" : a.width), o = computed(() => (100 - a.strokeWidth) * Math.PI), n = computed(() => {
...
var Ba = V(defineComponent({ __name: "QRCode", props: { value: { default: "" }, size: { default: 160 }, color: { default: "#000" }, bgColor: { default: "#FFF" }, bordered: { type: Boolean, default: true }, borderColor: { default: "#0505050f" }, scale: { default: 8 }, errorLevel: { default: "H" } }, setup(l) {
  ...
  return (o, n) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-qrcode", { bordered: o.bordered }]), style: normalizeStyle(`width: ${o.size}px; height: ${o.size}px; border-color: ${o.borderColor};`) }, [createBaseVNode("img", { src: e.value.value, class: "u-qrcode", alt: "QRCode" }, null, 8, T0)], 6));
...
var Fa = V(defineComponent({ __name: "Radio", props: { options: { default: () => [] }, disabled: { type: Boolean, default: false }, vertical: { type: Boolean, default: false }, value: { default: null }, gap: { default: 8 }, button: { type: Boolean, default: false }, buttonStyle: { default: "outline" } }, emits: ["update:value", "change"], setup(l, { emit: a }) {
  const e = l, o = computed(() => e.options.length), n = computed(() => e.vertical ? { marginBottom: e.gap + "px" } : { marginRight: e.gap + "px" }), d = a;
  function s(c) {
    c !== e.value && (d("update:value", c), d("change", c));
  }
  return (c, p) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-radio", { "m-radio-button-solid": c.buttonStyle === "solid" }]) }, [c.button ? (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList(c.options, (i, h) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-radio-button-wrap", { "m-radio-button-checked": c.value === i.value, "m-radio-button-disabled": c.disabled || i.disabled }]), key: h, onClick: (x) => c.disabled || i.disabled ? () => false : s(i.value) }, [createBaseVNode("span", W0, [renderSlot(c.$slots, "default", { label: i.label }, () => [createTextVNode(toDisplayString(i.label), 1)], true)])], 10, R0))), 128)) : (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(c.options, (i, h) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-radio-wrap", { vertical: c.vertical }]), style: normalizeStyle(o.value !== h + 1 ? n.value : ""), key: h }, [createBaseVNode("div", { class: normalizeClass(["m-box", { "m-radio-disabled": c.disabled || i.disabled }]), onClick: (x) => c.disabled || i.disabled ? () => false : s(i.value) }, [createBaseVNode("span", { class: normalizeClass(["u-radio", { "u-radio-checked": c.value === i.value }]) }, null, 2), createBaseVNode("span", V0, [renderSlot(c.$slots, "default", { label: i.label }, () => [createTextVNode(toDisplayString(i.label), 1)], true)])], 10, j0)], 6))), 128))], 2));
...
var Sa = V(defineComponent({ __name: "Rate", props: { allowClear: { type: Boolean, default: true }, allowHalf: { type: Boolean, default: false }, count: { default: 5 }, character: { default: "star-filled" }, size: { default: 20 }, color: { default: "#fadb14" }, gap: { default: 8 }, disabled: { type: Boolean, default: false }, value: { default: 0 } }, emits: ["update:value", "change", "hoverChange"], setup(l, { emit: a }) {
  ...
  return (i, h) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-rate", { disabled: i.disabled }]), style: normalizeStyle(`--color: ${i.color};`), onMouseleave: p }, [(openBlock(true), createElementBlock(Fragment, null, renderList(i.count, (x) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-star", { "u-star-half": i.allowHalf && o.value >= x - 0.5 && o.value < x, "u-star-full": o.value >= x, "temp-gray": !i.allowHalf && n.value === x }]), style: normalizeStyle(`margin-right: ${x !== i.count ? i.gap : 0}px;`), onClick: (M) => i.allowHalf ? void M.preventDefault() : s(x), key: x }, [i.allowHalf ? (openBlock(), createElementBlock("div", { key: 0, class: normalizeClass(["u-star-first", { "temp-gray-first": n.value === x - 0.5 }]), onClick: withModifiers((M) => s(x - 0.5), ["stop"]), onMouseenter: (M) => {
    return m = x - 0.5, o.value = m, void d("hoverChange", m);
    var m;
  }, onMouseleave: c }, [i.character === "star-filled" ? (openBlock(), createElementBlock("svg", { key: 0, class: "u-star", style: normalizeStyle(`width: ${i.size}px;`), focusable: "false", "data-icon": "star", "aria-hidden": "true", viewBox: "64 64 896 896" }, q0, 4)) : i.character === "star-outlined" ? (openBlock(), createElementBlock("svg", { key: 1, class: "u-star", style: normalizeStyle(`width: ${i.size}px;`), focusable: "false", "data-icon": "star", "aria-hidden": "true", viewBox: "64 64 896 896" }, P0, 4)) : i.character === "heart-filled" ? (openBlock(), createElementBlock("svg", { key: 2, class: "u-star", style: normalizeStyle(`width: ${i.size}px;`), focusable: "false", "data-icon": "heart", "aria-hidden": "true", viewBox: "64 64 896 896" }, Y0, 4)) : i.character === "heart-outlined" ? (openBlock(), createElementBlock("svg", { key: 3, class: "u-star", style: normalizeStyle(`width: ${i.size}px;`), focusable: "false", "data-icon": "heart", "aria-hidden": "true", viewBox: "64 64 896 896" }, U0, 4)) : (openBlock(), createElementBlock("span", { key: 4, class: "u-star", style: normalizeStyle(`font-size: ${0.66 * i.size}px; height: ${i.size}px;`) }, [renderSlot(i.$slots, "character", {}, () => [createTextVNode(toDisplayString(i.character), 1)], true)], 4))], 42, O0)) : createCommentVNode("", true), createBaseVNode("div", { class: normalizeClass(["u-star-second", { "temp-gray-second": n.value === x }]), onClick: withModifiers((M) => s(x), ["stop"]), onMouseenter: (M) => {
    return m = x, o.value = m, void d("hoverChange", m);
    var m;
  }, onMouseleave: c }, [i.character === "star-filled" ? (openBlock(), createElementBlock("svg", { key: 0, class: "u-star", style: normalizeStyle(`width: ${i.size}px;`), focusable: "false", "data-icon": "star", "aria-hidden": "true", viewBox: "64 64 896 896" }, Z0, 4)) : i.character === "star-outlined" ? (openBlock(), createElementBlock("svg", { key: 1, class: "u-star", style: normalizeStyle(`width: ${i.size}px;`), focusable: "false", "data-icon": "star", "aria-hidden": "true", viewBox: "64 64 896 896" }, G0, 4)) : i.character === "heart-filled" ? (openBlock(), createElementBlock("svg", { key: 2, class: "u-star", style: normalizeStyle(`width: ${i.size}px;`), focusable: "false", "data-icon": "heart", "aria-hidden": "true", viewBox: "64 64 896 896" }, J0, 4)) : i.character === "heart-outlined" ? (openBlock(), createElementBlock("svg", { key: 3, class: "u-star", style: normalizeStyle(`width: ${i.size}px;`), focusable: "false", "data-icon": "heart", "aria-hidden": "true", viewBox: "64 64 896 896" }, X0, 4)) : (openBlock(), createElementBlock("span", { key: 4, class: "u-star", style: normalizeStyle(`font-size: ${0.66 * i.size}px; height: ${i.size}px;`) }, [renderSlot(i.$slots, "character", {}, () => [createTextVNode(toDisplayString(i.character), 1)], true)], 4))], 42, K0)], 14, N0))), 128))], 38));
...
var Aa = V(defineComponent({ __name: "Row", props: { width: { default: "auto" }, gutter: { default: 0 }, wrap: { type: Boolean, default: false }, align: { default: "top" }, justify: { default: "start" } }, setup(l) {
  ...
  }), (p, i) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-row", { "gutter-row": p.gutter }]), style: normalizeStyle(`--xGap: ${o.value / 2}px; --justify: ${p.justify}; --align: ${e[p.align]}; width: ${d.value}; margin-left: -${o.value / 2}px; margin-right: -${o.value / 2}px; row-gap: ${n.value}px;`) }, [renderSlot(p.$slots, "default", {}, void 0, true)], 6));
...
var Da = V(defineComponent({ __name: "Slider", props: { width: { default: "100%" }, min: { default: 0 }, max: { default: 100 }, disabled: { type: Boolean, default: false }, range: { type: Boolean, default: false }, step: { default: 1 }, tipFormatter: { type: Function, default: (l) => l }, hideTip: { type: Boolean, default: false }, value: { default: 0 } }, emits: ["update:value", "change"], setup(l, { emit: a }) {
  const e = l, o = ref(false), n = ref(), d = ref(0), s = ref(0), c = ref(), p = ref(), i = ref(), h = ref(), x = computed(() => k(p.value / (e.max - e.min) * e.step)), M = computed(() => typeof e.width == "number" ? e.width + "px" : e.width), m = computed(() => {
    const S = Math.round(s.value / x.value * e.step + e.min);
    return e.range ? [Math.round(d.value / x.value * e.step + e.min), S] : S;
  }), u = computed(() => e.range ? e.tipFormatter(m.value[0]) : null), b = computed(() => e.range ? e.tipFormatter(m.value[1]) : e.tipFormatter(m.value)), g = a;
  function k(S) {
  ...
  }), (S, H) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-slider", { disabled: S.disabled }]), ref_key: "slider", ref: c, style: normalizeStyle(`width: ${M.value};`) }, [createBaseVNode("div", { class: "u-slider-rail", onClick: H[0] || (H[0] = withModifiers((E) => S.disabled ? () => false : function(K) {
    o.value ? (Ce(n.value), n.value = null) : o.value = true, n.value = me(() => {
      o.value = false;
    }, 300);
  ...
  }(E), ["self"])) }), createBaseVNode("div", { class: normalizeClass(["u-slider-track", { trackTransition: o.value }]), style: normalizeStyle(`left: ${d.value}px; right: auto; width: ${s.value - d.value}px;`) }, null, 6), S.range ? (openBlock(), createElementBlock("div", { key: 0, tabindex: "0", ref_key: "leftHandle", ref: i, class: normalizeClass(["u-slider-handle", { handleTransition: o.value }]), style: normalizeStyle(`left: ${d.value}px; right: auto; transform: translate(-50%, -50%);`), onKeydown: [H[1] || (H[1] = withKeys(withModifiers((E) => S.disabled ? () => false : B(d.value, "left"), ["prevent"]), ["left"])), H[2] || (H[2] = withKeys(withModifiers((E) => S.disabled ? () => false : I(d.value, "left"), ["prevent"]), ["right"])), H[3] || (H[3] = withKeys(withModifiers((E) => S.disabled ? () => false : B(d.value, "left"), ["prevent"]), ["down"])), H[4] || (H[4] = withKeys(withModifiers((E) => S.disabled ? () => false : I(d.value, "left"), ["prevent"]), ["up"]))], onMousedown: H[5] || (H[5] = (E) => S.disabled ? () => false : y()) }, [S.hideTip ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", b4, [createTextVNode(toDisplayString(u.value) + " ", 1), k4]))], 38)) : createCommentVNode("", true), createBaseVNode("div", { tabindex: "0", ref_key: "rightHandle", ref: h, class: normalizeClass(["u-slider-handle", { handleTransition: o.value }]), style: normalizeStyle(`left: ${s.value}px; right: auto; transform: translate(-50%, -50%);`), onKeydown: [H[6] || (H[6] = withKeys(withModifiers((E) => S.disabled ? () => false : B(s.value, "right"), ["prevent"]), ["left"])), H[7] || (H[7] = withKeys(withModifiers((E) => S.disabled ? () => false : I(s.value, "right"), ["prevent"]), ["right"])), H[8] || (H[8] = withKeys(withModifiers((E) => S.disabled ? () => false : B(s.value, "right"), ["prevent"]), ["down"])), H[9] || (H[9] = withKeys(withModifiers((E) => S.disabled ? () => false : I(s.value, "right"), ["prevent"]), ["up"]))], onMousedown: H[10] || (H[10] = (E) => S.disabled ? () => false : z()) }, [S.hideTip ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", w4, [createTextVNode(toDisplayString(b.value) + " ", 1), x4]))], 38)], 6));
...
var Ea = V(defineComponent({ __name: "Statistic", props: { title: { default: "" }, value: { default: "" }, valueStyle: { default: () => ({}) }, precision: { default: 0 }, prefix: { default: "" }, suffix: { default: "" }, separator: { default: "," }, formatter: { type: Function, default: (l) => l } }, setup(l) {
  const a = l, e = computed(() => a.formatter(z1(a.value, a.precision, a.separator))), o = useSlots(), n = computed(() => {
    var c;
...
var Ha = V(defineComponent({ __name: "Steps", props: { steps: { default: () => [] }, current: { default: 1 }, width: { default: "100%" }, descMaxWidth: { default: 120 } }, emits: ["update:current", "change"], setup(l, { emit: a }) {
  const e = l, o = computed(() => typeof e.width == "number" ? e.width + "px" : e.width), n = computed(() => e.steps.length), d = computed(() => e.current < 1 ? 1 : e.current > n.value + 1 ? n.value + 1 : e.current), s = a;
  return (c, p) => (openBlock(), createElementBlock("div", { class: "m-steps-area", style: normalizeStyle(`width: ${o.value};`) }, [createBaseVNode("div", B4, [(openBlock(true), createElementBlock(Fragment, null, renderList(c.steps, (i, h) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-steps-item", { finish: d.value > h + 1, process: d.value === h + 1, wait: d.value < h + 1 }]), key: h }, [createBaseVNode("div", { class: "m-info-wrap", onClick: (x) => function(M) {
    d.value !== M && (s("update:current", M), s("change", M));
  }(h + 1) }, [createBaseVNode("div", S4, [d.value <= h + 1 ? (openBlock(), createElementBlock("span", L4, toDisplayString(h + 1), 1)) : (openBlock(), createElementBlock("svg", A4, D4))]), createBaseVNode("div", E4, [createBaseVNode("div", H4, toDisplayString(i.title), 1), withDirectives(createBaseVNode("div", { class: "u-steps-description", style: normalizeStyle(`max-width: ${c.descMaxWidth}px;`) }, toDisplayString(i.description), 5), [[vShow, i.description]])])], 8, F4)], 2))), 128))])], 4));
...
var Ia = V(defineComponent({ __name: "Swiper", props: { images: { default: () => [] }, width: { default: "100%" }, height: { default: "100vh" }, type: { default: "banner" }, navigation: { type: Boolean, default: true }, delay: { default: 3e3 }, swipe: { type: Boolean, default: true }, preloaderColor: { default: "theme" } }, emits: ["swiper", "change"], setup(l, { emit: a }) {
  const e = l, o = computed(() => typeof e.width == "number" ? e.width + "px" : e.width), n = computed(() => typeof e.height == "number" ? e.height + "px" : e.height), d = ref([Navigation, Pagination, Autoplay, EffectFade]), s = ref({ delay: e.delay, disableOnInteraction: false, pauseOnMouseEnter: true }), c = ref([Autoplay]), p = ref({ delay: 0, disableOnInteraction: false }), i = ref([Navigation, Pagination, Mousewheel]), h = a;
  function x(M) {
  ...
  return (M, m) => (openBlock(), createElementBlock(Fragment, null, [M.type === "banner" ? (openBlock(), createBlock(unref(Swiper), mergeProps({ key: 0, class: { "swiper-no-swiping": !M.swipe }, modules: d.value, navigation: M.navigation, "slides-per-view": 1, autoplay: s.value, lazy: "", loop: "", onSwiper: x, onSlideChange: m[0] || (m[0] = (u) => M.$emit("change")) }, M.$attrs), { default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(M.images, (u, b) => (openBlock(), createBlock(unref(SwiperSlide), { key: b }, { default: withCtx(() => [createBaseVNode("a", { href: u.link ? u.link : "javascript:;", target: u.link ? "_blank" : "_self", class: "m-link" }, [createBaseVNode("img", { src: u.src, class: "u-img", style: normalizeStyle(`width: ${o.value}; height: ${n.value};`), alt: u.title, loading: "lazy" }, null, 12, T4)], 8, I4), createBaseVNode("div", { class: normalizeClass(`swiper-lazy-preloader swiper-lazy-preloader-${M.preloaderColor}`) }, null, 2)]), _: 2 }, 1024))), 128))]), _: 1 }, 16, ["class", "modules", "navigation", "autoplay"])) : createCommentVNode("", true), M.type === "carousel" ? (openBlock(), createBlock(unref(Swiper), mergeProps({ key: 1, class: "swiper-no-swiping", modules: c.value, autoplay: p.value, lazy: "", loop: "", onSwiper: x, onSlideChange: m[1] || (m[1] = (u) => M.$emit("change")) }, M.$attrs), { default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(M.images, (u, b) => (openBlock(), createBlock(unref(SwiperSlide), { key: b }, { default: withCtx(() => [createBaseVNode("a", { href: u.link ? u.link : "javascript:;", target: u.link ? "_blank" : "_self", class: "m-link" }, [createBaseVNode("img", { src: u.src, class: "u-img", style: normalizeStyle(`width: ${o.value}; height: ${n.value};`), alt: u.title, loading: "lazy" }, null, 12, V4)], 8, j4), createBaseVNode("div", { class: normalizeClass(`swiper-lazy-preloader swiper-lazy-preloader-${M.preloaderColor}`) }, null, 2)]), _: 2 }, 1024))), 128))]), _: 1 }, 16, ["modules", "autoplay"])) : createCommentVNode("", true), M.type === "broadcast" ? (openBlock(), createBlock(unref(Swiper), mergeProps({ key: 2, modules: i.value, navigation: M.navigation, lazy: "", onSwiper: x, onSlideChange: m[2] || (m[2] = (u) => M.$emit("change")) }, M.$attrs), { default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(M.images, (u, b) => (openBlock(), createBlock(unref(SwiperSlide), { key: b }, { default: withCtx(() => [createBaseVNode("a", { href: u.link ? u.link : "javascript:;", target: u.link ? "_blank" : "_self", class: "m-link" }, [createBaseVNode("img", { src: u.src, class: "u-img", style: normalizeStyle(`width: ${o.value}; height: ${n.value};`), alt: u.title, loading: "lazy" }, null, 12, W4)], 8, R4), createBaseVNode("div", { class: normalizeClass(`swiper-lazy-preloader swiper-lazy-preloader-${M.preloaderColor}`) }, null, 2)]), _: 2 }, 1024))), 128))]), _: 1 }, 16, ["modules", "navigation"])) : createCommentVNode("", true)], 64));
...
var Ta = V(defineComponent({ __name: "Switch", props: { onInfo: { default: "" }, offInfo: { default: "" }, disabled: { type: Boolean, default: false }, checked: { type: Boolean, default: false }, nodeStyle: { default: () => ({}) } }, emits: ["update:checked", "change"], setup(l, { emit: a }) {
  const e = l, o = a;
  return (n, d) => (openBlock(), createElementBlock("div", N4, [createBaseVNode("div", { onClick: d[0] || (d[0] = (s) => n.disabled ? () => false : (o("update:checked", !e.checked), void o("change", !e.checked))), class: normalizeClass(["m-switch", { "switch-checked": n.checked, disabled: n.disabled }]) }, [createBaseVNode("div", { class: normalizeClass(["u-switch-inner", n.checked ? "inner-checked" : "inner-unchecked"]) }, toDisplayString(n.checked ? n.onInfo : n.offInfo), 3), createBaseVNode("div", { class: normalizeClass(["u-node", { "node-checked": n.checked }]), style: normalizeStyle(n.nodeStyle) }, [renderSlot(n.$slots, "node", {}, void 0, true)], 6)], 2)]));
...
var ja = V(defineComponent({ __name: "Table", props: { columns: { default: () => [] }, dataSource: { default: () => [] }, pagination: { default: () => ({ page: 1, pageSize: 10 }) }, showPagination: { type: Boolean, default: true }, hideOnSinglePage: { type: Boolean, default: false }, total: { default: 0 }, loading: { type: Boolean, default: false } }, emits: ["change"], setup(l, { emit: a }) {
  ...
  return (n, d) => (openBlock(), createElementBlock("div", O4, [createBaseVNode("table", q4, [createBaseVNode("thead", null, [createBaseVNode("tr", P4, [(openBlock(true), createElementBlock(Fragment, null, renderList(n.columns, (s, c) => (openBlock(), createElementBlock("th", { class: "m-th", style: normalizeStyle(`width: ${typeof s.width == "number" ? s.width + "px" : s.width};`), key: c }, toDisplayString(s.title), 5))), 128))])]), createBaseVNode("tbody", Y4, [withDirectives(createBaseVNode("tr", U4, [createVNode(unref(ie), { class: "m-loading", size: "small", colspan: n.columns.length }, null, 8, ["colspan"])], 512), [[vShow, n.loading]]), withDirectives(createBaseVNode("tr", K4, [createBaseVNode("td", { class: "m-td-empty", colspan: n.columns.length }, [createVNode(unref(He), { class: "empty", image: "2" })], 8, Z4)], 512), [[vShow, !n.total]]), (openBlock(true), createElementBlock(Fragment, null, renderList(n.dataSource, (s, c) => (openBlock(), createElementBlock("tr", { class: "m-tr", key: c }, [(openBlock(true), createElementBlock(Fragment, null, renderList(n.columns, (p, i) => (openBlock(), createElementBlock("td", { class: "m-td", key: i, title: s[p.dataIndex] }, [p.slot ? renderSlot(n.$slots, p.slot, mergeProps({ key: 0 }, s, { index: c }), () => [createTextVNode(toDisplayString(s[p.dataIndex] || "--"), 1)], true) : (openBlock(), createElementBlock("span", J4, toDisplayString(s[p.dataIndex] || "--"), 1))], 8, G4))), 128))]))), 128))])]), n.showPagination && n.total ? (openBlock(), createBlock(unref(Ue), { key: 0, class: "mt20", onChange: o, current: n.pagination.page, pageSize: n.pagination.pageSize, total: n.total, hideOnSinglePage: n.hideOnSinglePage, showQuickJumper: true, showTotal: true, placement: "right" }, null, 8, ["current", "pageSize", "total", "hideOnSinglePage"])) : createCommentVNode("", true)]));
...
var Va = V(defineComponent({ __name: "Tabs", props: { tabPages: { default: () => [] }, centered: { type: Boolean, default: false }, size: { default: "small" }, activeKey: { default: "" } }, emits: ["update:activeKey", "change"], setup(l, { emit: a }) {
  const e = l, o = ref(), n = ref(0), d = ref(0), s = ref(), c = ref(), p = ref(false), i = ref(0), h = ref(0);
  watchEffect(() => {
    (function() {
      const m = s.value.offsetWidth, u = c.value.offsetWidth;
      u > m && (p.value = true, i.value = u - m);
    })();
  ...
  return (m, u) => (openBlock(), createElementBlock("div", { class: normalizeClass(`m-tabs ${m.size}`) }, [createBaseVNode("div", X4, [createBaseVNode("div", { ref_key: "wrap", ref: s, class: normalizeClass(["m-tabs-nav-wrap", { "tabs-center": m.centered, "before-shadow-active": h.value > 0, "after-shadow-active": h.value < i.value }]) }, [createBaseVNode("div", { ref_key: "nav", ref: c, class: "m-tabs-nav-list", onWheel: u[0] || (u[0] = (b) => p.value ? function(g) {
    if (g.deltaX !== 0) {
      g.preventDefault();
      const k = 1 * g.deltaX;
...
var Ra = V(defineComponent({ __name: "Tag", props: { closable: { type: Boolean, default: false }, color: { default: "" }, icon: { default: "" }, size: { default: "middle" }, bordered: { type: Boolean, default: true }, dynamic: { type: Boolean, default: false }, value: { default: () => [] }, spaceWidth: { default: "auto" }, spaceAlign: { default: "start" }, spaceDirection: { default: "horizontal" }, spaceSize: { default: "small" } }, emits: ["update:value", "close", "dynamicClose"], setup(l, { emit: a }) {
  const e = l, o = computed(() => {
    ...
    return null;
  }), n = computed(() => e.dynamic && e.value.length ? o.value ? e.value.map((y) => ({ label: y, closable: true })) : e.value.map((y) => ({ closable: true, ...y })) : []), d = useSlots(), s = computed(() => {
    var y;
    if (!e.dynamic) {
    ...
    return false;
  }), c = ref(), p = ref(false), i = ref(""), h = ["success", "processing", "error", "warning", "default", "pink", "red", "yellow", "orange", "cyan", "green", "blue", "purple", "geekblue", "magenta", "volcano", "gold", "lime"], x = ref(false), M = ref(), m = ref(Array(e.value.length).fill(1));
  watchEffect(() => {
    if (e.dynamic) {
...
var Wa = V(defineComponent({ inheritAttrs: false, __name: "Textarea", props: { width: { default: "100%" }, allowClear: { type: Boolean, default: false }, autoSize: { type: [Boolean, Object], default: false }, disabled: { type: Boolean, default: false }, maxlength: { default: void 0 }, showCount: { type: Boolean, default: false }, value: { default: "" }, valueModifiers: { default: () => ({}) } }, emits: ["update:value", "change", "enter"], setup(l, { emit: a }) {
  ...
  return (u, b) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-textarea", { "show-count": u.showCount }]), style: normalizeStyle(`width: ${o.value};`), "data-count": d.value }, [createBaseVNode("textarea", mergeProps({ ref_key: "textarea", ref: s, type: "hidden", class: ["u-textarea", { disabled: u.disabled }], style: [`height: ${u.autoSize ? c.value : ""}px`, n.value], value: u.value, maxlength: u.maxlength, disabled: u.disabled, onInput: h, onChange: x, onKeydown: M }, u.$attrs), null, 16, co), !u.disabled && u.allowClear && u.value ? (openBlock(), createElementBlock("span", { key: 0, class: "m-clear", onClick: m }, ro)) : createCommentVNode("", true)], 14, uo));
...
var Na = V(defineComponent({ __name: "TextScroll", props: { scrollText: {}, single: { type: Boolean, default: false }, width: { default: "100%" }, height: { default: 60 }, fontSize: { default: 16 }, fontWeight: { default: 400 }, color: { default: "rgba(0, 0, 0, .88)" }, backgroundColor: { default: "#FFF" }, amount: { default: 4 }, gap: { default: 20 }, vertical: { type: Boolean, default: false }, interval: { default: 3e3 } }, emits: ["click"], setup(l, { emit: a }) {
  const e = l, o = ref(0), n = ref(0), d = ref(), s = ref(60), c = computed(() => e.single ? [e.scrollText, e.scrollText] : [...e.scrollText]), p = computed(() => c.value.length), i = computed(() => e.single ? 1 : e.amount), h = computed(() => s.value === 60 ? 1 : 60 / s.value), x = ref(), M = ref(0);
  function m() {
...
var Oa = V(defineComponent({ __name: "Timeline", props: { timelineData: { default: () => [] }, width: { default: "100%" }, lineStyle: { default: "solid" }, mode: { default: "left" }, position: { default: "left" } }, setup(l) {
  const a = l, e = ref(), o = ref([]), n = computed(() => typeof a.width == "number" ? a.width + "px" : a.width), d = computed(() => a.timelineData.length);
  return watchEffect(() => {
    (function() {
  ...
  }, { flush: "post" }), (s, c) => (openBlock(), createElementBlock("div", { class: "m-timeline-area", style: normalizeStyle(`width: ${n.value};`) }, [createBaseVNode("div", fo, [(openBlock(true), createElementBlock(Fragment, null, renderList(s.timelineData, (p, i) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-timeline-item", { last: i === s.timelineData.length - 1 }]), key: i }, [createBaseVNode("span", { class: normalizeClass(`u-tail ${s.mode}-tail`), style: normalizeStyle(`border-left-style: ${s.lineStyle};`) }, null, 6), createBaseVNode("div", { class: normalizeClass(`m-dot ${s.mode}-dot`), style: normalizeStyle(`height: ${o.value[i]}`) }, [renderSlot(s.$slots, "dot", { index: i }, () => [p.color === "red" ? (openBlock(), createElementBlock("span", { key: 0, class: "u-dot", style: normalizeStyle({ borderColor: "#ff4d4f" }) }, null, 4)) : p.color === "gray" ? (openBlock(), createElementBlock("span", { key: 1, class: "u-dot", style: normalizeStyle({ borderColor: "#00000040" }) }, null, 4)) : p.color === "green" ? (openBlock(), createElementBlock("span", { key: 2, class: "u-dot", style: normalizeStyle({ borderColor: "#52c41a" }) }, null, 4)) : p.color === "blue" ? (openBlock(), createElementBlock("span", { key: 3, class: "u-dot", style: normalizeStyle({ borderColor: "#1677ff" }) }, null, 4)) : (openBlock(), createElementBlock("span", { key: 4, class: "u-dot", style: normalizeStyle({ borderColor: p.color || "#1677ff" }) }, null, 4))], true)], 6), createBaseVNode("div", { ref_for: true, ref_key: "desc", ref: e, class: normalizeClass(`u-desc ${s.mode}-desc`) }, [renderSlot(s.$slots, "desc", { index: i }, () => [createTextVNode(toDisplayString(p.desc || "--"), 1)], true)], 2)], 2))), 128))])], 4));
...
var qa = V(defineComponent({ __name: "Upload", props: { accept: { default: "*" }, multiple: { type: Boolean, default: false }, maxCount: { default: 1 }, tip: { default: "Upload" }, uploadingTip: { default: "Uploading" }, gap: { default: 8 }, fit: { default: "contain" }, errorInfo: { default: "" }, beforeUpload: { type: Function, default: () => true }, uploadMode: { default: "base64" }, customRequest: { type: Function, default: () => {
  ...
  const e = l, o = ref([]), n = ref(1), d = ref(Array(e.maxCount).fill(false)), s = ref();
  function c(m) {
  ...
  const p = a, i = function(m, u) {
    e.beforeUpload(m) ? (e.maxCount > n.value && n.value++, e.uploadMode === "base64" && (d.value[u] = true, function(b, g) {
    ...
    }(m, u)), e.uploadMode === "custom" && (d.value[u] = true, function(b, g) {
  ...
  return (m, u) => (openBlock(), createElementBlock("div", ho, [createVNode(unref(Le), { size: m.gap }, { default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(n.value, (b) => {
    return openBlock(), createElementBlock("div", { class: "m-upload-item", key: b }, [createBaseVNode("div", mo, [withDirectives(createBaseVNode("div", { class: normalizeClass(["m-upload-wrap", { "upload-disabled": m.disabled }]), onDragenter: u[1] || (u[1] = withModifiers(() => {
      ...
      var f;
    } }, [createBaseVNode("input", { ref_for: true, ref_key: "uploadInput", ref: s, type: "file", onClick: u[0] || (u[0] = withModifiers(() => {
...
var Do = [((l) => (pushScopeId("data-v-e5be5d67"), l = l(), popScopeId(), l))(() => createBaseVNode("svg", { class: "u-svg", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 34 34" }, [createBaseVNode("path", { d: `M28.26,11.961L11.035,0.813C7.464-1.498,3,1.391,3,6.013v21.974c0,4.622,4.464,7.511,8.035,5.2L28.26,22.039
...
var Pa = V(defineComponent({ __name: "Video", props: { src: { default: "" }, poster: { default: "" }, second: { default: 0.5 }, width: { default: 800 }, height: { default: 450 }, autoplay: { type: Boolean, default: false }, controls: { type: Boolean, default: true }, loop: { type: Boolean, default: false }, muted: { type: Boolean, default: false }, preload: { default: "metadata" }, showPlay: { type: Boolean, default: true }, fit: { default: "contain" } }, setup(l) {
  const a = l, e = ref(a.poster), o = ref(true), n = ref(false), d = ref();
  function s() {
    var c, p;
    o.value && (d.value.currentTime = 0, o.value = false), a.autoplay ? (c = d.value) == null || c.pause() : (n.value = true, (p = d.value) == null || p.play());
  }
  return onMounted(() => {
    a.autoplay && (n.value = true, o.value = false);
  }), (c, p) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-video", { "u-video-hover": !n.value }]), style: normalizeStyle(`width: ${c.width}px; height: ${c.height}px;`) }, [createBaseVNode("video", mergeProps({ ref_key: "veo", ref: d, style: `object-fit: ${c.fit};`, src: c.src, poster: e.value, width: c.width, height: c.height, autoplay: c.autoplay, controls: !o.value && c.controls, loop: c.loop, muted: c.autoplay || c.muted, preload: c.preload, crossorigin: "anonymous", onLoadedmetadata: p[0] || (p[0] = (i) => c.poster ? () => false : async function() {
  ...
  }()), onPause: p[1] || (p[1] = (i) => c.showPlay ? void (n.value = false) : () => false), onPlaying: p[2] || (p[2] = (i) => c.showPlay ? void (n.value = true) : () => false), onClickOnce: withModifiers(s, ["prevent"]) }, c.$attrs), " 您的浏览器不支持video标签。 ", 16, Ao), withDirectives(createBaseVNode("span", { class: normalizeClass(["m-icon-play", { hidden: n.value }]) }, Do, 2), [[vShow, o.value || c.showPlay]])], 6));
...
var Ya = V(defineComponent({ __name: "Waterfall", props: { images: { default: () => [] }, columnCount: { default: 3 }, columnGap: { default: 20 }, width: { default: "100%" }, borderRadius: { default: 8 }, backgroundColor: { default: "#F2F4F8" } }, setup(l) {
  const a = l, e = computed(() => typeof a.width == "number" ? a.width + "px" : a.width), o = ref([]), n = ref(Array(a.columnCount).fill(0)), d = shallowRef(), s = ref(), c = computed(() => Math.max(...n.value) + a.columnGap), p = computed(() => a.images.length), i = ref(Array(p.value)), h = ref(false);
  async function x() {
  ...
  return watch(() => [a.columnCount, a.columnGap, a.width], () => {
    h.value = true, n.value = Array(a.columnCount).fill(0), x();
  }, { deep: true, flush: "post" }), watchPostEffect(() => {
    a.images.length && x();
  }), (u, b) => (openBlock(), createElementBlock("div", { class: "m-waterfall", ref_key: "waterfall", ref: d, style: normalizeStyle(`--borderRadius: ${u.borderRadius}px; background-color: ${u.backgroundColor}; width: ${e.value}; height: ${c.value}px;`) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(o.value, (g, k) => withDirectives((openBlock(), createBlock(unref(ie), { class: "m-image", style: normalizeStyle(`width: ${g.width}px; height: ${g.height}px; top: ${g && g.top}px; left: ${g && g.left}px;`), spinning: !i.value[k], size: "small", indicator: "dynamic-circle", key: k }, { default: withCtx(() => [createBaseVNode("img", { class: "u-image", src: u.images[k].src, alt: u.images[k].title, onLoad: (f) => function(y) {
    i.value[y] = true;
  }(k) }, null, 40, Eo)]), _: 2 }, 1032, ["style", "spinning"])), [[vShow, i.value[k] !== void 0]])), 128))], 4));
...
var Ua = defineComponent({ __name: "Watermark", props: { width: { default: void 0 }, height: { default: void 0 }, layout: { default: "alternate" }, rotate: { default: -22 }, zIndex: { default: 9 }, image: { default: void 0 }, content: { default: "" }, fullscreen: { type: Boolean, default: false }, color: { default: "rgba(0,0,0,.15)" }, fontSize: { default: 16 }, fontWeight: { default: "normal" }, fontFamily: { default: "sans-serif" }, fontStyle: { default: "normal" }, gap: { default: () => [100, 100] }, offset: { default: () => [50, 50] } }, setup(l) {
  const a = l, e = shallowRef(), o = shallowRef(), n = shallowRef(document.documentElement), d = shallowRef(false), s = computed(() => {
    var z;
    return ((z = a.gap) == null ? void 0 : z[0]) ?? 100;
  }), c = computed(() => {
    var z;
    return ((z = a.gap) == null ? void 0 : z[1]) ?? 100;
  }), p = computed(() => s.value / 2), i = computed(() => c.value / 2), h = computed(() => {
    var z;
  ...
  function b(z, B) {
    var S;
    var I;
    e.value && o.value && (d.value = true, o.value.setAttribute("style", (I = { ...m.value, backgroundImage: `url('${z}')`, backgroundSize: (s.value + B) * M.value + "px" }, Object.keys(I).map((H) => `${function(E) {
