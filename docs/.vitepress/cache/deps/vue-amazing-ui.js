...
// node_modules/.pnpm/vue-amazing-ui@0.1.34_@algolia+client-search@4.22.1_@types+node@20.11.20_less@4.2.0_search-in_3udbcvu46jt7dxghvvnbanynse/node_modules/vue-amazing-ui/dist/vue-amazing-ui.js
...
var ce = (l) => (pushScopeId("data-v-68ad7050"), l = l(), popScopeId(), l);
...
var B1 = [ce(() => createBaseVNode("path", { d: "M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64zm32 664c0 4.4-3.6 8-8 8h-48c-4.4 0-8-3.6-8-8V456c0-4.4 3.6-8 8-8h48c4.4 0 8 3.6 8 8v272zm-32-344a48.01 48.01 0 010-96 48.01 48.01 0 010 96z" }, null, -1))];
...
var A1 = [ce(() => createBaseVNode("path", { d: "M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64zm-32 232c0-4.4 3.6-8 8-8h48c4.4 0 8 3.6 8 8v272c0 4.4-3.6 8-8 8h-48c-4.4 0-8-3.6-8-8V296zm32 440a48.01 48.01 0 010-96 48.01 48.01 0 010 96z" }, null, -1))];
...
var aa = V(defineComponent({ __name: "Alert", props: { message: { default: "" }, description: { default: "" }, type: { default: "info" }, closable: { type: Boolean, default: false }, closeText: { default: "" }, icon: { default: "" }, showIcon: { type: Boolean, default: false } }, emits: ["close"], setup(l, { emit: a }) {
  const e = l, o = ref(), n = useSlots(), c = computed(() => {
    var u;
...
var la = V(defineComponent({ __name: "Avatar", props: { shape: { default: "circle" }, size: { default: "default" }, src: { default: "" }, alt: { default: "" }, icon: { default: void 0 } }, setup(l) {
  ...
  return (u, h) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-avatar", [n.value === null ? "avatar-" + u.size : "", "avatar-" + u.shape, { "avatar-image": u.src }]]), style: normalizeStyle(n.value || {}) }, [u.src ? (openBlock(), createElementBlock("img", { key: 0, class: "u-image", src: u.src, alt: u.alt }, null, 8, J1)) : createCommentVNode("", true), !u.src && d.value ? (openBlock(), createElementBlock("span", X1, [renderSlot(u.$slots, "icon", {}, void 0, true)])) : createCommentVNode("", true), u.src || d.value || !s.value ? createCommentVNode("", true) : (openBlock(), createElementBlock("span", { key: 2, class: "m-string", style: normalizeStyle(p.value) }, [renderSlot(u.$slots, "default", {}, void 0, true)], 4))], 6));
...
var ta = V(defineComponent({ __name: "BackTop", props: { bottom: { default: 40 }, right: { default: 40 }, visibilityHeight: { default: 180 }, to: { default: "body" }, listenTo: { default: void 0 } }, emits: ["click", "show"], setup(l, { emit: a }) {
  const e = l, o = computed(() => typeof e.bottom == "number" ? e.bottom + "px" : e.bottom), n = computed(() => typeof e.right == "number" ? e.right + "px" : e.right), c = ref(), d = ref(0), s = ref();
  watchEffect(() => {
    nextTick(() => {
      var y;
      e.listenTo === void 0 ? s.value = h((y = c.value) == null ? void 0 : y.parentElement) : typeof e.listenTo == "string" ? s.value = typeof document < "u" ? document.getElementsByTagName(e.listenTo)[0] : null : e.listenTo instanceof HTMLElement && (s.value = e.listenTo), s.value && (function(i) {
  ...
  return watch(u, (y) => {
    x("show", y);
  }), (y, i) => (openBlock(), createBlock(Transition, null, { default: withCtx(() => [withDirectives(createBaseVNode("div", { ref_key: "backtop", ref: c, onClick: M, class: "m-backtop", style: normalizeStyle(`bottom: ${o.value}; right: ${n.value};`) }, [renderSlot(y.$slots, "default", {}, () => [Q1], true)], 4), [[vShow, u.value]])]), _: 3 }));
...
var sa = V(defineComponent({ __name: "Breadcrumb", props: { routes: { default: () => [] }, fontSize: { default: 14 }, height: { default: 21 }, maxWidth: { default: 180 }, separator: { default: "" }, target: { default: "_self" } }, setup(l) {
  ...
  return (n, c) => (openBlock(), createElementBlock("div", { class: "m-breadcrumb", style: normalizeStyle(`height: ${n.height}px;`) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(n.routes, (d, s) => (openBlock(), createElementBlock("div", { class: "m-bread", key: s }, [createBaseVNode("a", { class: normalizeClass(["u-route", { active: s === e.value - 1 }]), style: normalizeStyle(`font-size: ${n.fontSize}px; max-width: ${n.maxWidth}px;`), href: s === e.value - 1 ? "javascript:;" : o(d), title: d.name, target: s === e.value - 1 ? "_self" : n.target }, toDisplayString(d.name || "--"), 15, sl), s !== e.value - 1 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [n.separator ? (openBlock(), createElementBlock("span", nl, toDisplayString(n.separator), 1)) : (openBlock(), createElementBlock("svg", il, ul))], 64)) : createCommentVNode("", true)]))), 128)), cl], 4));
...
var na = V(defineComponent({ __name: "Card", props: { width: { default: "auto" }, bordered: { type: Boolean, default: true }, extra: { default: "" }, size: { default: "default" }, title: { default: "" }, headStyle: { default: () => ({}) }, bodyStyle: { default: () => ({}) } }, setup(l) {
  ...
  return (c, d) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-card", { bordered: c.bordered, "m-small-card": c.size === "small" }]), style: normalizeStyle(`width: ${e.value};`) }, [n.value ? (openBlock(), createElementBlock("div", { key: 0, class: "m-card-head", style: normalizeStyle(c.headStyle) }, [createBaseVNode("div", vl, [createBaseVNode("div", pl, [renderSlot(c.$slots, "title", {}, () => [createTextVNode(toDisplayString(c.title), 1)], true)]), createBaseVNode("div", fl, [renderSlot(c.$slots, "extra", {}, () => [createTextVNode(toDisplayString(c.extra), 1)], true)])])], 4)) : createCommentVNode("", true), createBaseVNode("div", { class: "m-card-body", style: normalizeStyle(c.bodyStyle) }, [renderSlot(c.$slots, "default", {}, void 0, true)], 4)], 6));
...
var ia = V(defineComponent({ __name: "Carousel", props: { images: { default: () => [] }, interval: { default: 3e3 }, width: { default: "100%" }, height: { default: "100vh" }, navigation: { type: Boolean, default: true }, navColor: { default: "#FFF" }, navSize: { default: 36 }, pagination: { type: Boolean, default: true }, pageActiveColor: { default: "#1677FF" }, pageSize: { default: 10 }, pageStyle: { default: () => ({}) }, disableOnInteraction: { type: Boolean, default: true }, pauseOnMouseEnter: { type: Boolean, default: true } }, setup(l) {
  const a = l, e = ref(true), o = ref(0), n = ref(false), c = ref(), d = ref(), s = ref(), p = ref(false), u = ref(), h = ref(1), x = computed(() => typeof a.width == "number" ? a.width + "px" : a.width), M = computed(() => typeof a.height == "number" ? a.height + "px" : a.height), y = computed(() => (a.images.length + 1) * z.value), i = computed(() => a.images.length), b = ref(Array(i.value).fill(false)), m = ref(), k = ref(60), f = computed(() => k.value === 60 ? 12 : k.value / 60 * 12);
  function g(D) {
    b.value[D] = true;
  }
  watch(() => b.value[0], (D) => {
  ...
  function S() {
    i.value > 1 && b.value[0] && (e.value = true, n.value = false, K(), console.log("imageSlider start"));
  }
  function H() {
    Qa(d.value), n.value = true, o.value = Math.ceil(o.value / z.value) * z.value;
  }
  function E() {
    Qa(d.value), n.value = true, o.value = Math.floor(o.value / z.value) * z.value;
  }
  function K() {
    c.value = me(() => {
      const D = o.value % (i.value * z.value) + z.value;
      h.value = h.value % i.value + 1, function(q) {
        o.value === i.value * z.value && (o.value = 0), s.value = q, d.value = pe(re);
      }(D);
    }, a.interval);
  }
  function ee(D) {
    e.value ? H() : (E(), e.value = true), n.value = false, function(q) {
      o.value === i.value * z.value && (o.value = 0), s.value = q, d.value = pe(ne);
    }(D);
  }
  function de(D) {
    e.value ? (H(), e.value = false) : E(), n.value = false, function(q) {
      o.value === 0 && (o.value = i.value * z.value), s.value = q, d.value = pe(ve);
    }(D);
  }
  function ke() {
    const D = (h.value + i.value - 2) % i.value * z.value;
    h.value = h.value - 1 > 0 ? h.value - 1 : i.value, de(D);
  }
  function we() {
  ...
  return onMounted(() => {
    ...
    D = null, m.value = pe(function q(Z) {
      D ? (k.value = Math.floor(1e3 / (Z - D)), console.log("fps", k.value)) : (m.value > 10 && (D = Z), m.value = pe(q));
    }), z.value = u.value.offsetWidth, $.value = u.value.offsetHeight, document.addEventListener("keydown", I);
  }), onUnmounted(() => {
    document.removeEventListener("keydown", I);
  }), (D, q) => (openBlock(), createElementBlock("div", { class: "m-slider", ref_key: "carousel", ref: u, style: normalizeStyle(`--navColor: ${D.navColor}; --pageActiveColor: ${D.pageActiveColor}; width: ${x.value}; height: ${M.value};`), onMouseenter: q[1] || (q[1] = (Z) => D.pauseOnMouseEnter ? (Ce(c.value), c.value = null, e.value ? H() : E(), void console.log("imageSlider stop")) : () => false), onMouseleave: q[2] || (q[2] = (Z) => D.pauseOnMouseEnter ? S() : () => false) }, [createBaseVNode("div", { class: normalizeClass({ transition: n.value }), style: normalizeStyle(`width: ${y.value}px; height: 100%; will-change: transform; transform: translateX(${-o.value}px);`) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(D.images, (Z, ae) => (openBlock(), createElementBlock("div", { class: "m-image", key: ae }, [createVNode(unref(ue), { spinning: !b.value[ae], indicator: "dynamic-circle" }, { default: withCtx(() => [createBaseVNode("a", { href: Z.link ? Z.link : "javascript:;", target: Z.link ? "_blank" : "_self", class: "m-link" }, [(openBlock(), createElementBlock("img", { onLoad: (te) => g(ae), src: Z.src, key: Z.src, alt: Z.title, class: "u-img", style: normalizeStyle(`width: ${z.value}px; height: ${$.value}px;`) }, null, 44, zl))], 8, Ml)]), _: 2 }, 1032, ["spinning"])]))), 128)), i.value ? (openBlock(), createElementBlock("div", _l, [createVNode(unref(ue), { spinning: !b.value[0], indicator: "dynamic-circle" }, { default: withCtx(() => [createBaseVNode("a", { href: D.images[0].link ? D.images[0].link : "javascript:;", target: D.images[0].link ? "_blank" : "_self", class: "m-link" }, [(openBlock(), createElementBlock("img", { onLoad: q[0] || (q[0] = (Z) => g(0)), src: D.images[0].src, key: D.images[0].src, alt: D.images[0].title, class: "u-img", style: normalizeStyle(`width: ${z.value}px; height: ${$.value}px;`) }, null, 44, $l))], 8, Cl)]), _: 1 }, 8, ["spinning"])])) : createCommentVNode("", true)], 6), D.navigation ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [(openBlock(), createElementBlock("svg", { class: "arrow-left", style: normalizeStyle(`width: ${D.navSize}px; height: ${D.navSize}px;`), onClick: ke, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 16 16" }, Bl, 4)), (openBlock(), createElementBlock("svg", { class: "arrow-right", style: normalizeStyle(`width: ${D.navSize}px; height: ${D.navSize}px;`), onClick: we, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 16 16" }, Fl, 4))], 64)) : createCommentVNode("", true), D.pagination ? (openBlock(), createElementBlock("div", Sl, [(openBlock(true), createElementBlock(Fragment, null, renderList(i.value, (Z) => (openBlock(), createElementBlock("div", { onClick: (ae) => function(te) {
    if (h.value !== te) {
      p.value = true;
...
var Se = V(defineComponent({ __name: "Select", props: { options: { default: () => [] }, label: { default: "label" }, value: { default: "value" }, placeholder: { default: "请选择" }, disabled: { type: Boolean, default: false }, allowClear: { type: Boolean, default: false }, search: { type: Boolean, default: false }, filter: { type: [Function, Boolean], default: true }, width: { default: 120 }, height: { default: 32 }, maxDisplay: { default: 6 }, modelValue: { default: null } }, emits: ["update:modelValue", "change"], setup(l, { emit: a }) {
  const e = l, o = ref(), n = ref(), c = ref(), d = ref(), s = ref(false), p = ref(true), u = ref(true), h = ref(false), x = ref(false), M = ref();
  function y() {
    e.allowClear && n.value && (u.value = false, h.value = true, e.search && (x.value = false));
  }
  function i() {
  ...
  }()) }, [g.search ? withDirectives((openBlock(), createElementBlock("input", { key: 1, class: "u-search", style: normalizeStyle(`line-height: ${g.height - 2}px;`), autocomplete: "off", "onUpdate:modelValue": z[0] || (z[0] = ($) => c.value = $), placeholder: n.value || g.placeholder }, null, 12, Tl)), [[vModelText, c.value, void 0, { number: true, trim: true }]]) : (openBlock(), createElementBlock("div", { key: 0, class: normalizeClass(["u-select-input", { placeholder: !n.value }]), style: normalizeStyle(`line-height: ${g.height - 2}px;`), title: n.value }, toDisplayString(n.value || g.placeholder), 15, Il)), (openBlock(), createElementBlock("svg", { focusable: "false", class: normalizeClass(["u-svg", { show: x.value }]), "data-icon": "search", "aria-hidden": "true", viewBox: "64 64 896 896" }, jl, 2)), (openBlock(), createElementBlock("svg", { class: normalizeClass(["u-svg", { rotate: s.value, show: u.value }]), viewBox: "64 64 896 896", "data-icon": "down", "aria-hidden": "true", focusable: "false" }, Vl, 2)), (openBlock(), createElementBlock("svg", { onClick: withModifiers(f, ["stop"]), class: normalizeClass(["close", { show: h.value }]), focusable: "false", "data-icon": "close-circle", "aria-hidden": "true", viewBox: "64 64 896 896" }, Rl, 2))], 38), createVNode(TransitionGroup, { name: "fade", tag: "div" }, { default: withCtx(() => [withDirectives(createBaseVNode("div", { class: "m-options-panel", onMouseenter: b, onMouseleave: m, key: "1", style: normalizeStyle(`top: ${g.height + 4}px; line-height: ${g.height - 10}px; max-height: ${g.maxDisplay * g.height + 9}px; width: ${g.width}px;`) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(o.value, ($, I) => (openBlock(), createElementBlock("p", { key: I, class: normalizeClass(["u-option", { "option-hover": !$.disabled && $[g.value] === d.value, "option-selected": $[g.label] === n.value, "option-disabled": $.disabled }]), title: $[g.label], onMouseenter: (S) => {
    return H = $[g.value], void (d.value = H);
    var H;
  }, onClick: (S) => $.disabled ? () => false : function(H, E, K) {
    e.modelValue !== H && (n.value = E, d.value = H, k("update:modelValue", H), k("change", H, E, K)), s.value = false, e.search && (x.value = false, u.value = true);
  }($[g.value], $[g.label], I) }, toDisplayString($[g.label]), 43, Wl))), 128))], 36), [[vShow, s.value && o.value && o.value.length]]), withDirectives(createBaseVNode("div", { key: "2", class: "m-empty-wrap", style: normalizeStyle(`top: ${g.height + 4}px; width: ${g.width}px;`) }, [createVNode(unref(He), { image: "2", key: "2" })], 4), [[vShow, s.value && o.value && !o.value.length]])]), _: 1 })], 4));
...
var ua = V(defineComponent({ __name: "Cascader", props: { options: { default: () => [] }, label: { default: "label" }, value: { default: "value" }, children: { default: "children" }, placeholder: { default: "请选择" }, changeOnSelect: { type: Boolean, default: false }, gap: { default: 8 }, width: { default: 120 }, height: { default: 32 }, disabled: { type: [Boolean, Array], default: false }, allowClear: { type: Boolean, default: false }, search: { type: Boolean, default: false }, filter: { type: [Function, Boolean], default: true }, maxDisplay: { default: 6 }, selectedValue: { default: () => [] } }, emits: ["update:selectedValue", "change"], setup(l, { emit: a }) {
  const e = l, o = ref([]), n = ref([]), c = ref([]), d = ref([]), s = ref([]);
  function p(i, b) {
    const m = i.length;
    for (let k = 0; k < m; k++)
  ...
  watchEffect(() => {
    ...
    var i;
    i = o.value, d.value = p(c.value, 0), s.value = [], i.length > 1 && (s.value = p(d.value, 1)), function(b) {
      n.value[0] = u(c.value, 0), b.length > 1 && (n.value[1] = u(d.value, 1)), b.length > 2 && (n.value[2] = u(s.value, 2));
    }(o.value);
  });
  const h = a;
  function x(i, b) {
    e.changeOnSelect ? (h("update:selectedValue", [i]), h("change", [i], [b])) : (o.value = [i], n.value = [b]);
  }
  function M(i, b) {
    e.changeOnSelect ? (h("update:selectedValue", [o.value[0], i]), h("change", [o.value[0], i], [n.value[0], b])) : (o.value = [o.value[0], i], n.value = [n.value[0], b]);
  }
  function y(i, b) {
    h("update:selectedValue", [...o.value.slice(0, 2), i]), h("change", [...o.value.slice(0, 2), i], [...n.value.slice(0, 2), b]);
  }
  return (i, b) => (openBlock(), createElementBlock("div", { class: "m-cascader", style: normalizeStyle(`height: ${i.height}px; gap: ${i.gap}px;`) }, [createVNode(unref(Se), { options: c.value, label: i.label, value: i.value, placeholder: Array.isArray(i.placeholder) ? i.placeholder[0] : i.placeholder, disabled: Array.isArray(i.disabled) ? i.disabled[0] : i.disabled, "allow-clear": i.allowClear, search: i.search, filter: i.filter, width: Array.isArray(i.width) ? i.width[0] : i.width, height: i.height, "max-display": i.maxDisplay, modelValue: o.value[0], "onUpdate:modelValue": b[0] || (b[0] = (m) => o.value[0] = m), onChange: x }, null, 8, ["options", "label", "value", "placeholder", "disabled", "allow-clear", "search", "filter", "width", "height", "max-display", "modelValue"]), createVNode(unref(Se), { options: d.value, label: i.label, value: i.value, placeholder: Array.isArray(i.placeholder) ? i.placeholder[1] : i.placeholder, disabled: Array.isArray(i.disabled) ? i.disabled[1] : i.disabled, "allow-clear": i.allowClear, search: i.search, filter: i.filter, width: Array.isArray(i.width) ? i.width[1] : i.width, height: i.height, "max-display": i.maxDisplay, modelValue: o.value[1], "onUpdate:modelValue": b[1] || (b[1] = (m) => o.value[1] = m), onChange: M }, null, 8, ["options", "label", "value", "placeholder", "disabled", "allow-clear", "search", "filter", "width", "height", "max-display", "modelValue"]), createVNode(unref(Se), { options: s.value, label: i.label, value: i.value, placeholder: Array.isArray(i.placeholder) ? i.placeholder[2] : i.placeholder, disabled: Array.isArray(i.disabled) ? i.disabled[2] : i.disabled, "allow-clear": i.allowClear, search: i.search, filter: i.filter, width: Array.isArray(i.width) ? i.width[2] : i.width, height: i.height, "max-display": i.maxDisplay, modelValue: o.value[2], "onUpdate:modelValue": b[2] || (b[2] = (m) => o.value[2] = m), onChange: y }, null, 8, ["options", "label", "value", "placeholder", "disabled", "allow-clear", "search", "filter", "width", "height", "max-display", "modelValue"])], 4));
...
var ca = V(defineComponent({ __name: "Checkbox", props: { options: { default: () => [] }, disabled: { type: Boolean, default: false }, vertical: { type: Boolean, default: false }, value: { default: () => [] }, gap: { default: 8 }, width: { default: "auto" }, height: { default: "auto" }, indeterminate: { type: Boolean, default: false }, checked: { type: Boolean, default: false } }, emits: ["update:value", "update:checked", "change"], setup(l, { emit: a }) {
  const e = l, o = computed(() => e.options.length), n = computed(() => typeof e.width == "number" ? e.width + "px" : e.width), c = computed(() => typeof e.height == "number" ? e.height + "px" : e.height), d = computed(() => e.vertical ? { marginBottom: e.gap + "px" } : { marginRight: e.gap + "px" }), s = ref(e.value);
  watch(() => e.value, (h) => {
    s.value = h;
  });
  const p = a;
  ...
  return (h, x) => (openBlock(), createElementBlock("div", { class: "m-checkbox", style: normalizeStyle(`max-width: ${n.value}; max-height: ${c.value};`) }, [o.value ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(h.options, (M, y) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-checkbox-wrap", { vertical: h.vertical }]), style: normalizeStyle(o.value !== y + 1 ? d.value : ""), key: y }, [createBaseVNode("div", { class: normalizeClass(["m-box", { disabled: h.disabled || M.disabled }]), onClick: (i) => h.disabled || M.disabled ? () => false : function(b) {
...
var ra = V(defineComponent({ __name: "Collapse", props: { collapseData: { default: () => [] }, activeKey: { default: null }, copyable: { type: Boolean, default: false }, lang: { default: "" }, fontSize: { default: 14 }, headerFontSize: { default: 0 }, textFontSize: { default: 0 }, showArrow: { type: Boolean, default: true } }, emits: ["update:activeKey", "change"], setup(l, { emit: a }) {
  ...
  return (u, h) => {
    ...
    return openBlock(), createElementBlock("div", Yl, [(openBlock(true), createElementBlock(Fragment, null, renderList(u.collapseData, (M, y) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-collapse-item", { "u-collapse-item-active": s(M.key || y) }]), key: y }, [createBaseVNode("div", { class: "u-collapse-header", onClick: (i) => {
      var b;
      s(b = M.key || y) ? Array.isArray(e.activeKey) ? d(e.activeKey.filter((m) => m !== b)) : d(null) : Array.isArray(e.activeKey) ? d([...e.activeKey, b]) : d(b);
    } }, [u.showArrow ? (openBlock(), createElementBlock("svg", Kl, Zl)) : createCommentVNode("", true), createBaseVNode("div", { class: normalizeClass(["u-header", { ml24: u.showArrow }]), style: normalizeStyle(`font-size: ${u.headerFontSize || u.fontSize}px;`) }, [renderSlot(u.$slots, "header", { header: M.header, key: M.key || y }, () => [createTextVNode(toDisplayString(M.header || "--"), 1)], true)], 6)], 8, Ul), createBaseVNode("div", { class: normalizeClass(["u-collapse-content", { "u-collapse-copyable": u.copyable }]), style: normalizeStyle(`height: ${s(M.key || y) ? n.value[y] : 0}px; opacity: ${s(M.key || y) ? 1 : 0};`) }, [createBaseVNode("div", Gl, [renderSlot(u.$slots, "lang", { lang: u.lang, key: M.key || y }, () => [createTextVNode(toDisplayString(u.lang), 1)], true)]), createVNode(x, { size: "small", class: "u-copy", type: "primary", onClick: (i) => function(b) {
...
var pa = V(defineComponent({ inheritAttrs: false, __name: "DatePicker", props: { width: { default: 180 }, mode: { default: "date" }, showTime: { type: Boolean, default: false }, showToday: { type: Boolean, default: false }, modelType: { default: "format" } }, setup(l) {
  const a = l, e = computed(() => a.mode === "time"), o = computed(() => a.mode === "week"), n = computed(() => a.mode === "month"), c = computed(() => a.mode === "year");
...
var fa = V(defineComponent({ __name: "Descriptions", props: { title: { default: "" }, bordered: { type: Boolean, default: false }, column: { default: () => ({ xs: 1, sm: 2, md: 3 }) }, extra: { default: "" }, size: { default: "default" }, labelStyle: { default: () => ({}) }, contentStyle: { default: () => ({}) } }, setup(l) {
  const a = l, e = ref(document.documentElement.clientWidth), o = computed(() => typeof a.column == "object" ? e.value >= 1600 && a.column.xxl ? a.column.xxl : e.value >= 1200 && a.column.xl ? a.column.xl : e.value >= 992 && a.column.lg ? a.column.lg : e.value >= 768 && a.column.md ? a.column.md : e.value >= 576 && a.column.sm ? a.column.sm : e.value < 576 && a.column.xs ? a.column.xs : 1 : a.column), n = ref(), c = ref(), d = ref(), s = ref(), p = ref([]), u = computed(() => p.value.length);
  function h() {
    e.value = document.documentElement.clientWidth;
  }
  function x(i, b) {
    ...
    for (let f = 0; f < m; f++) {
      ...
      M(k) < b ? (g.span = Math.min(g.span, b - M(k)), f === m - 1 && (g.span = b - M(k)), k.push(g), f === m - 1 && p.value.push(k)) : (p.value.push(k), k = [g], f === m - 1 && (g.span = b, p.value.push(k)));
    }
    a.bordered ? nextTick(() => {
      p.value.forEach((f, g) => {
        f.forEach((z) => {
          const $ = Array.from(z.element.children), I = $[0].cloneNode(true);
          I.colSpan = 1, y(I, a.labelStyle), y(I, JSON.parse(z.element.dataset.labelStyle));
          const S = $[1].cloneNode(true);
          S.colSpan = 2 * z.span - 1, y(S, a.contentStyle), y(S, JSON.parse(z.element.dataset.contentStyle)), s.value[g].appendChild(I), s.value[g].appendChild(S);
        });
      });
    }) : nextTick(() => {
      i.forEach((f, g) => {
        ...
        const I = z[1];
        y(I, a.contentStyle), y(I, JSON.parse(f.dataset.contentStyle)), d.value[g].appendChild(f);
      });
    });
  }
  function M(i) {
  ...
  }), (i, b) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-desc", `desc-${i.size}`]) }, [createBaseVNode("div", at, [createBaseVNode("div", lt, [renderSlot(i.$slots, "title", {}, () => [createTextVNode(toDisplayString(i.title), 1)], true)]), createBaseVNode("div", tt, [renderSlot(i.$slots, "extra", {}, () => [createTextVNode(toDisplayString(i.extra), 1)], true)])]), withDirectives(createBaseVNode("div", { ref_key: "view", ref: n }, [renderSlot(i.$slots, "default", {}, void 0, true)], 512), [[vShow, false]]), createBaseVNode("div", { class: normalizeClass(["m-desc-view", { "m-bordered": i.bordered }]) }, [createBaseVNode("table", null, [i.bordered ? (openBlock(), createElementBlock("tbody", nt, [u.value ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(u.value, (m) => (openBlock(), createElementBlock("tr", { ref_for: true, ref_key: "rows", ref: s, class: "tr-bordered", key: m }))), 128)) : createCommentVNode("", true)])) : (openBlock(), createElementBlock("tbody", ot, [(openBlock(true), createElementBlock(Fragment, null, renderList(p.value, (m, k) => (openBlock(), createElementBlock("tr", { key: k }, [(openBlock(true), createElementBlock(Fragment, null, renderList(m, (f, g) => (openBlock(), createElementBlock("td", { ref_for: true, ref_key: "cols", ref: d, class: "u-item-td", colspan: f.span, key: g }, null, 8, st))), 128))]))), 128))]))])], 2)], 2));
...
var ya = V(defineComponent({ __name: "Drawer", props: { title: { default: "" }, width: { default: 378 }, height: { default: 378 }, closable: { type: Boolean, default: true }, destroyOnClose: { type: Boolean, default: false }, extra: { default: "" }, placement: { default: "right" }, zIndex: { default: 1e3 }, open: { type: Boolean, default: false } }, emits: ["update:open", "close"], setup(l, { emit: a }) {
  const e = l, o = computed(() => typeof e.width == "number" ? e.width + "px" : e.width), n = computed(() => typeof e.height == "number" ? e.height + "px" : e.height), c = a;
  function d(p) {
    s(p);
  }
  function s(p) {
...
var qe = V(defineComponent({ __name: "Tooltip", props: { maxWidth: { default: 120 }, content: { default: "暂无内容" }, tooltip: { default: "暂无提示" }, fontSize: { default: 14 }, color: { default: "#FFF" }, backgroundColor: { default: "rgba(0, 0, 0, .85)" }, overlayStyle: { default: () => ({}) } }, emits: ["openChange"], setup(l, { emit: a }) {
  const e = ref(false), o = ref(), n = ref(0), c = ref(0), d = ref(), s = ref(), p = a;
  function u() {
    (function() {
      const x = d.value.offsetWidth, M = s.value.offsetWidth, y = s.value.offsetHeight;
      n.value = y + 4, c.value = (M - x) / 2;
...
var ba = V(defineComponent({ __name: "Ellipsis", props: { maxWidth: { default: "100%" }, line: { default: void 0 }, expand: { type: Boolean, default: false }, tooltip: { type: Boolean, default: true }, tooltipMaxWidth: { default: void 0 }, tooltipFontSize: { default: 14 }, tooltipColor: { default: "#FFF" }, tooltipBackgroundColor: { default: "rgba(0, 0, 0, .85)" }, tooltipOverlayStyle: { default: () => ({ padding: "8px 12px", textAlign: "justify" }) } }, emits: ["expandChange"], setup(l, { emit: a }) {
  const e = l, o = ref(), n = ref(), c = ref(), d = computed(() => typeof e.maxWidth == "number" ? e.maxWidth + "px" : e.maxWidth);
  watchEffect(() => {
    o.value = e.tooltip;
  }), watchEffect(() => {
  ...
  const s = a;
  function p() {
    n.value.style["-webkit-line-clamp"] ? (e.tooltip ? (o.value = false, nextTick(() => {
      n.value.style["-webkit-line-clamp"] = "";
    })) : n.value.style["-webkit-line-clamp"] = "", s("expandChange", true)) : (e.tooltip && (o.value = true), n.value.style["-webkit-line-clamp"] = e.line, s("expandChange", false));
  }
...
var Le = V(defineComponent({ __name: "Space", props: { width: { default: "auto" }, align: { default: "start" }, direction: { default: "horizontal" }, size: { default: "small" }, wrap: { type: Boolean, default: true } }, setup(l) {
  ...
  return (n, c) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-space", [`${n.direction} ${n.align}`, { wrap: n.wrap }]]), style: normalizeStyle(`width: ${e.value}; gap: ${o.value}; margin-bottom: -${Array.isArray(a.size) && n.wrap ? a.size[1] : 0}px;`) }, [renderSlot(n.$slots, "default", {}, void 0, true)], 6));
...
var d2 = defineComponent({ __name: "Image", props: { src: { default: "" }, name: { default: "" }, width: { default: 200 }, height: { default: 200 }, bordered: { type: Boolean, default: true }, gap: { default: 8 }, fit: { default: "contain" }, preview: { default: "预览" }, zoomRatio: { default: 0.1 }, minZoomScale: { default: 0.1 }, maxZoomScale: { default: 10 }, resetOnDbclick: { type: Boolean, default: true }, loop: { type: Boolean, default: false }, album: { type: Boolean, default: false } }, setup(l, { expose: a }) {
  const e = l, o = computed(() => typeof e.width == "number" ? e.width + "px" : e.width), n = computed(() => typeof e.height == "number" ? e.height + "px" : e.height), c = ref([]);
  watchEffect(() => {
  ...
  const s = ref(Array(d.value).fill(false)), p = ref(Array(d.value).fill(false)), u = ref(0), h = ref(false), x = ref(0), M = ref(1), y = ref(1), i = ref(1), b = ref(0), m = ref(0), k = ref(0), f = ref(0);
  function g(D) {
  ...
  function K() {
    M.value = 1, y.value = 1, i.value = 1, x.value = 0, k.value = 0, f.value = 0;
  }
  function ee() {
    x.value += 90;
  }
  ...
  return a({ onPreview: $ }), (D, q) => (openBlock(), createElementBlock("div", Nt, [createVNode(unref(Le), { size: D.gap }, { default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(c.value, (Z, ae) => withDirectives((openBlock(), createElementBlock("div", { class: normalizeClass(["m-image", { bordered: D.bordered, "image-hover-mask": s.value[ae] }]), style: normalizeStyle(`width: ${o.value}; height: ${n.value};`), key: ae }, [createVNode(unref(ue), { spinning: !s.value[ae], indicator: "dynamic-circle" }, { default: withCtx(() => [createBaseVNode("img", { class: "u-image", style: normalizeStyle(`width: calc(${o.value} - 2px); height: calc(${n.value} - 2px); object-fit: ${D.fit};`), onLoad: (te) => {
    ...
    document.onmousemove = (ea) => {
      k.value = Fe + ea.clientX - b.value, f.value = ze + ea.clientY - m.value;
    }, document.onmouseup = () => {
    ...
    p.value[Q] = true;
  }(ae), onDblclick: q[1] || (q[1] = (te) => D.resetOnDbclick ? K() : () => false) }, null, 44, i2)]), _: 2 }, 1032, ["spinning"])), [[vShow, u.value === ae]])), 128))], 4), d.value > 1 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createBaseVNode("div", { class: normalizeClass(["m-switch-left", { "u-switch-disabled": u.value === 0 && !D.loop }]), onClick: ne }, u2, 2), createBaseVNode("div", { class: normalizeClass(["m-switch-right", { "u-switch-disabled": u.value === d.value - 1 && !D.loop }]), onClick: ve }, c2, 2)], 64)) : createCommentVNode("", true)])], 544), [[vShow, h.value]])]), _: 1 })]));
} });
...
var wa = V(defineComponent({ inheritAttrs: false, __name: "Input", props: { width: { default: "100%" }, addonBefore: { default: "" }, addonAfter: { default: "" }, allowClear: { type: Boolean, default: false }, password: { type: Boolean, default: false }, disabled: { type: Boolean, default: false }, maxlength: { default: void 0 }, showCount: { type: Boolean, default: false }, size: { default: "middle" }, prefix: { default: "" }, suffix: { default: "" }, value: { default: "" }, valueModifiers: { default: () => ({}) } }, emits: ["update:value", "change", "enter"], setup(l, { emit: a }) {
  const e = l, o = computed(() => typeof e.width == "number" ? e.width + "px" : e.width), n = computed(() => e.maxlength ? e.value.length + " / " + e.maxlength : e.value.length), c = useSlots(), d = computed(() => {
    var g;
...
var _2 = defineComponent({ inheritAttrs: false, __name: "InputNumber", props: { width: { default: 90 }, min: { default: -1 / 0 }, max: { default: 1 / 0 }, step: { default: 1 }, precision: { default: 0 }, prefix: { default: "" }, formatter: { type: Function, default: (l) => l }, keyboard: { type: Boolean, default: true }, value: { default: null } }, emits: ["update:value", "change"], setup(l, { emit: a }) {
  ...
  const e = l, o = computed(() => typeof e.width == "number" ? e.width + "px" : e.width), n = computed(() => {
    ...
    var k;
    const m = (k = c.prefix) == null ? void 0 : k.call(c);
    return m ? !!(m[0].children !== "v-if" && (m != null && m.length)) : e.prefix;
  }), s = ref(e.formatter((b = e.value) == null ? void 0 : b.toFixed(n.value)));
  watch(() => e.value, (m) => {
  ...
  function h(m) {
    ...
    if (Number.isNaN(parseFloat(k)))
      ...
      if (parseFloat(k) < e.min)
        return void u(e.min);
      parseFloat(k) !== e.value ? u(parseFloat(k)) : s.value = (g = e.value) == null ? void 0 : g.toFixed(n.value);
    }
  }
  function x(m, k) {
    const f = String(m).split(".")[1], g = String(k).split(".")[1];
    let z = Math.max((f == null ? void 0 : f.length) || 0, (g == null ? void 0 : g.length) || 0), $ = m.toFixed(z), I = k.toFixed(z);
    return (+$.replace(".", "") + +I.replace(".", "")) / Math.pow(10, z);
  }
  function M(m) {
  ...
  return (m, k) => (openBlock(), createElementBlock("div", { class: "m-input-number", tabindex: "1", style: normalizeStyle(`width: ${o.value};`) }, [createBaseVNode("div", k2, [d.value ? (openBlock(), createElementBlock("span", w2, [renderSlot(m.$slots, "prefix", {}, () => [createTextVNode(toDisplayString(m.prefix), 1)], true)])) : createCommentVNode("", true), m.keyboard ? withDirectives((openBlock(), createElementBlock("input", mergeProps({ key: 1, autocomplete: "off", class: "u-input-number", onChange: h, "onUpdate:modelValue": k[0] || (k[0] = (f) => s.value = f), onKeydown: [k[1] || (k[1] = withKeys(withModifiers(() => {
  }, ["prevent"]), ["up"])), M] }, m.$attrs), null, 16)), [[vModelDynamic, s.value]]) : withDirectives((openBlock(), createElementBlock("input", mergeProps({ key: 2, autocomplete: "off", class: "u-input-number", onChange: h, "onUpdate:modelValue": k[2] || (k[2] = (f) => s.value = f) }, m.$attrs), null, 16)), [[vModelDynamic, s.value]])]), createBaseVNode("div", x2, [createBaseVNode("span", { class: normalizeClass(["u-up-arrow", { disabled: (m.value || 0) >= m.max }]), onClick: y }, M2, 2), createBaseVNode("span", { class: normalizeClass(["u-down-arrow", { disabled: (m.value || 0) <= m.min }]), onClick: i }, z2, 2)])], 4));
} });
...
var Ye = V(defineComponent({ __name: "Message", props: { duration: { default: 3e3 }, top: { default: 30 } }, emits: ["close"], setup(l, { expose: a, emit: e }) {
  const o = l, n = ref(), c = ref([]), d = ref([]), s = ref([]), p = computed(() => typeof o.top == "number" ? o.top + "px" : o.top), u = computed(() => c.value.every((y) => !y));
  function h() {
    Ce(n.value);
  ...
  function M(y) {
    d.value[y] = me(() => {
      c.value[y] = false, x("close");
    }, o.duration);
  }
  return (y, i) => (openBlock(), createElementBlock("div", { class: "m-message-wrap", style: normalizeStyle(`top: ${p.value};`) }, [createVNode(TransitionGroup, { name: "slide-fade" }, { default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(s.value, (b, m) => withDirectives((openBlock(), createElementBlock("div", { class: "m-message", key: m }, [createBaseVNode("div", { class: "m-message-content", onMouseenter: (k) => function(f) {
    Ce(d.value[f]);
  }(m), onMouseleave: (k) => function(f) {
    M(f);
  }(m) }, [b.mode === "info" ? (openBlock(), createElementBlock("svg", { key: 0, class: "u-svg", style: normalizeStyle({ fill: Ee[b.mode] }), viewBox: "64 64 896 896", "data-icon": "info-circle", "aria-hidden": "true", focusable: "false" }, $2, 4)) : createCommentVNode("", true), b.mode === "success" ? (openBlock(), createElementBlock("svg", { key: 1, class: "u-svg", style: normalizeStyle({ fill: Ee[b.mode] }), viewBox: "64 64 896 896", "data-icon": "check-circle", "aria-hidden": "true", focusable: "false" }, B2, 4)) : createCommentVNode("", true), b.mode === "error" ? (openBlock(), createElementBlock("svg", { key: 2, class: "u-svg", style: normalizeStyle({ fill: Ee[b.mode] }), viewBox: "64 64 896 896", "data-icon": "close-circle", "aria-hidden": "true", focusable: "false" }, F2, 4)) : createCommentVNode("", true), b.mode === "warning" ? (openBlock(), createElementBlock("svg", { key: 3, class: "u-svg", style: normalizeStyle({ fill: Ee[b.mode] }), viewBox: "64 64 896 896", "data-icon": "exclamation-circle", "aria-hidden": "true", focusable: "false" }, S2, 4)) : createCommentVNode("", true), b.mode === "loading" ? (openBlock(), createElementBlock("svg", { key: 4, class: "u-svg circular", style: normalizeStyle({ stroke: Ee[b.mode] }), viewBox: "0 0 50 50", focusable: "false" }, L2, 4)) : createCommentVNode("", true), createBaseVNode("p", A2, toDisplayString(b.content), 1)], 40, C2)])), [[vShow, c.value[m]]])), 128))]), _: 1 })], 4));
...
var za = V(defineComponent({ __name: "Notification", props: { message: { default: "温馨提示" }, duration: { default: 4500 }, top: { default: 24 }, bottom: { default: 24 }, placement: { default: "topRight" } }, emits: ["close"], setup(l, { expose: a, emit: e }) {
  const o = l, n = ref(), c = ref([]), d = ref([]), s = ref([]), p = ref(o.placement), u = ref(), h = computed(() => c.value.length === s.value.length);
  function x() {
    ...
    }), s.value[i].placement && (p.value = s.value[i].placement), o.duration && (d.value[i] = me(() => {
      y(i);
    }, o.duration));
  }
  watch(h, (i, b) => {
  ...
  return (i, b) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-notification-wrapper", p.value]), style: normalizeStyle(`top: ${["topRight", "topLeft"].includes(p.value) ? i.top : "auto"}px; bottom: ${["bottomRight", "bottomLeft"].includes(p.value) ? i.bottom : ""}px;`) }, [createVNode(TransitionGroup, { name: ["topRight", "bottomRight"].includes(p.value) ? "right" : "left" }, { default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(s.value, (m, k) => withDirectives((openBlock(), createElementBlock("div", { ref_for: true, ref_key: "notification", ref: u, class: "m-notification", onMouseenter: (f) => function(g) {
    Ce(d.value[g]), d.value[g] = null;
  }(k), onMouseleave: (f) => function(g) {
    o.duration && (d.value[g] = me(() => {
      y(g);
    }, o.duration));
  }(k), key: k }, [createBaseVNode("div", J2, [m.mode === "info" ? (openBlock(), createElementBlock("svg", { key: 0, class: "u-svg", style: normalizeStyle(`fill: ${Oe[m.mode]}`), viewBox: "64 64 896 896", "data-icon": "info-circle", "aria-hidden": "true", focusable: "false" }, X2, 4)) : createCommentVNode("", true), m.mode === "success" ? (openBlock(), createElementBlock("svg", { key: 1, class: "u-svg", style: normalizeStyle(`fill: ${Oe[m.mode]}`), viewBox: "64 64 896 896", "data-icon": "check-circle", "aria-hidden": "true", focusable: "false" }, Q2, 4)) : createCommentVNode("", true), m.mode === "warning" ? (openBlock(), createElementBlock("svg", { key: 2, class: "u-svg", style: normalizeStyle(`fill: ${Oe[m.mode]}`), viewBox: "64 64 896 896", "data-icon": "exclamation-circle", "aria-hidden": "true", focusable: "false" }, e0, 4)) : createCommentVNode("", true), m.mode === "error" ? (openBlock(), createElementBlock("svg", { key: 3, class: "u-svg", style: normalizeStyle(`fill: ${Oe[m.mode]}`), viewBox: "64 64 896 896", "data-icon": "close-circle", "aria-hidden": "true", focusable: "false" }, a0, 4)) : createCommentVNode("", true), createBaseVNode("div", { class: normalizeClass(["u-title", { mb4: m.mode !== "open", ml36: m.mode !== "open" }]) }, toDisplayString(m.message || i.message), 3), createBaseVNode("p", { class: normalizeClass(["u-description", { ml36: m.mode !== "open" }]) }, toDisplayString(m.description || "--"), 3), (openBlock(), createElementBlock("svg", { class: "u-close", onClick: (f) => y(k), viewBox: "64 64 896 896", "data-icon": "close", "aria-hidden": "true", focusable: "false" }, t0, 8, l0))])], 40, G2)), [[vShow, !c.value.includes(k)]])), 128))]), _: 1 }, 8, ["name"])], 6));
...
var _a = defineComponent({ __name: "NumberAnimation", props: { from: { default: 0 }, to: { default: 1e3 }, duration: { default: 3e3 }, autoplay: { type: Boolean, default: true }, precision: { default: 0 }, prefix: { default: "" }, suffix: { default: "" }, separator: { default: "," }, decimal: { default: "." }, valueStyle: { default: () => ({}) }, transition: { default: "easeInOutCubic" } }, emits: ["started", "finished"], setup(l, { expose: a, emit: e }) {
  ...
  const c = useTransition(n, { duration: o.duration, transition: TransitionPresets[o.transition], onFinished: () => p("finished"), onStarted: () => p("started") });
  function d() {
    n.value = o.to;
  }
  const s = computed(() => function(u) {
    const { precision: h, decimal: x, separator: M, suffix: y, prefix: i } = o;
    if (u === 0)
      return u.toFixed(h);
    if (!u)
      return "";
...
var Ue = V(defineComponent({ __name: "Pagination", props: { current: { default: 1 }, pageSize: { default: 10 }, total: { default: 0 }, pageListNum: { default: 5 }, hideOnSinglePage: { type: Boolean, default: false }, showQuickJumper: { type: Boolean, default: false }, showTotal: { type: Boolean, default: false }, placement: { default: "center" } }, emits: ["change"], setup(l, { emit: a }) {
  const e = l, o = ref(e.current), n = ref(""), c = ref(false), d = ref(false), s = ref(false), p = ref(false), u = computed(() => Math.ceil(e.total / e.pageSize)), h = computed(() => function(b) {
    var m = [], k = Math.floor(e.pageListNum / 2), f = { start: b - k, end: b + k };
  ...
  return watch(o, (b) => {
    ...
    document.onkeydown = (b) => {
      b && b.key === "Enter" && function() {
        ...
        Number.isInteger(m) && (m < 1 && (m = 1), m > u.value && (m = u.value), i(m)), n.value = "";
      }();
    };
  }), onUnmounted(() => {
    document.onkeydown = null;
  }), (b, m) => (openBlock(), createElementBlock("div", { class: normalizeClass([`m-pagination ${b.placement}`, { hidden: b.hideOnSinglePage && b.total <= b.pageSize }]) }, [createBaseVNode("div", o0, [b.showTotal ? (openBlock(), createElementBlock("span", s0, "共 " + toDisplayString(u.value) + " 页 / " + toDisplayString(b.total) + " 条", 1)) : createCommentVNode("", true), createBaseVNode("span", { class: normalizeClass(["u-item", { disabled: o.value === 1 }]), onClick: m[0] || (m[0] = (k) => i(o.value - 1)) }, n0, 2), createBaseVNode("span", { class: normalizeClass(["u-item", { active: o.value === 1 }]), onClick: m[1] || (m[1] = (k) => i(1)) }, "1", 2), withDirectives(createBaseVNode("span", { class: "m-arrow", ref: "forward", onClick: M, onMouseenter: m[2] || (m[2] = (k) => s.value = true), onMouseleave: m[3] || (m[3] = (k) => s.value = false) }, i0, 544), [[vShow, c.value && h.value[0] - 1 > 1]]), (openBlock(true), createElementBlock(Fragment, null, renderList(h.value, (k, f) => (openBlock(), createElementBlock("span", { class: normalizeClass(["u-item", { active: o.value === k }]), key: f, onClick: (g) => i(k) }, toDisplayString(k), 11, u0))), 128)), withDirectives(createBaseVNode("span", { class: "m-arrow", ref: "backward", onClick: y, onMouseenter: m[4] || (m[4] = (k) => p.value = true), onMouseleave: m[5] || (m[5] = (k) => p.value = false) }, c0, 544), [[vShow, d.value && h.value[h.value.length - 1] + 1 < u.value]]), withDirectives(createBaseVNode("span", { class: normalizeClass(["u-item", { active: o.value === u.value }]), onClick: m[6] || (m[6] = (k) => i(u.value)) }, toDisplayString(u.value), 3), [[vShow, u.value !== 1]]), createBaseVNode("span", { class: normalizeClass(["u-item", { disabled: o.value === u.value }]), onClick: m[7] || (m[7] = (k) => i(o.value + 1)) }, d0, 2), b.showQuickJumper ? (openBlock(), createElementBlock("span", r0, [createTextVNode("跳至"), withDirectives(createBaseVNode("input", { type: "text", "onUpdate:modelValue": m[8] || (m[8] = (k) => n.value = k) }, null, 512), [[vModelText, n.value]]), createTextVNode("页")])) : createCommentVNode("", true)])], 2));
...
var Ca = V(defineComponent({ __name: "Popconfirm", props: { title: { default: "" }, description: { default: "" }, content: { default: "" }, icon: { default: "" }, iconType: { default: "warning" }, maxWidth: { default: "auto" }, cancelText: { default: "取消" }, cancelType: { default: "default" }, okText: { default: "确定" }, okType: { default: "primary" }, showCancel: { type: Boolean, default: true } }, emits: ["cancel", "ok", "openChange"], setup(l, { emit: a }) {
  const e = l, o = computed(() => typeof e.maxWidth == "number" ? e.maxWidth + "px" : e.maxWidth), n = useSlots(), c = computed(() => {
    var g;
  ...
  function b() {
    d.value = !d.value, d.value && function() {
      const f = u.value.offsetWidth, g = h.value.offsetWidth, z = h.value.offsetHeight;
      s.value = z + 4, p.value = (g - f) / 2;
    }(), i("openChange", d.value);
  }
  function m(f) {
    d.value = false, i("openChange", false), i("cancel", f);
  }
  function k(f) {
    d.value = false, i("openChange", false), i("ok", f);
  }
  return (f, g) => {
    const z = resolveComponent("Button");
    return openBlock(), createElementBlock("div", v0, [createBaseVNode("div", { ref_key: "popRef", ref: h, tabindex: "1", class: normalizeClass(["m-pop-content", { "show-pop": d.value }]), style: normalizeStyle(`max-width: ${o.value}; top: ${-s.value}px; left: ${-p.value}px;`), onBlur: g[0] || (g[0] = ($) => x.value ? (d.value = false, void i("openChange", false)) : () => false) }, [createBaseVNode("div", p0, [createBaseVNode("div", f0, [createBaseVNode("span", h0, [renderSlot(f.$slots, "icon", {}, () => [f.iconType === "info" ? (openBlock(), createElementBlock("svg", m0, g0)) : createCommentVNode("", true), f.iconType === "success" ? (openBlock(), createElementBlock("svg", y0, b0)) : createCommentVNode("", true), f.iconType === "error" ? (openBlock(), createElementBlock("svg", k0, w0)) : createCommentVNode("", true), f.iconType === "warning" ? (openBlock(), createElementBlock("svg", x0, M0)) : createCommentVNode("", true)], true)]), createBaseVNode("div", { class: normalizeClass(["m-title", { "font-weight": c.value }]) }, [renderSlot(f.$slots, "title", {}, () => [createTextVNode(toDisplayString(f.title), 1)], true)], 2)]), c.value ? (openBlock(), createElementBlock("div", z0, [renderSlot(f.$slots, "description", {}, () => [createTextVNode(toDisplayString(f.description), 1)], true)])) : createCommentVNode("", true), createBaseVNode("div", _0, [f.showCancel ? (openBlock(), createBlock(z, { key: 0, onClick: m, size: "small", type: f.cancelType }, { default: withCtx(() => [createTextVNode(toDisplayString(f.cancelText), 1)]), _: 1 }, 8, ["type"])) : createCommentVNode("", true), createVNode(z, { onClick: k, size: "small", type: f.okType }, { default: withCtx(() => [createTextVNode(toDisplayString(f.okText), 1)]), _: 1 }, 8, ["type"])])]), C0], 38), createBaseVNode("div", { ref_key: "contentRef", ref: u, onClick: b, onMouseenter: M, onMouseleave: y }, [renderSlot(f.$slots, "default", {}, () => [createTextVNode(toDisplayString(f.content), 1)], true)], 544)]);
  };
...
var Fa = V(defineComponent({ __name: "Radio", props: { options: { default: () => [] }, disabled: { type: Boolean, default: false }, vertical: { type: Boolean, default: false }, value: { default: null }, gap: { default: 8 }, button: { type: Boolean, default: false }, buttonStyle: { default: "outline" } }, emits: ["update:value", "change"], setup(l, { emit: a }) {
  const e = l, o = computed(() => e.options.length), n = computed(() => e.vertical ? { marginBottom: e.gap + "px" } : { marginRight: e.gap + "px" }), c = a;
  function d(s) {
    s !== e.value && (c("update:value", s), c("change", s));
  }
  return (s, p) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-radio", { "m-radio-button-solid": s.buttonStyle === "solid" }]) }, [s.button ? (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList(s.options, (u, h) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-radio-button-wrap", { "m-radio-button-checked": s.value === u.value, "m-radio-button-disabled": s.disabled || u.disabled }]), key: h, onClick: (x) => s.disabled || u.disabled ? () => false : d(u.value) }, [createBaseVNode("span", W0, [renderSlot(s.$slots, "default", { label: u.label }, () => [createTextVNode(toDisplayString(u.label), 1)], true)])], 10, R0))), 128)) : (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(s.options, (u, h) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-radio-wrap", { vertical: s.vertical }]), style: normalizeStyle(o.value !== h + 1 ? n.value : ""), key: h }, [createBaseVNode("div", { class: normalizeClass(["m-box", { "m-radio-disabled": s.disabled || u.disabled }]), onClick: (x) => s.disabled || u.disabled ? () => false : d(u.value) }, [createBaseVNode("span", { class: normalizeClass(["u-radio", { "u-radio-checked": s.value === u.value }]) }, null, 2), createBaseVNode("span", V0, [renderSlot(s.$slots, "default", { label: u.label }, () => [createTextVNode(toDisplayString(u.label), 1)], true)])], 10, j0)], 6))), 128))], 2));
...
var Aa = V(defineComponent({ __name: "Row", props: { width: { default: "auto" }, gutter: { default: 0 }, wrap: { type: Boolean, default: false }, align: { default: "top" }, justify: { default: "start" } }, setup(l) {
  ...
  }), (p, u) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-row", { "gutter-row": p.gutter }]), style: normalizeStyle(`--xGap: ${o.value / 2}px; --justify: ${p.justify}; --align: ${e[p.align]}; width: ${c.value}; margin-left: -${o.value / 2}px; margin-right: -${o.value / 2}px; row-gap: ${n.value}px;`) }, [renderSlot(p.$slots, "default", {}, void 0, true)], 6));
...
var Da = V(defineComponent({ __name: "Slider", props: { width: { default: "100%" }, min: { default: 0 }, max: { default: 100 }, disabled: { type: Boolean, default: false }, range: { type: Boolean, default: false }, step: { default: 1 }, tipFormatter: { type: Function, default: (l) => l }, hideTip: { type: Boolean, default: false }, value: { default: 0 } }, emits: ["update:value", "change"], setup(l, { emit: a }) {
  const e = l, o = ref(false), n = ref(), c = ref(0), d = ref(0), s = ref(), p = ref(), u = ref(), h = ref(), x = computed(() => k(p.value / (e.max - e.min) * e.step)), M = computed(() => typeof e.width == "number" ? e.width + "px" : e.width), y = computed(() => {
    const S = Math.round(d.value / x.value * e.step + e.min);
    return e.range ? [Math.round(c.value / x.value * e.step + e.min), S] : S;
  }), i = computed(() => e.range ? e.tipFormatter(y.value[0]) : null), b = computed(() => e.range ? e.tipFormatter(y.value[1]) : e.tipFormatter(y.value)), m = a;
  function k(S) {
  ...
  function z() {
    ...
    document.onmousemove = (H) => {
      const E = k(Math.round((H.clientX - S) / x.value) * x.value);
      E > p.value ? d.value = p.value : c.value <= E && E <= p.value ? d.value = E : (d.value = c.value, u.value.focus(), g());
    }, document.onmouseup = () => {
      document.onmousemove = null;
    };
  }
  ...
  }(E), ["self"])) }), createBaseVNode("div", { class: normalizeClass(["u-slider-track", { trackTransition: o.value }]), style: normalizeStyle(`left: ${c.value}px; right: auto; width: ${d.value - c.value}px;`) }, null, 6), S.range ? (openBlock(), createElementBlock("div", { key: 0, tabindex: "0", ref_key: "leftHandle", ref: u, class: normalizeClass(["u-slider-handle", { handleTransition: o.value }]), style: normalizeStyle(`left: ${c.value}px; right: auto; transform: translate(-50%, -50%);`), onKeydown: [H[1] || (H[1] = withKeys(withModifiers((E) => S.disabled ? () => false : $(c.value, "left"), ["prevent"]), ["left"])), H[2] || (H[2] = withKeys(withModifiers((E) => S.disabled ? () => false : I(c.value, "left"), ["prevent"]), ["right"])), H[3] || (H[3] = withKeys(withModifiers((E) => S.disabled ? () => false : $(c.value, "left"), ["prevent"]), ["down"])), H[4] || (H[4] = withKeys(withModifiers((E) => S.disabled ? () => false : I(c.value, "left"), ["prevent"]), ["up"]))], onMousedown: H[5] || (H[5] = (E) => S.disabled ? () => false : g()) }, [S.hideTip ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", b4, [createTextVNode(toDisplayString(i.value) + " ", 1), k4]))], 38)) : createCommentVNode("", true), createBaseVNode("div", { tabindex: "0", ref_key: "rightHandle", ref: h, class: normalizeClass(["u-slider-handle", { handleTransition: o.value }]), style: normalizeStyle(`left: ${d.value}px; right: auto; transform: translate(-50%, -50%);`), onKeydown: [H[6] || (H[6] = withKeys(withModifiers((E) => S.disabled ? () => false : $(d.value, "right"), ["prevent"]), ["left"])), H[7] || (H[7] = withKeys(withModifiers((E) => S.disabled ? () => false : I(d.value, "right"), ["prevent"]), ["right"])), H[8] || (H[8] = withKeys(withModifiers((E) => S.disabled ? () => false : $(d.value, "right"), ["prevent"]), ["down"])), H[9] || (H[9] = withKeys(withModifiers((E) => S.disabled ? () => false : I(d.value, "right"), ["prevent"]), ["up"]))], onMousedown: H[10] || (H[10] = (E) => S.disabled ? () => false : z()) }, [S.hideTip ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", w4, [createTextVNode(toDisplayString(b.value) + " ", 1), x4]))], 38)], 6));
...
var Ha = V(defineComponent({ __name: "Steps", props: { steps: { default: () => [] }, current: { default: 1 }, width: { default: "100%" }, descMaxWidth: { default: 120 } }, emits: ["update:current", "change"], setup(l, { emit: a }) {
  const e = l, o = computed(() => typeof e.width == "number" ? e.width + "px" : e.width), n = computed(() => e.steps.length), c = computed(() => e.current < 1 ? 1 : e.current > n.value + 1 ? n.value + 1 : e.current), d = a;
...
var Ia = V(defineComponent({ __name: "Swiper", props: { images: { default: () => [] }, width: { default: "100%" }, height: { default: "100vh" }, type: { default: "banner" }, navigation: { type: Boolean, default: true }, delay: { default: 3e3 }, swipe: { type: Boolean, default: true }, preloaderColor: { default: "theme" } }, emits: ["swiper", "change"], setup(l, { emit: a }) {
  ...
  return (M, y) => (openBlock(), createElementBlock(Fragment, null, [M.type === "banner" ? (openBlock(), createBlock(unref(Swiper), mergeProps({ key: 0, class: { "swiper-no-swiping": !M.swipe }, modules: c.value, navigation: M.navigation, "slides-per-view": 1, autoplay: d.value, lazy: "", loop: "", onSwiper: x, onSlideChange: y[0] || (y[0] = (i) => M.$emit("change")) }, M.$attrs), { default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(M.images, (i, b) => (openBlock(), createBlock(unref(SwiperSlide), { key: b }, { default: withCtx(() => [createBaseVNode("a", { href: i.link ? i.link : "javascript:;", target: i.link ? "_blank" : "_self", class: "m-link" }, [createBaseVNode("img", { src: i.src, class: "u-img", style: normalizeStyle(`width: ${o.value}; height: ${n.value};`), alt: i.title, loading: "lazy" }, null, 12, T4)], 8, I4), createBaseVNode("div", { class: normalizeClass(`swiper-lazy-preloader swiper-lazy-preloader-${M.preloaderColor}`) }, null, 2)]), _: 2 }, 1024))), 128))]), _: 1 }, 16, ["class", "modules", "navigation", "autoplay"])) : createCommentVNode("", true), M.type === "carousel" ? (openBlock(), createBlock(unref(Swiper), mergeProps({ key: 1, class: "swiper-no-swiping", modules: s.value, autoplay: p.value, lazy: "", loop: "", onSwiper: x, onSlideChange: y[1] || (y[1] = (i) => M.$emit("change")) }, M.$attrs), { default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(M.images, (i, b) => (openBlock(), createBlock(unref(SwiperSlide), { key: b }, { default: withCtx(() => [createBaseVNode("a", { href: i.link ? i.link : "javascript:;", target: i.link ? "_blank" : "_self", class: "m-link" }, [createBaseVNode("img", { src: i.src, class: "u-img", style: normalizeStyle(`width: ${o.value}; height: ${n.value};`), alt: i.title, loading: "lazy" }, null, 12, V4)], 8, j4), createBaseVNode("div", { class: normalizeClass(`swiper-lazy-preloader swiper-lazy-preloader-${M.preloaderColor}`) }, null, 2)]), _: 2 }, 1024))), 128))]), _: 1 }, 16, ["modules", "autoplay"])) : createCommentVNode("", true), M.type === "broadcast" ? (openBlock(), createBlock(unref(Swiper), mergeProps({ key: 2, modules: u.value, navigation: M.navigation, lazy: "", onSwiper: x, onSlideChange: y[2] || (y[2] = (i) => M.$emit("change")) }, M.$attrs), { default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(M.images, (i, b) => (openBlock(), createBlock(unref(SwiperSlide), { key: b }, { default: withCtx(() => [createBaseVNode("a", { href: i.link ? i.link : "javascript:;", target: i.link ? "_blank" : "_self", class: "m-link" }, [createBaseVNode("img", { src: i.src, class: "u-img", style: normalizeStyle(`width: ${o.value}; height: ${n.value};`), alt: i.title, loading: "lazy" }, null, 12, W4)], 8, R4), createBaseVNode("div", { class: normalizeClass(`swiper-lazy-preloader swiper-lazy-preloader-${M.preloaderColor}`) }, null, 2)]), _: 2 }, 1024))), 128))]), _: 1 }, 16, ["modules", "navigation"])) : createCommentVNode("", true)], 64));
...
var Ta = V(defineComponent({ __name: "Switch", props: { onInfo: { default: "" }, offInfo: { default: "" }, disabled: { type: Boolean, default: false }, checked: { type: Boolean, default: false }, nodeStyle: { default: () => ({}) } }, emits: ["update:checked", "change"], setup(l, { emit: a }) {
  const e = l, o = a;
  return (n, c) => (openBlock(), createElementBlock("div", N4, [createBaseVNode("div", { onClick: c[0] || (c[0] = (d) => n.disabled ? () => false : (o("update:checked", !e.checked), void o("change", !e.checked))), class: normalizeClass(["m-switch", { "switch-checked": n.checked, disabled: n.disabled }]) }, [createBaseVNode("div", { class: normalizeClass(["u-switch-inner", n.checked ? "inner-checked" : "inner-unchecked"]) }, toDisplayString(n.checked ? n.onInfo : n.offInfo), 3), createBaseVNode("div", { class: normalizeClass(["u-node", { "node-checked": n.checked }]), style: normalizeStyle(n.nodeStyle) }, [renderSlot(n.$slots, "node", {}, void 0, true)], 6)], 2)]));
...
var ja = V(defineComponent({ __name: "Table", props: { columns: { default: () => [] }, dataSource: { default: () => [] }, pagination: { default: () => ({ page: 1, pageSize: 10 }) }, showPagination: { type: Boolean, default: true }, hideOnSinglePage: { type: Boolean, default: false }, total: { default: 0 }, loading: { type: Boolean, default: false } }, emits: ["change"], setup(l, { emit: a }) {
  ...
  return (n, c) => (openBlock(), createElementBlock("div", O4, [createBaseVNode("table", q4, [createBaseVNode("thead", null, [createBaseVNode("tr", P4, [(openBlock(true), createElementBlock(Fragment, null, renderList(n.columns, (d, s) => (openBlock(), createElementBlock("th", { class: "m-th", style: normalizeStyle(`width: ${typeof d.width == "number" ? d.width + "px" : d.width};`), key: s }, toDisplayString(d.title), 5))), 128))])]), createBaseVNode("tbody", Y4, [withDirectives(createBaseVNode("tr", U4, [createVNode(unref(ue), { class: "m-loading", size: "small", colspan: n.columns.length }, null, 8, ["colspan"])], 512), [[vShow, n.loading]]), withDirectives(createBaseVNode("tr", K4, [createBaseVNode("td", { class: "m-td-empty", colspan: n.columns.length }, [createVNode(unref(He), { class: "empty", image: "2" })], 8, Z4)], 512), [[vShow, !n.total]]), (openBlock(true), createElementBlock(Fragment, null, renderList(n.dataSource, (d, s) => (openBlock(), createElementBlock("tr", { class: "m-tr", key: s }, [(openBlock(true), createElementBlock(Fragment, null, renderList(n.columns, (p, u) => (openBlock(), createElementBlock("td", { class: "m-td", key: u, title: d[p.dataIndex] }, [p.slot ? renderSlot(n.$slots, p.slot, mergeProps({ key: 0 }, d, { index: s }), () => [createTextVNode(toDisplayString(d[p.dataIndex] || "--"), 1)], true) : (openBlock(), createElementBlock("span", J4, toDisplayString(d[p.dataIndex] || "--"), 1))], 8, G4))), 128))]))), 128))])]), n.showPagination && n.total ? (openBlock(), createBlock(unref(Ue), { key: 0, class: "mt20", onChange: o, current: n.pagination.page, pageSize: n.pagination.pageSize, total: n.total, hideOnSinglePage: n.hideOnSinglePage, showQuickJumper: true, showTotal: true, placement: "right" }, null, 8, ["current", "pageSize", "total", "hideOnSinglePage"])) : createCommentVNode("", true)]));
...
var eo = ["onClick"];
var ao = { class: "m-tabs-page" };
var Va = V(defineComponent({ __name: "Tabs", props: { tabPages: { default: () => [] }, centered: { type: Boolean, default: false }, size: { default: "middle" }, type: { default: "line" }, gutter: { default: void 0 }, activeKey: { default: "" } }, emits: ["update:activeKey", "change"], setup(l, { emit: a }) {
  const e = l, o = ref(), n = ref(0), c = ref(0), d = ref(), s = ref(), p = ref(), u = ref(), h = ref(false), x = ref(0), M = ref(0);
  ...
  const y = a;
  function i() {
    const m = e.tabPages.findIndex((f) => f.key === e.activeKey), k = o.value[m];
    k ? (n.value = k.offsetLeft, c.value = k.offsetWidth, n.value < M.value && (M.value = n.value), n.value + c.value - s.value > M.value && (M.value = n.value + c.value - s.value)) : (n.value = 0, c.value = 0);
  }
  function b() {
    s.value = d.value.offsetWidth, u.value = p.value.offsetWidth, u.value > s.value && (h.value = true, x.value = u.value - s.value), i();
  }
  return (m, k) => (openBlock(), createElementBlock("div", X4, [createBaseVNode("div", Q4, [createBaseVNode("div", { ref_key: "wrap", ref: d, class: normalizeClass(["m-tabs-nav-wrap", { "tabs-center": m.centered, "before-shadow-active": M.value > 0, "after-shadow-active": M.value < x.value }]) }, [createBaseVNode("div", { ref_key: "nav", ref: p, class: "m-tabs-nav-list", onWheel: k[0] || (k[0] = (f) => h.value ? function(g) {
    if (g.deltaX !== 0) {
      g.preventDefault();
      const z = 1 * g.deltaX;
      M.value + z > x.value ? M.value = x.value : M.value + z < 0 ? M.value = 0 : M.value += z;
    }
  }(f) : () => false), style: normalizeStyle(`transform: translate(${-M.value}px, 0)`) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(m.tabPages, (f, g) => (openBlock(), createElementBlock("div", { ref_for: true, ref_key: "tabs", ref: o, class: normalizeClass(["u-tab", [`u-tab-${m.size}`, { "u-tab-card": m.type === "card", "u-tab-disabled": f.disabled }, { "u-tab-line-active": m.activeKey === f.key && m.type === "line" }, { "u-tab-card-active": m.activeKey === f.key && m.type === "card" }]]), style: normalizeStyle(`margin-left: ${g !== 0 ? m.gutter : null}px;`), onClick: (z) => {
    return f.disabled ? () => false : ($ = f.key, y("update:activeKey", $), void y("change", $));
    var $;
  }, key: f.key }, toDisplayString(f.tab), 15, eo))), 128)), createBaseVNode("div", { class: normalizeClass(["u-tab-bar", { "u-card-hidden": m.type === "card" }]), style: normalizeStyle(`left: ${n.value}px; width: ${c.value}px;`) }, null, 6)], 36)], 2)]), createBaseVNode("div", ao, [(openBlock(true), createElementBlock(Fragment, null, renderList(m.tabPages, (f) => withDirectives((openBlock(), createElementBlock("div", { class: "m-tabs-content", key: f.key }, [renderSlot(m.$slots, f.key, {}, () => [createTextVNode(toDisplayString(f.content), 1)], true)])), [[vShow, m.activeKey === f.key]])), 128))])]));
} }), [["__scopeId", "data-v-05c20507"]]);
Va.install = (l) => {
  l.component(Va.__name, Va);
};
var t1 = (l) => (pushScopeId("data-v-a9350280"), l = l(), popScopeId(), l);
var lo = { key: 0, class: "m-icon" };
var to = { class: "u-tag" };
var oo = [t1(() => createBaseVNode("svg", { focusable: "false", class: "u-close", "data-icon": "close", width: "1em", height: "1em", fill: "currentColor", "aria-hidden": "true", viewBox: "64 64 896 896" }, [createBaseVNode("path", { d: "M563.8 512l262.5-312.9c4.4-5.2.7-13.1-6.1-13.1h-79.8c-4.7 0-9.2 2.1-12.3 5.7L511.6 449.8 295.1 191.7c-3-3.6-7.5-5.7-12.3-5.7H203c-6.8 0-10.5 7.9-6.1 13.1L459.4 512 196.9 824.9A7.95 7.95 0 00203 838h79.8c4.7 0 9.2-2.1 12.3-5.7l216.5-258.1 216.5 258.1c3 3.6 7.5 5.7 12.3 5.7h79.8c6.8 0 10.5-7.9 6.1-13.1L563.8 512z" })], -1))];
var so = { class: "u-tag" };
var no = ["onClick"];
var io = [t1(() => createBaseVNode("svg", { focusable: "false", class: "u-close", "data-icon": "close", width: "1em", height: "1em", fill: "currentColor", "aria-hidden": "true", viewBox: "64 64 896 896" }, [createBaseVNode("path", { d: "M563.8 512l262.5-312.9c4.4-5.2.7-13.1-6.1-13.1h-79.8c-4.7 0-9.2 2.1-12.3 5.7L511.6 449.8 295.1 191.7c-3-3.6-7.5-5.7-12.3-5.7H203c-6.8 0-10.5 7.9-6.1 13.1L459.4 512 196.9 824.9A7.95 7.95 0 00203 838h79.8c4.7 0 9.2-2.1 12.3-5.7l216.5-258.1 216.5 258.1c3 3.6 7.5 5.7 12.3 5.7h79.8c6.8 0 10.5-7.9 6.1-13.1L563.8 512z" })], -1))];
var uo = [t1(() => createBaseVNode("svg", { focusable: "false", class: "u-plus", "data-icon": "plus", width: "1em", height: "1em", fill: "currentColor", "aria-hidden": "true", viewBox: "64 64 896 896" }, [createBaseVNode("path", { d: "M482 152h60q8 0 8 8v704q0 8-8 8h-60q-8 0-8-8V160q0-8 8-8z" }), createBaseVNode("path", { d: "M176 474h672q8 0 8 8v60q0 8-8 8H176q-8 0-8-8v-60q0-8 8-8z" })], -1))];
var Ra = V(defineComponent({ __name: "Tag", props: { closable: { type: Boolean, default: false }, color: { default: "" }, icon: { default: "" }, size: { default: "middle" }, bordered: { type: Boolean, default: true }, dynamic: { type: Boolean, default: false }, value: { default: () => [] }, spaceWidth: { default: "auto" }, spaceAlign: { default: "start" }, spaceDirection: { default: "horizontal" }, spaceSize: { default: "small" } }, emits: ["update:value", "close", "dynamicClose"], setup(l, { emit: a }) {
  const e = l, o = computed(() => {
    ...
    return null;
  }), n = computed(() => e.dynamic && e.value.length ? o.value ? e.value.map((g) => ({ label: g, closable: true })) : e.value.map((g) => ({ closable: true, ...g })) : []), c = useSlots(), d = computed(() => {
    var g;
    if (!e.dynamic) {
    ...
    return false;
  }), s = ref(), p = ref(false), u = ref(""), h = ["success", "processing", "error", "warning", "default", "pink", "red", "yellow", "orange", "cyan", "green", "blue", "purple", "geekblue", "magenta", "volcano", "gold", "lime"], x = ref(false), M = ref(), y = ref(Array(e.value.length).fill(1));
  watchEffect(() => {
    if (e.dynamic) {
  ...
  function k() {
    o.value ? i("update:value", [...e.value, u.value]) : i("update:value", [...e.value, { label: u.value }]), p.value = false, s.value = "";
  }
  function f(g) {
    g.key === "Enter" && s.value.blur();
  }
  return (g, z) => g.dynamic ? (openBlock(), createBlock(unref(Le), { key: 1, width: g.spaceWidth, align: g.spaceAlign, direction: g.spaceDirection, size: g.spaceSize }, { default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(n.value, ($, I) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-tag", [`tag-${$.size || g.size}`, ($.color || g.color) && h.includes($.color || g.color) ? "tag-" + ($.color || g.color) : "", { "tag-borderless": $.bordered !== void 0 && !$.bordered, "has-color": ($.color || g.color) && !h.includes($.color || g.color) }]]), style: normalizeStyle(`background-color: ${!$.color && !g.color || h.includes($.color || g.color) ? "" : $.color || g.color};`), key: I }, [withDirectives(createBaseVNode("span", { class: "m-icon", ref_for: true, ref_key: "tagsIconRef", ref: M }, [renderSlot(g.$slots, "icon", { index: I }, () => [createTextVNode(toDisplayString($.icon), 1)], true)], 512), [[vShow, y.value[I]]]), createBaseVNode("span", so, [renderSlot(g.$slots, "default", { label: $.label, index: I }, () => [createTextVNode(toDisplayString($.label), 1)], true)]), $.closable || g.closable ? (openBlock(), createElementBlock("span", { key: 0, class: "m-close", onClick: (S) => function(H, E) {
    const K = e.value.filter((ee, de) => de !== E);
    i("update:value", K), i("dynamicClose", H, E);
  }($, I) }, io, 8, no)) : createCommentVNode("", true)], 6))), 128)), p.value ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", { key: 0, class: normalizeClass(["m-tag", [`tag-${g.size}`, { "m-plus": g.dynamic }]]), onClick: m }, uo, 2)), withDirectives(createBaseVNode("input", { ref_key: "inputRef", ref: s, class: normalizeClass(["u-input", `input-${g.size}`]), type: "text", "onUpdate:modelValue": z[0] || (z[0] = ($) => u.value = $), onBlur: z[1] || (z[1] = ($) => p.value = false), onChange: k, onKeydown: f }, null, 34), [[vShow, p.value], [vModelText, u.value]])]), _: 3 }, 8, ["width", "align", "direction", "size"])) : (openBlock(), createElementBlock("div", { key: 0, class: normalizeClass(["m-tag", [`tag-${g.size}`, g.color && h.includes(g.color) ? "tag-" + g.color : "", { "tag-borderless": !g.bordered, "has-color": g.color && !h.includes(g.color), hidden: x.value }]]), style: normalizeStyle(`background-color: ${g.color && !h.includes(g.color) ? g.color : ""};`) }, [d.value ? (openBlock(), createElementBlock("span", lo, [renderSlot(g.$slots, "icon", {}, () => [createTextVNode(toDisplayString(g.icon), 1)], true)])) : createCommentVNode("", true), createBaseVNode("span", to, [renderSlot(g.$slots, "default", {}, void 0, true)]), g.closable ? (openBlock(), createElementBlock("span", { key: 1, class: "m-close", onClick: b }, oo)) : createCommentVNode("", true)], 6));
...
var Wa = V(defineComponent({ inheritAttrs: false, __name: "Textarea", props: { width: { default: "100%" }, allowClear: { type: Boolean, default: false }, autoSize: { type: [Boolean, Object], default: false }, disabled: { type: Boolean, default: false }, maxlength: { default: void 0 }, showCount: { type: Boolean, default: false }, value: { default: "" }, valueModifiers: { default: () => ({}) } }, emits: ["update:value", "change", "enter"], setup(l, { emit: a }) {
  ...
  return (i, b) => (openBlock(), createElementBlock("div", { class: normalizeClass(["m-textarea", { "show-count": i.showCount }]), style: normalizeStyle(`width: ${o.value};`), "data-count": c.value }, [createBaseVNode("textarea", mergeProps({ ref_key: "textarea", ref: d, type: "hidden", class: ["u-textarea", { disabled: i.disabled }], style: [`height: ${i.autoSize ? s.value : ""}px`, n.value], value: i.value, maxlength: i.maxlength, disabled: i.disabled, onInput: h, onChange: x, onKeydown: M }, i.$attrs), null, 16, ro), !i.disabled && i.allowClear && i.value ? (openBlock(), createElementBlock("span", { key: 0, class: "m-clear", onClick: y }, vo)) : createCommentVNode("", true)], 14, co));
} }), [["__scopeId", "data-v-424cb57c"]]);
Wa.install = (l) => {
  l.component(Wa.__name, Wa);
};
var po = ["title", "href", "target", "onClick"];
var fo = ["title", "href", "target", "onClick"];
var Na = V(defineComponent({ __name: "TextScroll", props: { scrollText: {}, single: { type: Boolean, default: false }, width: { default: "100%" }, height: { default: 60 }, fontSize: { default: 16 }, fontWeight: { default: 400 }, color: { default: "rgba(0, 0, 0, .88)" }, backgroundColor: { default: "#FFF" }, amount: { default: 4 }, gap: { default: 20 }, vertical: { type: Boolean, default: false }, interval: { default: 3e3 } }, emits: ["click"], setup(l, { emit: a }) {
  const e = l, o = ref(0), n = ref(0), c = ref(), d = ref(60), s = computed(() => e.single ? [e.scrollText, e.scrollText] : [...e.scrollText]), p = computed(() => s.value.length), u = computed(() => e.single ? 1 : e.amount), h = computed(() => d.value === 60 ? 1 : 60 / d.value), x = ref(), M = ref(0);
  function y() {
    ...
    n.value = S(function E(K) {
      if (H)
        return d.value = Math.floor(1e3 / (K - H)), console.log("fps", d.value), M.value = parseFloat((x.value.offsetWidth / u.value).toFixed(2)), void m();
      n.value > 10 && (H = K), n.value = S(E);
    });
  }
  function i() {
    o.value >= M.value ? (s.value.push(s.value.shift()), o.value = 0) : o.value += h.value, c.value = pe(i);
  }
  const b = computed(() => typeof e.width == "number" ? e.width + "px" : e.width);
  function m() {
    e.vertical ? p.value > 1 && I() : s.value.length > u.value && (c.value = pe(i));
  }
  function k() {
  ...
  return (S, H) => S.vertical ? (openBlock(), createElementBlock("div", { key: 1, class: "m-slider-vertical", onMouseenter: k, onMouseleave: m, style: normalizeStyle(`height: ${S.height}px; width: ${b.value}; background: ${S.backgroundColor}; --fontSize: ${S.fontSize}px; --fontWeight: ${S.fontWeight}; --color: ${S.color};`) }, [createVNode(TransitionGroup, { name: "slide" }, { default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(s.value, (E, K) => withDirectives((openBlock(), createElementBlock("div", { class: "m-slider", style: normalizeStyle(`width: calc(${b.value} - ${2 * S.gap}px); height: ${S.height}px;`), key: K }, [createBaseVNode("a", { class: "u-slider", title: E.title, href: E.link ? E.link : "javascript:;", target: E.link ? "_blank" : "_self", onClick: (ee) => g(E.title) }, toDisplayString(E.title || "--"), 9, fo)], 4)), [[vShow, z.value === K]])), 128))]), _: 1 })], 36)) : (openBlock(), createElementBlock("div", { key: 0, ref_key: "horizonRef", ref: x, class: "m-slider-horizon", onMouseenter: k, onMouseleave: m, style: normalizeStyle(`height: ${S.height}px; width: ${b.value}; background: ${S.backgroundColor}; --fontSize: ${S.fontSize}px; --fontWeight: ${S.fontWeight}; --color: ${S.color};`) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(s.value, (E, K) => (openBlock(), createElementBlock("a", { style: normalizeStyle(`will-change: transform; transform: translateX(${-o.value}px); width: ${M.value - S.gap}px; margin-left: ${S.gap}px;`), class: "u-slide-title", key: K, title: E.title, href: E.link ? E.link : "javascript:;", target: E.link ? "_blank" : "_self", onClick: (ee) => g(E.title) }, toDisplayString(E.title || "--"), 13, po))), 128))], 36));
} }), [["__scopeId", "data-v-71abcabf"]]);
Na.install = (l) => {
  l.component(Na.__name, Na);
};
var ho = { class: "m-timeline" };
var Oa = V(defineComponent({ __name: "Timeline", props: { timelineData: { default: () => [] }, width: { default: "100%" }, lineStyle: { default: "solid" }, mode: { default: "left" }, position: { default: "left" } }, setup(l) {
  const a = l, e = ref(), o = ref([]), n = computed(() => typeof a.width == "number" ? a.width + "px" : a.width), c = computed(() => a.timelineData.length);
  return watchEffect(() => {
    (function() {
...
var qa = V(defineComponent({ __name: "Upload", props: { accept: { default: "*" }, multiple: { type: Boolean, default: false }, maxCount: { default: 1 }, tip: { default: "Upload" }, uploadingTip: { default: "Uploading" }, gap: { default: 8 }, fit: { default: "contain" }, errorInfo: { default: "" }, beforeUpload: { type: Function, default: () => true }, uploadMode: { default: "base64" }, customRequest: { type: Function, default: () => {
  ...
  const e = l, o = ref([]), n = ref(1), c = ref(Array(e.maxCount).fill(false)), d = ref();
  function s(y) {
  ...
  const p = a, u = function(y, i) {
    e.beforeUpload(y) ? (e.maxCount > n.value && n.value++, e.uploadMode === "base64" && (c.value[i] = true, function(b, m) {
      ...
      k.readAsDataURL(b), k.onloadstart = function(f) {
        ...
        f.loaded === f.total && (c.value[m] = false);
      }, k.onload = function(f) {
        var g;
    ...
    }(y, i)), e.uploadMode === "custom" && (c.value[i] = true, function(b, m) {
  ...
  return (y, i) => (openBlock(), createElementBlock("div", mo, [createVNode(unref(Le), { size: y.gap }, { default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(n.value, (b) => {
    return openBlock(), createElementBlock("div", { class: "m-upload-item", key: b }, [createBaseVNode("div", go, [withDirectives(createBaseVNode("div", { class: normalizeClass(["m-upload-wrap", { "upload-disabled": y.disabled }]), onDragenter: i[1] || (i[1] = withModifiers(() => {
    }, ["stop", "prevent"])), onDragover: i[2] || (i[2] = withModifiers(() => {
    }, ["stop", "prevent"])), onDrop: withModifiers((k) => y.disabled ? () => false : function(f, g) {
      var $;
      const z = ($ = f.dataTransfer) == null ? void 0 : $.files;
      if (z != null && z.length) {
        const I = z.length;
        for (let S = 0; S < I && g + S <= e.maxCount; S++)
          u(z[S], g + S);
        d.value[g].value = "";
      }
    }(k, b - 1), ["stop", "prevent"]), onClick: (k) => {
      return y.disabled ? () => false : (f = b - 1, void d.value[f].click());
      var f;
    } }, [createBaseVNode("input", { ref_for: true, ref_key: "uploadInput", ref: d, type: "file", onClick: i[0] || (i[0] = withModifiers(() => {
    }, ["stop"])), accept: y.accept, multiple: y.multiple, onChange: (k) => function(f, g) {
      const z = f.target.files;
      if (z != null && z.length) {
        const $ = z.length;
        for (let I = 0; I < $ && g + I < e.maxCount; I++)
          u(z[I], g + I);
        d.value[g].value = "";
      }
    }(k, b - 1), style: { display: "none" } }, null, 40, bo), createBaseVNode("div", null, [ko, createBaseVNode("p", wo, [renderSlot(y.$slots, "default", {}, () => [createTextVNode(toDisplayString(y.tip), 1)], true)])])], 42, yo), [[vShow, !c.value[b - 1] && !o.value[b - 1]]]), withDirectives(createBaseVNode("div", xo, [createVNode(unref(ue), { class: "u-spin", tip: y.uploadingTip, size: "small", indicator: "dynamic-circle" }, null, 8, ["tip"])], 512), [[vShow, c.value[b - 1]]]), o.value[b - 1] ? (openBlock(), createElementBlock("div", Mo, [s(o.value[b - 1].url) ? (openBlock(), createBlock(unref(Pe), { key: 0, ref_for: true, ref_key: "imageRef", ref: h, bordered: false, width: 82, height: 82, src: o.value[b - 1].url, name: o.value[b - 1].name }, null, 8, ["src", "name"])) : (m = o.value[b - 1].url, /\.pdf$/i.test(m) || /^data:application\/pdf/.test(m) ? (openBlock(), createElementBlock("svg", zo, _o)) : (openBlock(), createElementBlock("svg", Co, $o))), createBaseVNode("div", Bo, [createBaseVNode("a", { class: "m-icon", title: "预览", onClick: (k) => function(f, g) {
      if (console.log("isImage", s(g)), s(g)) {
        const z = o.value.slice(0, f).filter(($) => !s($.url));
        h.value[f - z.length].onPreview(0);
      } else
        window.open(g);
    }(b - 1, o.value[b - 1].url) }, So, 8, Fo), withDirectives(createBaseVNode("a", { class: "m-icon", title: "删除", onClick: withModifiers((k) => function(f) {
      o.value.length < e.maxCount && n.value--;
      const g = o.value.splice(f, 1);
      p("remove", g), p("update:fileList", o.value), p("change", o.value);
    }(b - 1), ["prevent", "stop"]) }, Ao, 8, Lo), [[vShow, !y.disabled]])])])) : createCommentVNode("", true)])]);
    var m;
...
var Do = ["src", "poster", "width", "height", "autoplay", "controls", "loop", "muted", "preload"];
...
var Pa = V(defineComponent({ __name: "Video", props: { src: { default: "" }, poster: { default: "" }, second: { default: 0.5 }, width: { default: 800 }, height: { default: 450 }, autoplay: { type: Boolean, default: false }, controls: { type: Boolean, default: true }, loop: { type: Boolean, default: false }, muted: { type: Boolean, default: false }, preload: { default: "metadata" }, showPlay: { type: Boolean, default: true }, fit: { default: "contain" } }, setup(l) {
  ...
  }()), onPause: p[1] || (p[1] = (u) => s.showPlay ? void (n.value = false) : () => false), onPlaying: p[2] || (p[2] = (u) => s.showPlay ? void (n.value = true) : () => false), onClickOnce: withModifiers(d, ["prevent"]) }, s.$attrs), " 您的浏览器不支持video标签。 ", 16, Do), withDirectives(createBaseVNode("span", { class: normalizeClass(["m-icon-play", { hidden: n.value }]) }, Eo, 2), [[vShow, o.value || s.showPlay]])], 6));
...
var Ya = V(defineComponent({ __name: "Waterfall", props: { images: { default: () => [] }, columnCount: { default: 3 }, columnGap: { default: 20 }, width: { default: "100%" }, borderRadius: { default: 8 }, backgroundColor: { default: "#F2F4F8" } }, setup(l) {
  const a = l, e = ref([]), o = ref(Array(a.columnCount).fill(0)), n = shallowRef(), c = ref(), d = computed(() => typeof a.width == "number" ? a.width + "px" : a.width), s = computed(() => Math.max(...o.value) + a.columnGap), p = computed(() => a.images.length), u = ref(Array(p.value)), h = ref(false);
  async function x() {
  ...
  function M(i, b) {
    return new Promise((m) => {
      ...
      k.src = i, k.onload = function() {
        ...
        e.value[b] = { width: c.value, height: f, ...y(b, f) }, m("load");
      };
    });
  }
  function y(i, b) {
    if (i < a.columnCount)
      return o.value[i] = a.columnGap + b, { top: a.columnGap, left: (c.value + a.columnGap) * i + a.columnGap };
    {
      ...
      return o.value[k] = m + a.columnGap + b, { top: m + a.columnGap, left: (c.value + a.columnGap) * k + a.columnGap };
    }
  }
  return watch(() => [a.columnCount, a.columnGap, a.width], () => {
    ...
    a.images.length && x();
  }), (i, b) => (openBlock(), createElementBlock("div", { class: "m-waterfall", ref_key: "waterfall", ref: n, style: normalizeStyle(`--borderRadius: ${i.borderRadius}px; background-color: ${i.backgroundColor}; width: ${d.value}; height: ${s.value}px;`) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(e.value, (m, k) => withDirectives((openBlock(), createBlock(unref(ue), { class: "m-image", style: normalizeStyle(`width: ${m.width}px; height: ${m.height}px; top: ${m && m.top}px; left: ${m && m.left}px;`), spinning: !u.value[k], size: "small", indicator: "dynamic-circle", key: k }, { default: withCtx(() => [createBaseVNode("img", { class: "u-image", src: i.images[k].src, alt: i.images[k].title, onLoad: (f) => function(g) {
    u.value[g] = true;
  }(k) }, null, 40, Ho)]), _: 2 }, 1032, ["style", "spinning"])), [[vShow, u.value[k] !== void 0]])), 128))], 4));
...
var Ua = defineComponent({ __name: "Watermark", props: { width: { default: void 0 }, height: { default: void 0 }, layout: { default: "alternate" }, rotate: { default: -22 }, zIndex: { default: 9 }, image: { default: void 0 }, content: { default: "" }, fullscreen: { type: Boolean, default: false }, color: { default: "rgba(0,0,0,.15)" }, fontSize: { default: 16 }, fontWeight: { default: "normal" }, fontFamily: { default: "sans-serif" }, fontStyle: { default: "normal" }, gap: { default: () => [100, 100] }, offset: { default: () => [50, 50] } }, setup(l) {
  const a = l, e = shallowRef(), o = shallowRef(), n = shallowRef(document.documentElement), c = shallowRef(false), d = computed(() => {
    var z;
  ...
  }), M = computed(() => ({ parallel: 1, alternate: 2 })[a.layout]), y = computed(() => {
    const z = { zIndex: a.zIndex ?? 9, position: "absolute", left: 0, top: 0, width: "100%", height: "100%", pointerEvents: "none", backgroundRepeat: "repeat" };
    let $ = h.value - p.value, I = x.value - u.value;
    return $ > 0 && (z.left = `${$}px`, z.width = `calc(100% - ${$}px)`, $ = 0), I > 0 && (z.top = `${I}px`, z.height = `calc(100% - ${I}px)`, I = 0), z.backgroundPosition = `${$}px ${I}px`, z;
  });
  function i() {
  ...
  function b(z, $) {
    var S;
    var I;
    e.value && o.value && (c.value = true, o.value.setAttribute("style", (I = { ...y.value, backgroundImage: `url('${z}')`, backgroundSize: (d.value + $) * M.value + "px" }, Object.keys(I).map((H) => `${function(E) {
  ...
  function k(z, $, I, S, H) {
    const E = m(), K = a.content, ee = a.fontSize, de = a.fontWeight, ke = a.fontFamily, we = a.fontStyle, re = a.color, ne = Number(ee) * E;
    ...
    ve == null || ve.forEach((D, q) => {
      z.fillText(D ?? "", $, I + q * (ne + 3 * E));
    });
  }
  function f() {
    const z = document.createElement("canvas"), $ = z.getContext("2d"), I = a.image, S = a.rotate ?? -22;
    if ($) {
      o.value || (o.value = document.createElement("div"));
      const H = m(), [E, K] = function(Q) {
        let Me = 120, Ve = 64;
        ...
        return [Xe ?? Me, Qe ?? Ve];
      }($), ee = (d.value + E) * H, de = (s.value + K) * H;
      z.setAttribute("width", ee * M.value + "px"), z.setAttribute("height", de * M.value + "px");
      const ke = d.value * H / 2, we = s.value * H / 2, re = E * H, ne = K * H, ve = (re + d.value * H) / 2, D = (ne + s.value * H) / 2, q = ke + ee, Z = we + de, ae = ve + ee, te = D + de;
      if ($.save(), g($, ve, D, S), I) {
        const Q = new Image();
        Q.onload = () => {
          $.drawImage(Q, ke, we, re, ne), $.restore(), g($, ae, te, S), $.drawImage(Q, q, Z, re, ne), b(z.toDataURL(), E);
        }, Q.crossOrigin = "anonymous", Q.referrerPolicy = "no-referrer", Q.src = I;
      } else
        k($, ke, we, re, ne), $.restore(), g($, ae, te, S), k($, q, Z, re, ne), b(z.toDataURL(), E);
    }
  }
  function g(z, $, I, S) {
    z.translate($, I), z.rotate(Math.PI / 180 * Number(S)), z.translate(-$, -I);
  }
  return onMounted(() => {
    f();
  }), watch(() => [a], () => {
    ...
    const H = () => {
      ...
      H(), window && K && (S = new MutationObserver($), S.observe(K, I));
    }, { immediate: true });
...
var Io = [aa, la, ta, oa, sa, xe, na, ia, ua, ca, da, ra, va, pa, fa, ha, ma, ga, ya, ba, He, ka, Pe, wa, xa, Ye, Ma, za, _a, Ue, Ca, $a, Ba, Fa, Sa, La, Aa, Se, Da, Le, ue, Ea, Ha, Ia, Ta, ja, Va, Ra, Wa, Na, Oa, qe, qa, Pa, Ya, Ua];
var Zo = { install: (l) => {
