...
function useStorage(key, defaults2, storage, options = {}) {
  ...
  if (window2 && listenToStorageChanges) {
    if (storage instanceof Storage) useEventListener(window2, 'storage', onStorageEvent, { passive: true })
...
function useFileDialog(options = {}) {
  ...
  const inputRef = computed(() => {
    var _a
    const input =
      (_a = unrefElement(options.input)) != null ? _a : document2 ? document2.createElement('input') : void 0
    if (input) {
      input.type = 'file'
