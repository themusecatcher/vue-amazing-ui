import { isClient, toRef } from './chunk-YGRTXT6N.js'
import { ref, watch } from './chunk-5TCDO6LD.js'
...
var require_utils = __commonJS({
  'node_modules/.pnpm/qrcode@1.5.4/node_modules/qrcode/lib/core/utils.js'(exports) {
    ...
    var CODEWORDS_COUNT = [
      0,
      // Not used
      26, 44, 70, 100, 134, 172, 196, 242, 292, 346, 404, 466, 532, 581, 655, 733, 815, 901, 991, 1085, 1156, 1258,
        ...
        for (let j = 0; j < nodeGroup.length; j++) {
          ...
          for (let n = 0; n < prevNodeIds.length; n++) {
            ...
            if (table[prevNodeId] && table[prevNodeId].node.mode === node.mode) {
              ...
              graph[prevNodeId][key] =
                getSegmentBitsLength(node.length, node.mode) + 4 + Mode.getCharCountIndicator(node.mode, version)
            }
          }
        }
...
// node_modules/.pnpm/@vueuse+integrations@12.0.0_async-validator@4.2.5_focus-trap@7.6.2_qrcode@1.5.4_typescript@5.6.3/node_modules/@vueuse/integrations/useQRCode.mjs
